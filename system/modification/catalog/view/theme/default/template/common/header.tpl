  ...
  <div class="container">
    ...
    <?php echo $language; ?>
      ...
      <ul class="list-inline">
		<li><a href="<?php echo $careers; ?>"><i class="fa fa-cubes"></i>&nbsp;Careers: <span class="hidden-xs hidden-sm hidden-md" style="background:#F2B50F;border-radius:2px;padding:0px 2px;border:1px solid #F2B50F;">We are hiring</span></a></li>
      </ul>
    </div>
    ...
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
						...
						<?php if ($logged) { ?>
						<li class="dropdown"><a href="<?php echo $menu_buy; ?>" title="<?php echo $menu_buy; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-tachometer"></i> <span class="hidden-xs hidden-sm hidden-md">Customer Dashboard</span> <span class="caret"></span></a>
								<ul class="dropdown-menu dropdown-menu-right">
        ...
        <li class="dropdown"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li>
				<a href="<?php echo $login; ?>" id="marketinsg-login">
...
<div class="row"><div class="col-sm-12">
  <nav id="menu" class="navbar">
    ...
    <div class="navbar-header visible-lg visible-md" ><span id="category">All Products</span>
      <button type="button" class="btn btn-navbar navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse"><i class="fa fa-chevron-down"></i></button>
    </div>
    </div>
