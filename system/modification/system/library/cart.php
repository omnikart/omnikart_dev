...
class Cart {
	...
	public function getProducts() {
		...
		$vendor = $this->db->query("SELECT * FROM " . DB_PREFIX . "customerpartner_to_product c2p WHERE (c2p.product_id=".(int)$product_id." AND c2p.quantity>".(int)$quantity.") ORDER BY c2p.sort_order ASC"); 
