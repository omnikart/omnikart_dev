...
#nitroCacheClearCache {
	...
	-moz-box-shadow: 0 0 5px rgba(0,0,0,.75) !important; /* drop shadow */
	-webkit-box-shadow: 0 0 5px rgba(0,0,0,.75) !important; /* drop shadow */
	...
	background-image: -moz-linear-gradient(bottom, #849938 0%, #91bb48 100%) !important; /* gradient overlay */
	background-image: -o-linear-gradient(bottom, #849938 0%, #91bb48 100%) !important; /* gradient overlay */
	background-image: -webkit-linear-gradient(bottom, #849938 0%, #91bb48 100%) !important; /* gradient overlay */
	background-image: linear-gradient(bottom, #849938 0%, #91bb48 100%) !important; /* gradient overlay */
...
#nitroCacheClearCache:hover {
	...
	background-image: -moz-linear-gradient(bottom, #91bb48 0%, #849938 100%) !important;/* gradient overlay */
	background-image: -o-linear-gradient(bottom, #91bb48 0%, #849938 100%) !important; /* gradient overlay */
	background-image: -webkit-linear-gradient(bottom, #91bb48 0%, #849938 100%) !important; /* gradient overlay */
	background-image: linear-gradient(bottom, #91bb48 0%, #849938 100%) !important; /* gradient overlay */	
}
#clearCacheForm {
	margin: 0 !important;	
	padding: 0 !important;	
