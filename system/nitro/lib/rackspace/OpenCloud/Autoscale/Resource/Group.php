...
/**
 * An autoscaling group is monitored by Rackspace Cloud Monitoring.
 * When
...
class Group extends AbstractResource {
	...
	public function create($params = array()) {
		if (is_string ( $params )) {
			...
			throw new Exceptions\InvalidArgumentError ( 'You must provide either a string or an array/object' );
		}
