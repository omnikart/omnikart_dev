...
class AgentTarget extends ReadOnlyResource implements ResourceInterface {
	...
	public function setType($type) {
		if (! in_array ( $type, $this->allowedTypes )) {
			throw new Exception\AgentException ( sprintf ( 'Incorrect target type. Please specify one of the following: %s', implode ( ', ', $this->allowedTypes ) ) );
		}
	...
	public function listAll() {
		if (! $this->type) {
			throw new Exception\AgentException ( sprintf ( 'Please specify a target type' ) );
		}
