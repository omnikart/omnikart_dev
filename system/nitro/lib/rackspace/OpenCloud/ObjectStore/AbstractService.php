...
abstract class AbstractService extends CommonService {
	 ...
	 *
	 * @param mixed $cdata
	 *        	The name of the container or an object from which to set values
	 ...
	 *
	 * @param array $filter
	 *        	An array to filter the results
	 * @return OpenCloud\Common\Collection
	 */
	public function containerList(array $filter = array()) {
		$filter ['format'] = 'json';
		
		return $this->collection ( 'OpenCloud\ObjectStore\Resource\Container', $this->url ( null, $filter ) );
	}
}
