...
class Stack extends PersistentObject {
	...
	protected function createJson() {
		...
		if (! empty ( $this->{$pk} )) {
			throw new CreateError ( sprintf ( 'Stack is already created and has ID of %s', $this->$pk ) );
		}
	...
	public function resources() {
		return $this->getService ()->collection ( 'OpenCloud\Orchestration\Resource', $this->url ( 'resources' ), $this );
	}
}
