...
class VolumeType extends PersistentObject {
	...
	public function Create($params = array()) {
		throw new Exceptions\CreateError ( Lang::translate ( 'VolumeType cannot be created' ) );
	}
	...
	public function Update($params = array()) {
		throw new Exceptions\UpdateError ( Lang::translate ( 'VolumeType cannot be updated' ) );
	}
