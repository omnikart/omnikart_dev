...
class Domain extends Object {
	 ...
	 *
	 * @param array $filter
	 *        	key/value pairs for query string parameters
	 *        	return \OpenCloud\Collection
	 */
	...
	public function changes($since = null) {
		$url = $this->url ( 'changes', isset ( $since ) ? array (
				'since' => $since 
		) : null );
	 ...
	 *        	Replace occurrences of the reference domain
	 ...
	 * @return AsyncResponse
	 */
	public function cloneDomain($newdomain, $sub = true, $comments = true, $email = true, $records = true) {
