...
interface AuthorizationCodeInterface extends BaseAuthorizationCodeInterface {
	 ...
	 *        	identifier related to the authorization code
	 * @param $user_id User
	 *        	ID associated with the authorization code
	 * @param $redirect_uri An
	 *        	absolute URI to which the authorization server will redirect the
	 *        	user-agent to when the end-user authorization step is completed.
	 * @param $scope OPTIONAL
	 *        	Scopes to be stored in space-separated string.
	 * @param $id_token OPTIONAL
	 *        	The OpenID Connect id_token.
	 *        	
