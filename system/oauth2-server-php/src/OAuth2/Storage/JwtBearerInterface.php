...
interface JwtBearerInterface {
	 ...
	 *        	audience to match.
	 *        	
	 * @param $expiration The
	 *        	expiration of the jti.
	 *        	
	 * @param $jti The
	 *        	jti to match.
	 *        	
	 * @return An associative array as below, and return NULL if the jti does not exist.
