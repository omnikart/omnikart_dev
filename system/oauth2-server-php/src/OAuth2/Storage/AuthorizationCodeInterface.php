...
interface AuthorizationCodeInterface {
	 ...
	 *         @endcode
	 *        
	 * @see http://tools.ietf.org/html/rfc6749#section-4.1 @ingroup oauth2_section_4
	 */
	 ...
	 *
	 * @see http://tools.ietf.org/html/rfc6749#section-4.1.2 The client MUST NOT use the authorization code
