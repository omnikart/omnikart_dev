...
interface ClientCredentialsInterface extends ClientInterface {
	 ...
	 *         @endcode
	 *        
	 * @see http://tools.ietf.org/html/rfc6749#section-3.1 @ingroup oauth2_section_3
	 */
	 ...
	 * @see https://github.com/bshaffer/oauth2-server-php/issues/257 @ingroup oauth2_section_2
	 */
