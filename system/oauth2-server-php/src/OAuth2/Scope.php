...
class Scope implements ScopeInterface {
	 ...
	 *
	 * @param $required_scope A
	 *        	space-separated string of scopes.
	 *        	
	 * @return TRUE if everything in required scope is contained in available scope,
	 *         and FALSE if it isn't.
	 *        
	 * @see http://tools.ietf.org/html/rfc6749#section-7 @ingroup oauth2_section_7
	 */
	 ...
	 *
	 * @return An array of reserved scopes.
	 */
