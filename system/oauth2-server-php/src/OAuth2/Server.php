...
class Server implements ResourceControllerInterface, AuthorizeControllerInterface, TokenControllerInterface, UserInfoControllerInterface {
	 ...
	 * @see http://tools.ietf.org/html/rfc6749#section-4.1.3 @ingroup oauth2_section_4
	 */
	 ...
	 *
	 * @param $request The
	 *        	request should have the follow parameters set in the querystring:
	 ...
	 * @param $is_authorized TRUE
	 *        	or FALSE depending on whether the user authorized the access.
	 * @param $user_id Identifier
	 *        	of user who authorized the client
	 *        	
	 * @see http://tools.ietf.org/html/rfc6749#section-4 @ingroup oauth2_section_4
	 */
	 ...
	 *
	 * @return The authorization parameters so the authorization server can prompt
	 *         the user for approval if valid.
	 *        
	 * @see http://tools.ietf.org/html/rfc6749#section-4.1.1
	 * @see http://tools.ietf.org/html/rfc6749#section-10.12 @ingroup oauth2_section_3
	 */
