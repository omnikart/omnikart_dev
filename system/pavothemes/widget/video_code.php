 ...
 * ******************************************************/
class PtsWidgetVideo_code extends PtsWidgetPageBuilder {
	public $name = 'video_code';
	public $group = 'social';
	public static function getWidgetInfo() {
		return array (
				'label' => 'Video Code',
				'explain' => 'Make Video widget via putting Youtube Code, Vimeo Code',
				'group' => 'others' 
		);
	}
	...
	public function getHostInfo($vid_link) {
		...
		if (preg_match ( '#youtu#', $vid_link )) {
			return array (
					'host_name' => 'youtube',
					'original_key' => $this->getYoubetuID ( $vid_link ) 
			);
		}		// vimeo get video id
