...
class PtsWidgetFlickr extends PtsWidgetPageBuilder {
	...
	public function renderForm($args, $data) {
		...
		$num_photos = array (
				...
				array (
						'id' => '2',
						'name' => $this->l ( '2 photos' ) 
				),
				array (
						'id' => '3',
						'name' => $this->l ( '3 photos' ) 
				),
				array (
						'id' => '4',
						'name' => $this->l ( '4 photos' ) 
				),
				array (
						'id' => '5',
						'name' => $this->l ( '5 photos' ) 
				),
				array (
						'id' => '6',
						'name' => $this->l ( '6 photos' ) 
				),
				array (
						'id' => '7',
						'name' => $this->l ( '7 photos' ) 
				),
				array (
						'id' => '8',
						'name' => $this->l ( '8 photos' ) 
				),
				array (
						'id' => '9',
						'name' => $this->l ( '9 photos' ) 
				) 
		);
		$type = array (
				array (
