...
class PtsWidgetSocialshare extends PtsWidgetPageBuilder {
	...
	public static function getWidgetInfo() {
		return array (
				'label' => 'Social Share',
				'explain' => 'Get list of sharing socials',
				'group' => 'social' 
		);
	}
	public function renderForm($args, $data) {
		...
		$align = array (
				array (
						'id' => 'separator_align_center',
						'name' => $this->l ( 'Align center' ) 
				),
				array (
						'id' => 'separator_align_left',
						'name' => $this->l ( 'Align left' ) 
				),
				array (
						'id' => 'separator_align_right',
						'name' => $this->l ( 'Align right' ) 
				) 
		);
