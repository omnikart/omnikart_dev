<?php echo $header; ?><div id="columns">
  ...
  <h1><?php echo $heading_title; ?></h1>
				<fieldset>
					<legend>
						<i class="fa fa-list"></i> <?php echo $text_transactionList; ?></legend>
      <?php if($isMember) { ?>
      <div class="well">
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="filter_id"
										...
										placeholder="<?php echo $text_transactionId; ?>" id="input-id"
										class="form-control" />
								</div>
								<div class="form-group">
									...
									<input type="text" name="filter_amount"
										...
										placeholder="<?php echo $text_transactionAmount; ?>"
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="filter_details"
										...
										placeholder="<?php echo $text_transactionDetails; ?>"
										id="input-details" class="form-control" />
								</div>
								<div class="form-group">
									...
									<div class="input-group date">
										<input type="text" name="filter_date"
											...
											placeholder="<?php echo $text_transactionDate; ?>"
											id="input-date" class="form-control date" /> <span
