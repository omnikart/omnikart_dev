  ...
  <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
    <h1>
      ...
      <div class="pull-right">
						<button type="submit" form="form-shipping" data-toggle="tooltip"
							title="<?php echo $button_next; ?>" class="btn btn-primary">
							<i class="fa fa-share"></i>
						</button>
						<a href="<?php echo $back; ?>" data-toggle="tooltip"
							title="<?php echo $button_back; ?>" class="btn btn-default"><i
							class="fa fa-reply"></i></a> <a
							onclick="$('#form-delete').submit();" data-toggle="tooltip"
				...
				<fieldset>
					<legend>
						<i class="fa fa-list"></i> <?php echo $text_mpshipping; ?></legend>
      <?php if($isMember) { ?>
        <div class="alert alert-info">
						<i class="fa fa-exclamation-circle"></i> <?php echo $entry_info; ?>
          <button type="button" class="close" data-dismiss="alert">&times;</button>
					</div>

					<form action="<?php echo $action; ?>" method="post"
						enctype="multipart/form-data" id="form-shipping"
						class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="input-flatrate"><span
								data-toggle="tooltip" title="<?php echo $add_flatrate; ?>"><?php echo $add_flatrate; ?></span></label>
							<div class="col-sm-9">
								<div class="input-group">
									<input type="text" name="shipping_add_flatrate"
										value="<?php if(isset($shipping_add_flatrate_amount)){ echo $shipping_add_flatrate_amount; } ?>"
										placeholder="<?php echo $add_flatrate; ?>" id="input-flatrate"
										class="form-control" /> <span class="input-group-addon"><?php echo $shipping_add_flatrate; ?></span>
								</div>
							</div>
						</div>
						...
						<div class="form-group required">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip"
								title="<?php echo $entry_csv_info; ?>"><?php echo $entry_csv; ?></span></label>
							<div class="col-sm-9">
								<div class="input-group">
									...
									</span> <input type="text" id="input-csv-name"
                ...
                <?php echo $entry_error_csv; ?>
						...
						<div class="form-group required">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip"
								title="<?php echo $entry_separator_info; ?>"><?php echo $entry_separator; ?></span></label>
							<div class="col-sm-9">
								<div class="input-group">
									<span class="input-group-btn">
										<button type="button" class="btn btn-primary separator">
											<i class="fa fa-keyboard-o"></i> <?php echo $entry_sep_manually; ?></button>
									</span>
									<div>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="filter_country"
										value="<?php echo $filter_country; ?>"
										placeholder="<?php echo $filter_country; ?>"
								...
								<div class="form-group">
									...
									<input type="text" name="filter_price"
										...
										placeholder="<?php echo $filter_price; ?>" id="input-price"
										class="form-control" />
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="filter_zip_to"
										value="<?php echo $filter_zip_to; ?>"
										placeholder="<?php echo $filter_zip_to; ?>" id="input-zipto"
										class="form-control" />
								</div>
								<div class="form-group">
									<label class="control-label" for="input-weightto"><?php echo $weight_to; ?></label>
									<input type="text" name="filter_weight_to"
										value="<?php echo $filter_weight_to; ?>"
										placeholder="<?php echo $filter_weight_to; ?>"
										id="input-weightto" class="form-control" />
								</div>
							</div>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="filter_zip_from"
										value="<?php echo $filter_zip_from; ?>"
										placeholder="<?php echo $filter_zip_from; ?>"
										id="input-zipfrom" class="form-control" />
								</div>
								<div class="form-group">
									<label class="control-label" for="input-weightfrom"><?php echo $weight_from; ?></label>
									<input type="text" name="filter_weight_from"
										value="<?php echo $filter_weight_from; ?>"
										placeholder="<?php echo $filter_weight_from; ?>"
										id="input-weightfrom" class="form-control" />
								</div>
							</div>
							<a onclick="filter();" class="btn btn-primary pull-right"
								data-toggle="tooltip" title="<?php echo $button_filtering; ?>"><?php echo $button_filtering; ?></a>
						</div>
					</div>

					<form action="<?php echo $delete; ?>" method="post"
						enctype="multipart/form-data" id="form-delete">
                        ...
                        <a href="<?php echo $sort_country_code; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $shipping_country; ?></a>
                        <?php } else { ?>
                        ...
                        <a href="<?php echo $sort_zip_to; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $zip_to; ?></a>
                        <?php } else { ?>
                        ...
                        <a href="<?php echo $sort_zip_from; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $zip_from; ?></a>
                        <?php } else { ?>
                        ...
                        <a href="<?php echo $sort_price; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $price; ?></a>
                        <?php } else { ?>
                        ...
                        <a href="<?php echo $sort_weight_to; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $weight_to; ?></a>
                        <?php } else { ?>
                        ...
                        <a href="<?php echo $sort_weight_from; ?>"
											class="<?php echo strtolower($order); ?>"><?php echo $weight_from; ?></a>
                        <?php } else { ?>
                      ...
                      <?php foreach ($result_shipping as $result_shippings) { ?>
                        <tr>
                            ...
                            <input type="checkbox" name="selected[]"
											value="<?php echo $result_shippings['id']; ?>"
											checked="checked" />
                            <?php } else { ?>
                            <input type="checkbox" name="selected[]"
											value="<?php echo $result_shippings['id']; ?>" />
        ...
        <?php } else { ?>
          <div class="text-danger">Warning: You are not authorised to
						view this page, Please contact to site administrator!</div>
        <?php } ?>
    </fieldset>
