  ...
  <div id="content" class="<?php echo $class; ?>">
    ...
    <h1>
      ...
      <div class="pull-right">
				...
				<fieldset>
					<legend>
						<i class="fa fa-list"></i> <?php echo $heading_title." ".$product_id; ?></legend>
            ...
            <?php if($orders){ ?>    
              <?php foreach($orders as $order) {?>
                <tr>
									...
									<td class="text-center"><a href="<?php echo $order['link'];?>"
										class="btn btn-primary btn-xs" data-toggle="tooltip"
										title="<?php echo $text_invoice; ?>"> <i class="fa fa-eye"></i></a></td>
