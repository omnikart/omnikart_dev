  ...
  <?php if($chkIsPartner){ ?>
    ...
    <h1>
      ...
      <div class="pull-right">
						<a href="<?php echo $continue; ?>" data-toggle="tooltip"
							title="<?php echo $button_back; ?>" class="btn btn-default"><i
							class="fa fa-reply"></i></a> <a
							href="<?php echo $order_invoice; ?>" data-toggle="tooltip"
							class="btn btn-primary" target="_blank"
							title="<?php echo $button_invoice; ?>"><i class="fa fa-save"></i></a>
					</div>
				</h1>
              ...
              <tr>
                  ...
                  <?php }else{ ?>
                    <input type="text" class="form-control"
										name="tracking[<?php echo $product['product_id'];?>]"
										placeholder="<?php echo $column_tracking_no; ?>" />
                  <?php $i = true; } ?>
                </td>
								</tr>
              <?php } ?>
