    ...
    <h1>
      <?php echo $heading_title; ?>
	  	<div class="pull-right">
			...
			<button data-toggle="tooltip" class="btn btn-primary"
							id="updateProducts" form="form-product"
							formaction="<?php echo $addproducts; ?>"
      ...
      <div class="well">
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label class="control-label" for="input-category">Filter by
										Category</label> <input type="text" name="filter_category"
										value="" placeholder="" id="input-category"
										class="form-control" />
								</div>
								<a onclick="filter();" class="btn btn-primary pull-right">Find
									Products</a>
							</div>
						</div>
					</div>
          ...
          <?php } } ?>
					...
					<form action="<?php echo $delete; ?>" method="post"
						class="col-sm-9" enctype="multipart/form-data" id="form-product">
              ...
              <tr>
                  ...
                  <?php } ?></td>
										...
										<td class="text-left"><input type="text" style="width: 70px;"
											class="form-control"
											name="products[<?php echo $product['product_id']; ?>][price]"
											value="" /></td>
										<td class="text-right"><input type="text" style="width: 50px;"
											class="form-control"
