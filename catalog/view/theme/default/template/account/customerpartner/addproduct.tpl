      ...
      <h1>
        ...
        <div class="pull-right">
						<a onclick="$('#form-save').submit();" data-toggle="tooltip"
							class="btn <?php echo $product_id ? 'btn-info' : 'btn-success'; ?>"
							title="<?php echo $button_continue; ?>" id="submit"><i
							class="fa fa-save"></i></a> <a href="<?php echo $cancel; ?>"
							data-toggle="tooltip" title="<?php echo $button_back; ?>"
							class="btn btn-default" data-original-title="Cancel"><i
							class="fa fa-reply"></i></a>
					</div>
				</h1>
				<h4>
					The product might already be on our database. Please find it using
					this. <a href="<?php echo $existing; ?>" data-toggle="tooltip"
						class="btn btn-info" title="Check existing Products" id="submit">Find
						Existing Product</a>
				</h4>
				<fieldset>

					<legend>
						<i class="fa fa-pencil"></i> <?php echo $heading_title; ?></legend>
    
    <?php if(!isset($access_error) && $isMember){ ?>
    <form action="<?php echo $action; ?>" method="post"
						enctype="multipart/form-data" id="form-save">
       ...
       <li><a href="#tab-image" data-toggle="tab"><?php echo $tab_image; ?></a>
							</li>     
        ...
        <?php } ?>     
            ...
            <li
										class="<?php if($flag == 1) { echo "active"; } $flag++; ?>"><a
            ...
            <?php $flag = 1; foreach ($languages as $language) { ?>
            <div
										class="tab-pane <?php if($flag == 1) { echo "active"; } $flag++; ?>"
		                	...
		                	<?php } ?>
											...
											<div class="col-sm-6">
												<div class="form-group required">
													<label class="control-label"
														for="input-meta-description<?php echo $language['language_id']; ?>"><?php echo $entry_meta_title; ?></label>
													<input <?php if ($add) { ?>
											...
											<div class="col-sm-12">
												<div class="form-group">
													...
													<textarea <?php if ($add) { ?>
														...
														class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label"
														for="input-tag<?php echo $language['language_id']; ?>"><span
														data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo $entry_tag; ?></span></label>
													<div class="col-sm-9">
            ...
            <?php } ?>
          		...
          		<div class="form-group required">
											...
											<input type="text" <?php if ($add) { ?> name="model"
												<?php } else echo "disabled"; ?>
				...
				<div class="form-group">
											<label class="col-sm-3 control-label" for="input-jan"><span
												data-toggle="tooltip" title="<?php echo $help_jan; ?>"><?php echo $entry_jan; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="jan"
												<?php } else echo "disabled"; ?> value="<?php echo $jan; ?>"
												placeholder="<?php echo $entry_jan; ?>" id="input-jan"
												class="form-control" />
										</div>
				<?php } ?>
				...
				<div class="form-group">
					...
					<?php if(!$thumb){ ?>
					<input type="file" <?php if ($add) { ?> name="image"
												<?php } else echo "disabled"; ?> value="" accept="image/*"
												class="form-control" />
											</td>
					<?php }else{ ?>
					<input type="file" <?php if ($add) { ?> name="image"
												<?php } else echo "disabled"; ?> value="" id="1stimg"
												class="hide" accept="image/*" class="form-control" /> <img
												src="<?php echo $thumb; ?>" class="img-thumbnail click-file" />
											<input type="hidden" <?php if ($add) { ?> name="image"
												<?php } else echo "disabled"; ?>
				...
				<div class="form-group">
											<label class="control-label" for="input-sku"><span
												data-toggle="tooltip" title="<?php echo $help_sku; ?>"><?php echo $entry_sku; ?></span></label>
											<input type="text" name="sku" value="<?php echo $sku; ?>"
												placeholder="<?php echo $entry_sku; ?>" id="input-sku"
												class="form-control" />
										</div>
				<?php } ?> 
				<?php if(isset($mp_allowproductcolumn['isbn'])) { ?> 
				<div class="form-group">
											<label class="control-label" for="input-isbn"><span
												data-toggle="tooltip" title="<?php echo $help_isbn; ?>"><?php echo $entry_isbn; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="isbn"
												<?php } else echo "disabled"; ?>
												value="<?php echo $isbn; ?>"
				...
				<div class="form-group">
											...
											<select <?php if ($add) { ?> name="tax_class_id"
												<?php } else echo "disabled"; ?> id="input-tax-class"
												class="form-control">
				...
				<div class="form-group">
											<label class=" control-label" for="input-stock-status"><span
												data-toggle="tooltip"
				...
				<div class="form-group">
											<label class="control-label" for="input-upc"><span
												data-toggle="tooltip" title="<?php echo $help_upc; ?>"><?php echo $entry_upc; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="upc"
												<?php } else echo "disabled"; ?> value="<?php echo $upc; ?>"
												placeholder="<?php echo $entry_upc; ?>" id="input-upc"
												class="form-control" />
										</div>
				<?php } ?>
				<?php if(isset($mp_allowproductcolumn['mpn'])) { ?> 
				<div class="form-group">
											<label class=" control-label" for="input-mpn"><span
												data-toggle="tooltip" title="<?php echo $help_mpn; ?>"><?php echo $entry_mpn; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="mpn"
												<?php } else echo "disabled"; ?> value="<?php echo $mpn; ?>"
												placeholder="<?php echo $entry_mpn; ?>" id="input-mpn"
												class="form-control" />
										</div>
				<?php } ?>
				...
				<div class="form-group">
											...
											<select name="shipping" id="shipping" class="form-control">
												<option value="1"
													<?php echo ($shipping?'checked="checked"':''); ?>><?php echo $text_yes; ?></option>
												<option value="0"
													<?php echo ($shipping?'':'checked="checked"'); ?>><?php echo $text_no; ?></option>
											</select>
										</div>
				<?php } ?>
											...
											<div class="row">
												<div class="col-lg-4">
													<input type="text" name="length"
														...
														placeholder="<?php echo $help_length; ?>"
														id="input-length" class="form-control" />
												</div>
												<div class="col-lg-4">
													<input type="text" name="width"
														value="<?php echo $width; ?>"
														placeholder="<?php echo $help_width; ?>" id="input-width"
														class="form-control" />
												</div>
												<div class="col-lg-4">
													<input type="text" name="height"
														value="<?php echo $height; ?>"
														placeholder="<?php echo $help_height; ?>"
				...
				<div class="form-group">
											<label class="control-label" for="input-ean"><span
												data-toggle="tooltip" title="<?php echo $help_ean; ?>"><?php echo $entry_ean; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="ean"
												<?php } else echo "disabled"; ?> value="<?php echo $ean; ?>"
												placeholder="<?php echo $entry_ean; ?>" id="input-ean"
												class="form-control" />
										</div>
				<?php } ?> 
				...
				<div class="form-group">
											...
											<input type="text" name="location"
												...
												placeholder="<?php echo $entry_location; ?>"
												id="input-location" class="form-control" />
										</div>
				<?php } ?>
				<?php if(isset($mp_allowproductcolumn['minimum'])) { ?> 
				<div class="form-group">
											<label class=" control-label" for="input-minimum"><span
												data-toggle="tooltip" title="<?php echo $help_minimum; ?>"><?php echo $entry_minimum; ?></span></label>
											<input type="text" name="minimum"
												value="<?php echo $minimum; ?>"
												placeholder="<?php echo $entry_minimum; ?>"
												id="input-minimum" class="form-control" />
										</div>
				<?php } ?>
				<?php if(isset($mp_allowproductcolumn['keyword'])) { ?> 
				<div class="form-group">
											<label class=" control-label" for="input-keyword"><span
												data-toggle="tooltip" title="<?php echo $help_keyword; ?>"><?php echo $entry_keyword; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="keyword"
												<?php } else echo "disabled"; ?>
				...
				<div class="form-group">
											...
											<input type="text" name="weight"
												...
												placeholder="<?php echo $help_weight; ?>" id="input-weight"
												class="form-control" />
										</div>
				<?php } ?>
        ...
        <div class="tab-pane" id="tab-links">
								<div class="form-group">
									<label class="col-sm-3 control-label" for="input-manufacturer"><span
										data-toggle="tooltip"
										title="<?php echo $help_manufacturer; ?>"><?php echo $entry_manufacturer; ?></span></label>
									<div class="col-sm-9">
										<input type="text" <?php if ($add) { ?> name="manufacturer"
											<?php } else echo "disabled"; ?>
											value="<?php echo $manufacturer ?>"
											placeholder="<?php echo $entry_manufacturer; ?>"
											id="input-manufacturer" class="form-control" /> <input
											type="hidden" <?php if ($add) { ?> name="manufacturer_id"
											<?php } else echo "disabled"; ?>
											value="<?php echo $manufacturer_id; ?>" />
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label class="control-label" for="input-category"><span
												data-toggle="tooltip" title="<?php echo $help_category; ?>"><?php echo $entry_category; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="category"
												<?php } else echo "disabled"; ?> value=""
	                		...
	                		<div
													id="product-category<?php echo $product_category['category_id']; ?>">
													<i class="fa fa-minus-circle "></i><?php echo $product_category['name']; ?>
	                  			<input type="hidden" <?php if ($add) { ?>
														name="product_category[]" <?php } else echo "disabled"; ?>
	                		...
	                		<?php } ?>
										...
										<div class="form-group">
											<label class="control-label" for="input-filter"><span
												data-toggle="tooltip" title="<?php echo $help_filter; ?>"><?php echo $entry_filter; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="filter"
												<?php } else echo "disabled"; ?> value=""
												placeholder="<?php echo $entry_filter; ?>" id="input-filter"
												class="form-control" />
											<div id="product-filter" class="well well-sm"
												style="height: 150px; overflow: auto;">
                			<?php foreach ($product_filters as $product_filter) { ?>
                			<div
													id="product-filter<?php echo $product_filter['filter_id']; ?>">
													<i class="fa fa-minus-circle"></i> <?php echo $product_filter['name']; ?>
                  				<input type="hidden" <?php if ($add) { ?>
														name="product_filter[]" <?php } else echo "disabled"; ?>
                			...
                			<?php } ?>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label class="control-label" for="input-download"><span
												data-toggle="tooltip" title="<?php echo $help_download; ?>"><?php echo $entry_download; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="download"
												<?php } else echo "disabled"; ?> value=""
												placeholder="<?php echo $entry_download; ?>"
												id="input-download" class="form-control" />
											<div id="product-download" class="well well-sm"
												style="height: 150px; overflow: auto;">
                			<?php foreach ($product_downloads as $product_download) { ?>
                			<div
													id="product-download<?php echo $product_download['download_id']; ?>">
													<i class="fa fa-minus-circle"></i> <?php echo $product_download['name']; ?>
                  				<input type="hidden" <?php if ($add) { ?>
														name="product_download[]" <?php } else echo "disabled"; ?>
                			...
                			<?php } ?>
										...
										<div class="form-group">
											<label class="control-label" for="input-related"><span
												data-toggle="tooltip" title="<?php echo $help_related; ?>"><?php echo $entry_related; ?></span></label>
											<input type="text" <?php if ($add) { ?> name="related"
												<?php } else echo "disabled"; ?> value=""
												placeholder="<?php echo $entry_related; ?>"
                			...
                			<div
													id="product-related<?php echo $product_related['product_id']; ?>"
													class="<?php echo $class; ?>">
													<i class="fa fa-minus-circle"></i> <?php echo $product_related['name']; ?>
                  			<input type="hidden" <?php if ($add) { ?>
														name="product_related[]" <?php } else echo "disabled"; ?>
                ...
                <tbody id="attribute-row<?php echo $attribute_row; ?>">
                      ...
                      <div class="input-group">
														...
														<textarea <?php if ($add) { ?>
															...
															<?php } else echo "disabled"; ?> cols="40" rows="5"
											...
											<tr>
												...
												<td class="text-left">
													<button type="button" onclick="addAttribute();"
														data-toggle="tooltip"
														title="<?php echo $button_add_attribute; ?>"
        ...
        <div class="tab-pane" id="tab-option">
                ...
                <li><a href="#tab-option<?php echo $option_row; ?>"
												data-toggle="tab" id="option<?php echo $option_row; ?>"><i
													class="fa fa-minus-circle"
													onclick="$('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove(); $('#tab-option<?php echo $option_row; ?>').remove(); $('#option a:first').tab('show');"></i> <?php echo $product_option['name']; ?></a></li>
                <?php $option_row++; ?>
                <?php } ?>
                <li><input type="text" name="option" value=""
												placeholder="<?php echo $button_add_option; ?>"
												id="input-option" class="form-control" /></li>
										</ul>
									</div>
									<div class="col-sm-9">
										<div class="tab-content">
                ...
                <?php foreach ($product_options as $product_option) { ?>
                <div class="tab-pane"
												id="tab-option<?php echo $option_row; ?>">
												<input type="hidden"
												...
												<input type="hidden"
													...
													value="<?php echo $product_option['name']; ?>" /> <input
													type="hidden"
													name="product_option[<?php echo $option_row; ?>][option_id]"
													value="<?php echo $product_option['option_id']; ?>" /> <input
													type="hidden"
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<select
															name="product_option[<?php echo $option_row; ?>][required]"
                  ...
                  <div class="form-group">
													...
													<div class="col-sm-9">
														<input type="text"
															name="product_option[<?php echo $option_row; ?>][option_value]"
                  ...
                  <div class="form-group">
													...
													<div class="col-sm-9">
														<textarea
															...
															id="input-value<?php echo $option_row; ?>"
															class="form-control"><?php echo $product_option['option_value']; ?></textarea>
													</div>
												</div>
                  <?php } ?>
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody
															id="option-value-row<?php echo $option_value_row; ?>">
															<tr>
                              ...
                              <?php if (isset($option_values[$product_option['option_id']])) { ?>
                               ...
                               <option
                                ...
                                <?php } ?>
																	...
																	value="<?php echo $product_option_value['product_option_value_id']; ?>" /></td>
															...
															<tr>
																...
																<td class="text-left">
																	<button type="button"
																		...
																		data-toggle="tooltip"
																		title="<?php echo $button_add_option_value; ?>"
																		class="btn btn-primary">
																		<i class="fa fa-plus-circle"></i>
																	</button>
																</td>
              ...
              <tfoot>
											<tr>
												...
												<td class="text-left"><button type="button"
														...
														title="<?php echo $button_add_discount; ?>"
														class="btn btn-primary">
														<i class="fa fa-plus-circle"></i>
													</button></td>
											</tr>
              ...
              <tfoot>
											<tr>
												...
												<td class="text-left"><button type="button"
														...
														title="<?php echo $button_add_special; ?>"
														class="btn btn-primary">
														<i class="fa fa-plus-circle"></i>
													</button></td>
											</tr>
        ...
        <div class="tab-pane" id="tab-image">
              ...
              <tbody id="image-row<?php echo $image_row; ?>">
											...
											<tr>
												<td class="text-left"><input type="file" class="hide"
													name="product_image[<?php echo $image_row; ?>][image]"> <img
													src="<?php echo $product_image['thumb'] ? $product_image['thumb'] : $placeholder; ?>"
													data-placeholder="<?php echo $placeholder; ?>"
													class="img-thumbnail click-file" /> <input type="hidden"
              ...
              <tfoot>
											<tr>
												...
												<td class="text-left"><button type="button"
														...
														title="<?php echo $button_add_image; ?>"
														class="btn btn-primary">
														<i class="fa fa-plus-circle"></i>
													</button></td>
											</tr>
        ...
        <div class="tab-pane" id="tab-reward">
								<div class="form-group">
									<label class="col-lg-2 control-label" for="input-points"><span
										data-toggle="tooltip" title="<?php echo $help_points; ?>"><?php echo $entry_points; ?></span></label>
									<div class="col-lg-10">
...
<?php echo $column_right; ?></div>
	...
	<script type="text/javascript"
		src="catalog/view/javascript/jquery/editor/jquery-te-1.4.0.min.js"></script>
	<link href="catalog/view/javascript/jquery/editor/jquery-te-1.4.0.css"
		rel="stylesheet" />
	<script type="text/javascript"><!--
<?php  foreach ($languages as $language) { ?>
