      ...
      <h1>
        ...
        <div class="pull-right">
						<a href="<?php echo $insert; ?>" data-toggle="tooltip"
							...
							onclick="$('#form-download').submit();" data-toggle="tooltip"
				...
				<fieldset>
					<legend>
						<i class="fa fa-list"></i> <?php echo $text_downloadableItems; ?></legend>
        <?php if($isMember) { ?>
              ...
              <tr>
                  ...
                  <?php } ?></td>
                   ...
                   <a data-toggle="tooltip" title=""
											...
											data-original-title="<?php echo $action['text']; ?>"
											href="<?php echo $action['href']; ?>"><i class="fa fa-pencil"></i></a> 
                  <?php } ?></td>
									</tr>
              <?php } ?>
              <?php } else { ?>
