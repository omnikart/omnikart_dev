    ...
    <?php if ($categories) { ?>
     	...
     	<?php foreach ($categories as $category) { ?>
	        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
						<div class="product-thumb transition">
							<div class="image">
								<a href="<?php echo $category['href']; ?>"><div></div>
							...
							<div>
								...
								<div class="button-group">
									<button class="quickaddcart" style="width: 100%" type="button"
										value="<?php echo $category['category_id']; ?>">
										<i class="fa fa-shopping-cart"></i> <span
											class="hidden-xs hidden-sm hidden-md">Quick Add to Cart</span>
									</button>
								</div>
							</div>
						</div>
      ...
      <div class="buttons">
					<div class="pull-right">
						<button id="button-pcd" class="btn btn-primary btn-lg">Add
							Products to DashBoard</button>
					</div>
				</div>
      <?php } ?>
      <div class="row">
