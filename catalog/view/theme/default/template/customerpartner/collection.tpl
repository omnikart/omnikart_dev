	...
	<div class="<?php echo $class; ?>">
		<p>
			<a href="<?php echo $compare; ?>" id="compare-total"
				class="default-work"><?php echo $text_compare; ?></a>
		</p>
		<div class="row">
			<div class="col-md-4">
				<div class="btn-group">
		...
		<div class="row">
			...
			<div class="product-layout product-list col-xs-12">
				<div class="product-thumb">
					<div class="image">
						<a href="<?php echo $product['href']; ?>" class="default-work"><img
					...
					<div>
						<div class="caption">
							<h4>
								<a href="<?php echo $product['href']; ?>" class="default-work"><?php echo $product['name']; ?></a>
							</h4>
