...
<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group required">
							<label class="control-label" for="name-of-person">Name of the
								Contact Person</label> <input name="name" class="form-control"
								placeholder="" type="text" id="name-of-person" />
						</div>
						<div class="form-group required">
							<label class="control-label" for="phone-number">Mobile Number</label>
							<input name="number" class="form-control" placeholder=""
					...
					<div class="col-sm-4">
						<div class="form-group required">
							...
							<input name="company" class="form-control" placeholder=""
								type="text" id="company-name" />
						</div>
						<div class="form-group">
							<label class="control-label" for="alt-number">Alternate Number</label>
							<input name="number_2" class="form-control" placeholder=""
								type="text" id="alt-number" />
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group required">
							<label class="control-label" for="email">Email Id</label> <input
								name="email" class="form-control" placeholder="" type="text"
								id="email" />
						</div>
						<div class="form-group">
							<label class="control-label" for="website">Website Link</label> <input
								name="website" class="form-control" placeholder="" type="text"
								id="website" />
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group required">
							...
							<div class="well well-sm" id="trade"
								style="height: 150px; overflow: auto">
								<div class="radio">
									<label> <input type="radio" value="1" name="trade" />OEM/Manufacturer
									</label>
								</div>
								<div class="radio">
									<label> <input type="radio" value="2" name="trade" />Authorized
										Dealer/Distributer
									</label>
								</div>
								<div class="radio">
									<label> <input type="radio" value="3" name="trade" />Dealer/Stockist
									</label>
								</div>
								<div class="radio">
									<label> <input type="radio" value="4" name="trade" />Importer
									</label>
								</div>
								<div class="radio">
									<label> <input type="radio" value="5" name="trade" />Reseller
									</label>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-4">
						<div class="form-group required">
							...
							<div class="well well-sm" style="height: 150px; overflow: auto">
								<div class="checkbox">
									<label> <input type="checkbox" value="0" name="manufacturers[]" />Others
									</label>
								</div>
					<?php if (isset($manufacturers)) { foreach($manufacturers as $manufacturer) { ?>
						<div class="checkbox">
									<label> <input type="checkbox"
										...
										name="manufacturers[]" /><?php echo $manufacturer['name']; ?>
							</label>
								</div>
					<?php }} ?>
				</div>
					...
					<div class="col-sm-4">
						<div class="form-group required">
							...
							<div class="well well-sm" style="height: 150px; overflow: auto">
								<div class="checkbox">
									<label> <input type="checkbox" value="0" name="categories[]" />Others
									</label>
								</div>
					<?php if (isset($categories)) { foreach($categories as $category) { ?>
						<div class="checkbox">
									<label> <input type="checkbox"
										...
										name="categories[]" /><?php echo $category['name']; ?>
							</label>
								</div>
					<?php }} ?>
				</div>
					...
					<div class="col-sm-12">
						<div class="text-center">
							<button type="button" class="btn btn-primary btn-lg"
								onclick="validateForm();" id="submit">Register</button>
						</div>
					</div>
				</div>
			</form>
        ...
        <?php if($tabs){ ?>
          <?php foreach ($tabs as $key => $value) { ?>
              <li <?php if(!$key){ ?> class="active" <?php } ?>><a
						href="<?php echo "#tab-".$key; ?>" data-toggle="tab"><?php echo $value['hrefValue']; ?></a></li>
          <?php }?>
        <?php }?>          
      </ul>
        ...
        <?php foreach ($tabs as $key => $value) { ?>
          <div id="<?php echo "tab-".$key; ?>"
						class="tab-pane <?php if(!$key){ ?>active<?php } ?>"><?php echo $value['description']; ?></div>
        <?php }?>
      </div>
						...
						<div class="product-thumb">
							...
							<div class="text-center">
								<a href="<?php echo $partner['sellerHref']; ?>"><img
									...
									title="<?php echo $partner['name']; ?>" class="img-circle" /></a>
          ...
          <div
                  ...
                  <?php } ?>
                    ...
                    <span data-toggle="tooltip"
											title="<?php echo $text_seller; ?>"><i class="fa fa-user"></i></span>
										<a href="<?php echo $product['sellerHref']; ?>"
											target="_blank"> <b class="text-white"><?php echo $product['seller_name']; ?></b></a>
									</p>
