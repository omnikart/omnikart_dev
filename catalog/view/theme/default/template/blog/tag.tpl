...
$inc = 0;
					...
					<div class="col-sm-12">
							<h2 class="nmt">
								<a href="<?php echo $post['link']; ?>"><i class="fa fa-pencil"></i> <?php echo ucfirst($post['title']); ?></a>
							</h2>
						...
						<div>
							...
							<div>
								...
								<div class="row">
									<div class="col-sm-3">
										<a class="image" href="<?php echo $post['link']; ?>"> <img
											src="<?php echo $post['post_thumbnail']; ?>" alt="">
										</a>
										<div class="images">
