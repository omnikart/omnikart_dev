    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h1><?php echo $heading_title; ?></h1>
                ...
                <input type="checkbox" name="content" value="1"
									id="post_content" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="content" value="1"
									id="post_content" />
                <?php } ?>
              ...
              <option value="<?php echo $category_2['category_id']; ?>"
									selected="selected">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $category_2['name']; ?></option>
              <?php } else { ?>
              ...
              <?php echo $text_sub_category; ?></label>
					...
					<input type="button" value="<?php echo $button_search; ?>"
        ...
        <div class="display-controls">
          ...
          <div class="product-layout product-list col-xs-12">
							<div class="post-thumb">
								<div class="image">
									<a href="<?php echo $post['href']; ?>"><img
										src="<?php echo $post['thumb']; ?>"
										alt="<?php echo $post['title']; ?>"
										title="<?php echo $post['title']; ?>" class="img-responsive" /></a>
								</div>
								<div class="caption">
									<h4>
