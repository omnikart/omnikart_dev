...
<div id="ne_subscribe<?php echo $module; ?>"
	class="form-horizontal ne_subscribe">
	<div class="input-group">
		<input type="text" name="ne_email" value="" id="input-subscribe-email"
			class="form-control" /> <span class="input-group-btn"> <a href="#"
			class="btn btn-primary ne_submit"><?php echo $text_subscribe; ?></a>
		</span>
	</div>
