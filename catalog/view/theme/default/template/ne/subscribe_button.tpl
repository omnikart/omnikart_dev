...
<div class="panel panel-default">
    ...
    <div class="panel-body">
		<div id="ne_subscribe<?php echo $module; ?>" class="ne_subscribe"
			...
			<a href="#ne_modal<?php echo $module; ?>" data-toggle="modal"
				class="btn btn-primary ne_submit" style="width: 80%;"><?php echo $text_subscribe; ?></a>
		</div>
	</div>
</div>
		...
		<div class="modal-dialog" style="max-width: 400px;">
			<div class="modal-content">
				<div class="modal-header">
					...
					<a href="#" class="ne_close" data-dismiss="modal"
						aria-hidden="true"><?php echo $text_close; ?></a>
				</div>
