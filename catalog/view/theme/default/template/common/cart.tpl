<div id="cart">
  <button type="button" data-toggle="modal" data-target="#cart_modal" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-block dropdown-toggle"><i class="fa fa-shopping-cart"></i> <span id="cart-total" class="badge"><?php echo $text_items; ?></span></button>
</div> 
