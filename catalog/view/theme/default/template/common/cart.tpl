<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="modal" data-target="#cart_modal" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-block btn-lg dropdown-toggle"><i class="fa fa-cart-arrow-down fa-5x"></i> <span id="cart-total"><?php echo $text_items; ?></span></button>
</div> 
