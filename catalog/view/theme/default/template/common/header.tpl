...
<?php } ?>
<script src="catalog/view/javascript/mf/jquery-ui.min.js?v=6" type="text/javascript"></script>
<link href="catalog/view/javascript/bootstrap/css/bootstrap.min.css?v=6" rel="stylesheet" media="screen" />
