			...
			<table id="gp-table" class="gp-table table table-bordered">
				<thead>
					<tr>
						...
						<td class="text-right"><?php echo $column_gp_price; ?></td>
						<?php } ?>
					...
					<tr data-gp-child-row="<?php echo $child_id; ?>">
						...
						<td class="gp-col-image">
							<a class="gp-child-image" href="<?php echo $child['image']['popup']; ?>" title="<?php echo $child['name']; ?>">
								<img src="<?php echo $child['image']['thumb'] ?>" alt="<?php echo $child['name'] ?>" />
							</a>
						</td>
						<?php } ?>
				...
				<td class="gp-col-qty">
					...
					<?php } else { ?>
					<input name="quantity" id="quantity<?php echo $child_id; ?>" type="text" value="<?php echo $child['qty_now']; ?>" class="form-control" />
					<?php } ?>
				</td>
				<td class="gp-col-btn">
