<?php echo $header; ?><div id="columns">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
        ...
        <div class="<?php echo $class; ?>">
						<div class="btn-group">
							<button type="button" data-toggle="tooltip"
								class="btn btn-default" title="<?php echo $button_wishlist; ?>"
								onclick="wishlist.add('<?php echo $product_id; ?>');">
								<i class="fa fa-heart"></i>
							</button>
							<button type="button" data-toggle="tooltip"
								class="btn btn-default" title="<?php echo $button_compare; ?>"
          ...
          <div id="product">
            ...
            <div class="form-group">
								...
								<input type="text" name="quantity"
									value="<?php echo $minimum; ?>" size="2" id="input-quantity"
									class="form-control" /> <input type="hidden" name="product_id"
									value="<?php echo $product_id; ?>" /> <br />
								<button type="button" id="button-cart"
									data-loading-text="<?php echo $text_loading; ?>"
									class="btn btn-primary btn-lg btn-block"><?php echo $button_add_to_cart; ?></button>
							</div>
            <?php if ($minimum > 1) { ?>
          ...
          <?php } ?>
					...
					<div class="col-sm-12">
						<div class="table-responsive col-sm-12 white">
							<table id="gp-table"
								class="gp-table table table-hover table-stripped">
								<thead>
									<tr>
      ...
      <tr data-gp-child-row="<?php echo $child_id; ?>">
        <?php if ($column_gp_image) { ?>
        <td class="gp-col-image"><a class="gp-child-image"
											href="<?php echo $child['image']['popup']; ?>"
											title="<?php echo $child['name']; ?>"><img
												src="<?php echo $child['image']['thumb'] ?>"
												alt="<?php echo $child['name'] ?>" /></a></td>
        <?php } ?>
        <?php if ($dbe) { ?>
        	<td class="gp-col-checkbox"><input type="checkbox"
											name="products[]" id="pcd-<?php echo $child['child_id']; ?>"
											value="<?php echo $child['child_id']; ?>" /><label
											for="pcd-<?php echo $child['child_id']; ?>"></label></td>
        <?php } ?>
...
/*
        ...
        <td class="gp-col-qty">
          ...
          <input name="" type="text" value="" class="form-control"
											disabled="disabled" title="<?php echo $text_gp_no_stock; ?>" />
          <?php } else { ?>
          <input name="quantity" id="quantity<?php echo $child_id; ?>"
											type="text" value="<?php echo $child['qty_now']; ?>"
											class="form-control" size="2" />
          <?php } ?>
        </td>
										<td class="gp-col-btn"><input type="hidden" name="product_id"
											id="product<?php echo $child_id; ?>"
											value="<?php echo $child_id; ?>" />
          <?php if ($child['enabled']) {?>
          <button type="button"
												data-loading-text="<?php echo $text_loading; ?>"
												onclick="addGpGrouped('<?php echo $child_id; ?>');"
												class="btn btn-default"><?php echo $button_add_to_cart; ?></button>
          <?php } ?>
          <button type="button"
												data-loading-text="<?php echo $text_loading; ?>"
												onclick="addGpGroupedToQuote('<?php echo $child_id; ?>');"
												class="btn btn-default"><?php echo $button_add_to_quote; ?></button>
										</td>
									</tr>
      <?php } ?>
    </tbody>
