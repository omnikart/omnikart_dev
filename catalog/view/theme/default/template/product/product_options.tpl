      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <?php if ($discount) { ?>
              	<span style="text-decoration: line-through;"><?php echo $original_price; ?></span><span
								style="padding: 1px; background: #ddd; border-radius: 2px;"><?php echo $discount; ?>% Off</span>
              <?php } ?>
          ...
          <div id="product">
								...
								<div class="col-sm-3">
									<div class="input-group">
										...
										<input type="text" name="quantity"
											...
											class="form-control col-sm-6" /> <input type="hidden"
											name="product_id" value="<?php echo $product_id; ?>" /> <input
											type="hidden" name="products[]"
								...
								<div class="col-sm-3">
									<div class="input-group">
										<button type="button" id="button-cart"
											data-loading-text="<?php echo $text_loading; ?>"
											class="btn btn-primary btn-block"><?php echo $button_cart; ?></button>
									</div>
								</div>
            ...
            <?php } ?>
				...
				<?php if ($curr_vendor) {  ?>
    				<div class="vendor">
							Sold by:<br /> <a href="<?php echo $vlink; ?>"><?php echo $curr_vendor['companyname']; ?></a>
							<input type="hidden" name="vendor_id"
								value="<?php echo $curr_vendor['vendor_id']; ?>">
						</div>      	
          		<?php } ?>
