<form class="form-horizontal"
	action="https://secure.bluepay.com/interfaces/bp10emu" method=POST>
	<fieldset id="payment">
		...
		<?php if (!empty($existing_cards)) { ?>
			...
			<div class="col-sm-10">
				<label class="radio-inline"> <input type="radio" name="new-existing"
					value="existing" checked="checked" />
						<?php echo $entry_card_existing; ?>
					</label> <label class="radio-inline"> <input type="radio"
					name="new-existing" value="new" />
		...
		<div style="display: none" id="card-new">
			<?php } else { ?>
				...
				<?php if ($bluepay_redirect_card) { ?>
					...
					<div class="col-sm-2">
						<input id="input-cc-save" type="checkbox" name="CreateToken"
							value="1" />
					</div>
				</div>
				<?php } ?>
