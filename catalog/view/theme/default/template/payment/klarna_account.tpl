...
<p>
	<img
		src="https://cdn.klarna.com/public/images/<?php echo $iso_code_2; ?>/badges/v1/account/<?php echo $iso_code_2; ?>_account_badge_std_blue.png?width=150&eid=<?php echo $merchant; ?>" />
</p>
<form id="payment" class="form-horizontal">
    ...
    <div class="radio">
        ...
        <input type="radio" name="code"
				value="<?php echo $payment_option['code']; ?>" checked="checked" />
        <?php } else { ?>
        <input type="radio" name="code"
				value="<?php echo $payment_option['code']; ?>" />
        <?php } ?>
        <?php if ($iso_code_3 == 'NLD') { ?>
        <img
				src="catalog/view/theme/default/image/klarna_nld_banner.png" />
        <?php } ?>
    ...
    <div class="form-group required">
			...
			<div class="col-sm-10">
				<input type="text" name="pno" value="" id="input-pno"
					class="form-control" />
			</div>
		</div>
    <?php } ?>
    ...
    <div class="form-group required">
			...
			<div class="col-sm-10">
				<input type="text" name="pno" value="" id="input-company"
					class="form-control" />
			</div>
		</div>
    <?php } ?>
    ...
    <div class="form-group required">
			...
			<div class="col-sm-10">
				<label class="radio-inline"> <input type="radio" name="gender"
					value="1" />
          <?php echo $text_male; ?></label> <label class="radio-inline">
		...
		<div class="form-group required">
			...
			<div class="col-sm-10">
				<input type="text" name="house_no"
					value="<?php echo $street_number; ?>" id="input-house-no"
					class="form-control" />
			</div>
		</div>
    <?php } ?>
    ...
    <div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" name="house_ext"
					value="<?php echo $street_extension; ?>" id="input-house-ext"
					class="form-control" />
			</div>
		</div>
    <?php } ?>
    <div class="form-group required">
			...
			<div class="col-sm-10">
				<input type="text" name="phone_no"
					value="<?php echo $phone_number; ?>" id="input-phone-no"
					class="form-control" />
			</div>
		</div>
    <?php if ($iso_code_3 == 'DEU') { ?>
    <div class="radio">
			<input type="checkbox" name="deu_terms" value="1" /> Mit der
			Übermittlung der für die Abwicklung des Rechnungskaufes und einer
			Identitäts - und Bonitätsprüfung erforderlichen Daten an Klarna bin
			ich einverstanden. Meine <a
				href="https://online.klarna.com/consent_de.yaws" target="_blank">Einwilligung</a>
...
<div class="buttons">
	<div class="pull-right">
		<input type="button" value="<?php echo $button_confirm; ?>"
			id="button-confirm" data-loading-text="<?php echo $text_loading; ?>"
