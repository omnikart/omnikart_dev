...
<link
		href="<?php echo $url_inlude; ?>catalog/view/javascript/mmosolution/bootstrap/css/bootstrap_custom.css"
		rel="stylesheet" media="screen" />
	<script type="text/javascript"
		src="<?php echo $url_inlude; ?>catalog/view/javascript/mmosolution/jquery.qtip.custom/jquery.qtip.min.js"></script>
	<link rel="stylesheet" type="text/css"
		href="<?php echo $url_inlude; ?>catalog/view/javascript/mmosolution/jquery.qtip.custom/jquery.qtip.min.css" />
...
.wait-processing-onepage {
	...
	height: 24px;
	border-radius: 2px;
	background-image: url('<? php echo $ url_inlude;
		?>
	catalog
	/view/theme/default/image/loading_bar_icon/<?php
