...
<?php if (isset($new_payment_address_id) && $new_payment_address_id !== false) { ?><input type="hidden" id="new_payment_address_id"	name="new_payment_address_id"	value="<?php echo $new_payment_address_id; ?>" /><?php } ?><div id="payment-address-options" style="<?php
...
?>">	<div class="radio">		<label for="payment-address-existing"> <input type="radio"			name="payment_address" value="existing" id="payment-address-existing"			<?php if ($use_exist) echo 'checked="checked"'; ?> />
        <?php echo $text_address_existing; ?> </label>	</div>	<div class="radio clearfix">		<label for="payment-address-new"> <input type="radio"			name="payment_address" value="new" id="payment-address-new"			<?php
...
?>">	<form class="form-horizontal" role="form">		<div class="form-group form-group-sm ">			<span class="required">*</span> <?php echo $entry_firstname; ?>
            ...
            <input type="text" name="city" id="input-payment-city"				value="<?php
        ...
        <div			class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> form-group-sm custom-field"			data-sort="<?php echo $custom_field['sort_order']; ?>">			<label class="control-label"				for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?>fadf</label>			<div>				<div class="input-group date">					<input type="text"						name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]"						value="<?php echo $custom_field['value']; ?>"						placeholder="<?php echo $custom_field['name']; ?>"						data-date-format="YYYY-MM-DD"						id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"						class="form-control" /> <span class="input-group-btn">						<button type="button" class="btn btn-default">							<i class="fa fa-calendar"></i>						</button>					</span>				</div>			</div>		</div>
        <?php } ?>
        ...
        <?php } ?>
                ...
                <div class="checkbox">		<label>
                        <?php if ($shipping_address_same) { ?>
                            <input type="checkbox"			name="shipping_address_same" value="1" checked="checked" />
                        <?php } else { ?>
                            <input type="checkbox"			name="shipping_address_same" value="1" />
                        <?php } ?>
