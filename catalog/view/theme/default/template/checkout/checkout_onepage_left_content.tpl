...
?>" style="<?php
    ...
    <div class="panel-body">
            ...
            <div  id="checkout-options">
                <div class="list-group">
                    <li href="#" class="list-group-item ">
                        ...
                        ?>"  style="font-size: 1.5em;"><i class="fa fa-certificate"  style="font-size: 1em;"></i>&nbsp;<?php echo $text_checkout; ?>
                        </span>
                    </li>
                    <?php if ($guest_checkout) { ?>
                        <a href="javascript:void(0);" class="list-group-item  <?php
        ...
        <?php } ?>
                                    <strong><?php echo $text_guest; ?>&nbsp;<i class="fa fa-pencil"></i></strong>
                                </label>
                            </div>
                        </a>
                    <?php } ?>
    ...
    <?php } ?>
                                <strong><?php echo $text_register; ?>&nbsp;<i class="fa fa-pencil-square-o"></i> </strong>
                            </label>
                        </div>
                    </a>
                    <a href="javascript:void(0);" class="list-group-item <?php
    ...
    <?php if ($account_view == 'returning-customer') { ?>
                                    <input type="radio" name="account" value="returning-customer" id="returning-customer" checked="checked">
    <?php } else { ?>
                                    <input type="radio" name="account" value="returning-customer" id="returning-customer">
    <?php } ?>
                                <strong><?php echo $text_i_am_returning_customer; ?>&nbsp;<i class="fa fa-user"></i> </strong>
                            </label>
                        </div>
                    </a>
                </div>
