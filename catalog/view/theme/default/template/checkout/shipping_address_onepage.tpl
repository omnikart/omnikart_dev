...
<?php if (isset($new_shipping_address_id) && $new_shipping_address_id !== false) { ?>
    <input type="hidden" id="new_shipping_address_id" name="new_shipping_address_id" value="<?php echo $new_shipping_address_id; ?>"/>
<?php } ?>
...
?>">
    <form class="form-horizontal" role="form">
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="firstname"  id="input-shipping-firstname" value="<?php
        ...
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="lastname"  id="input-shipping-lastname" value="<?php
        ...
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="company"  id="input-shipping-company" value="<?php
        ...
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="address_1"  id="input-shipping-address-1" value="<?php
        ...
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="address_2"  id="input-shipping-address-2" value="<?php
        ...
        <div class="form-group form-group-sm ">
            ...
            <input type="text" name="city"  id="input-shipping-city" value="<?php
    ...
    <div class="panel-footer">
        <div class="text-right">
            <input type="button" value="<?php echo $button_ok; ?>" id="button-shipping-address" class="btn btn-sm btn-<?php
                   ...
                   if($use_exist){echo 'display:none;';}
                   ?>"/>
        </div>
    </div>
</div>
