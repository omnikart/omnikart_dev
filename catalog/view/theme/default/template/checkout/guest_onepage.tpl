        ...
        <form  role="form">
            <fieldset id="account-guest">
                            ...
                            <div class="customer-groups">
                                <?php foreach ($customer_groups as $customer_group) { ?>
                                    <?php if ($customer_group['customer_group_id'] == $customer_group_id) { ?>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" id="guest-customer_group_id<?php echo $customer_group['customer_group_id']; ?>" checked="checked" />
                                    ...
                                    <?php } else { ?>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" id="guest-customer_group_id<?php echo $customer_group['customer_group_id']; ?>" />
                                                <strong><?php echo $customer_group['name']; ?></strong>
                                            </label>
                                        </div>
                                    <?php } ?>
                ...
                <div class="form-group form-group-sm required">
                    ...
                    <input type="text" name="firstname"  id="input-payment-firstname" value="<?php echo $firstname; ?>"class="form-control input-sm">
                </div>
                <div class="form-group form-group-sm required">
                    <label class="control-label"> <?php echo $entry_lastname; ?></label>
                    <input type="text" name="lastname"  id="input-payment-lastname" value="<?php echo $lastname; ?>" class="form-control input-sm" />
                </div>
                <div class="form-group form-group-sm required">
                    <label class="control-label"> <?php echo $entry_email; ?></label>
                    <input type="text" name="email"  id="input-payment-email" value="<?php echo $email; ?>" class="form-control input-sm" />
                </div>
                ...
                ?>">
                        ...
                        <input type="text" name="telephone"  id="input-payment-telephone" value="<?php echo $telephone; ?>" class="form-control input-sm" />
                    <?php } else { ?>
                        <?php echo $entry_telephone; ?>
                        <input type="text" name="telephone"  id="input-payment-telephone" value="0000" class="form-control input-sm" />
                    <?php } ?>
                </div>
                <div class="form-group form-group-sm <?php
                ...
                ?>">
                    ...
                    <input type="text" name="fax"  id="input-payment-fax" value="<?php echo $fax; ?>" class="form-control input-sm" />
                </div>
                ...
                <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                  ...
                  <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control input-sm">
            ...
            <fieldset id="address-guest">
                ...
                ?>">
                    <div class="form-group form-group-sm ">
                        ...
                        <input type="text" name="company"  id="input-payment-company" value="<?php echo $company; ?>" class="form-control input-sm" />
                    </div>

                    <div class="form-group form-group-sm required">
                        <label class="control-label"> <?php echo $entry_address_1; ?></label>
                        <input type="text" name="address_1"  id="input-payment-address-1" value="<?php echo $address_1; ?>" class="form-control input-sm">
                    </div>
                    <div class="form-group form-group-sm ">
                        <label class="control-label"> <?php echo $entry_address_2; ?></label>
                        <input type="text" name="address_2"  id="input-payment-address-2" value="<?php echo $address_2; ?>" class="form-control input-sm" />
                    </div>
                    <div class="form-group form-group-sm required">
                        <label class="control-label"> <?php echo $entry_city; ?></label>
                        <input type="text" name="city"  id="input-payment-city" value="<?php echo $city; ?>" class="form-control input-sm">
                    </div>
                    <div class="form-group form-group-sm ">
                       <label class="control-label">  <span id="guest-payment-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></label>
                        <input type="text" name="postcode"  id="input-payment-postcode" value="<?php echo $postcode; ?>"class="form-control input-sm">
                    </div>
                    ...
                    <div class="checkbox">
                        <label>
                            <?php if (!empty($shipping_address_same)) { ?>
                                <input type="checkbox" name="shipping_address_same" value="1" id="guest-shipping" checked="checked" />
                            <?php } else { ?>
                                <input type="checkbox" name="shipping_address_same" value="1" id="guest-shipping" />
                            <?php } ?>
