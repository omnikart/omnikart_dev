...
<div class="row" id="billing-shipping-methods">
            ...
            ?>" style="<?php
                ...
                ?>">
                    <h3 class="panel-title">
                        ...
                        <strong><?php echo $text_checkout_shipping_method; ?></strong>
                        <span id="shipping-method-wait" class="glyphicon glyphicon-refresh glyphicon-spin-animate hidden"></span>
                    </h3>
                </div>
                <div class="panel-body">
                    <?php if (!empty($tips['shipping_method_tip'][$config_language_id])) { ?>
                        <i class="fa fa-lightbulb-o"></i>&nbsp;<small class="text-warning"><i><?php echo $tips['shipping_method_tip'][$config_language_id]; ?></i></small>
                    <?php } ?>
            ...
            ?>" style="<?php
                ...
                ?>">
                    <h3 class="panel-title">
                        ...
                        <strong><?php echo $text_checkout_payment_method; ?></strong>
                        <span id="payment-method-wait" class="glyphicon glyphicon-refresh glyphicon-spin-animate hidden"></span>
                    </h3>
                </div>
                <div class="panel-body">
                    <?php if (!empty($tips['payment_method_tip'][$config_language_id])) { ?>
                        <i class="fa fa-lightbulb-o"></i>&nbsp;<small class="text-warning"><i><?php echo $tips['payment_method_tip'][$config_language_id]; ?></i></small>
                    <?php } ?>
  ...
  <?php if($mmos_checkout['enable_giftcart'] == 1 ||  $mmos_checkout['enable_counpon'] == 1 ): 
...
<div class="row" id="reward">
      ...
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapsereward" aria-expanded="true" aria-controls="collapsereward">
         <?php echo $heading_title; ?>
         <span class="glyphicon glyphicon-chevron-down" aria-hidden="true" style="position: absolute; top:10px; right: 10px;"></span>
        </a>
      </h4>
    </div>
             <div id="collapsereward" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapsereward">
                <div  class="panel-body">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-xs-12">
                                <div class="input-group input-group-sm">
                                <input type="text" name="reward" class="form-control" placeholder="<?php echo $entry_reward; ?>">
...
<div class="row"  id="voucher-coupon">
    <div class="col-xs-12" >
        <div id="voucher-coupon-panel"  class="panel panel-<?php
        if ($css['checkout_theme'] == 'standar') {
            echo 'success';
        } else {
            echo $css['checkout_theme'];
	...
	<div class="panel-heading" role="tab" id="headingvoucher-coupon">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapsevoucher-coupon" aria-expanded="true" aria-controls="collapsevoucher-coupon">
       <?php echo $entry_heading_voucher.' & '.$entry_heading_coupon;?> 
        <span class="glyphicon glyphicon-chevron-down" aria-hidden="true" style="position: absolute; top:10px; right: 10px;"></span>
             ...
             <div id="collapsevoucher-coupon" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapsevoucher-coupon">
                    ...
                    <!-- Voucher -->
                        <div class="<?php echo  $couponclass; ?> col-xs-12">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" name="voucher" class="form-control" placeholder="<?php echo $entry_voucher; ?>">
                                <span class="input-group-btn">
                        ...
                        <div class="<?php echo  $couponclass; ?> col-xs-12">
                            <div class="input-group  input-group-sm">
                                ...
                                <input type="text" name="coupon" class="form-control" placeholder="<?php echo $entry_coupon; ?>">
                                <span class="input-group-btn">
...
?>"  style="<?php
    ...
    ?>">
        ...
        <h3 class="panel-title">
            ...
            <span id="summary-wait" class="glyphicon glyphicon-refresh glyphicon-spin-animate hidden"></span>
        </h3>
