...
<div class="row">
	<div class="table-responsive">
		<table class="table  table-bordered table-striped"
            ...
            <?php endif; ?>
            <tr>
					<td class="name"><a href="<?php echo $product['href']; ?>"> <img
							class="product-image" src="<?php echo $product['thumb']; ?>"
							alt="<?php echo $product['name']; ?>" /> <span
							style="padding-left: 1em;"><?php echo $product['name']; ?></span>
							<input class="product-name" type="hidden"
					...
					<td class="text-center"><strong><?php echo $product['quantity']; ?></strong>
					</td>
