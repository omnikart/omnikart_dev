...
if (! empty ( $subcategories )) {
						...
						<?php } ?>
						<?php foreach ($categories as $category) { ?>
							<li class="viewmore"><a href="<?php echo $category['href']; ?>">View
								More</a></li>
						<?php } ?>
					</ul>
				</div>
...
<?php foreach ($products as $product) { ?>
  <div
				class="product-layout product-grid col-lg-3 col-md-3 col-sm-4 col-xs-6">
				<div class="product-thumb row">
					<div class="image">
						<a href="<?php echo $product['href']; ?>"><img
							...
							class="img-responsive lazyOwl" /></a>
					</div>
					<div>
						<div class="caption">
							<h4>
