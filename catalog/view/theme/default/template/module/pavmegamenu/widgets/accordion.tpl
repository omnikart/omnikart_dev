...
<div
	...
	<div class="widget-inner box-content">
		<div id="accordion<?php $id?>" class="panel-group">
	 	<?php foreach ( $accordions as $key => $ac ) { ?>
		
				<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a href="#collapseAc<?php $id?><?php $key?>"
							data-parent="#accordion<?php $id?>" data-toggle="collapse"
				...
				<div
					class="panel-collapse collapse <?php if ( $key==0 ) { ?> in <?php } else { ?> out<?php } ?>"
					id="collapseAc<?php echo $id?><?php echo $key; ?>">
