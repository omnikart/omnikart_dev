		...
		<div class="row box-outer">
				...
				<div class="reassurances-left">
					...
					<div class="description media-body">
						...
						<a href="javascript:void(0);" class="pavreassurances arrow"
							data-toggle="modal"
							data-target="<?php echo empty($reassurance['reassurance_3rdmodel'])?"#myModal".$i:"#".$reassurance['reassurance_3rdmodel'];?>"></a>
