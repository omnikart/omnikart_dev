		...
		<div id="blog-comment">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2 class="panel-title">
						<span class="<?php echo $titleicon_list; ?>"></span>&nbsp;<?php echo $title_commentlist; ?></h2>
				</div>
			...
			<?php if(!empty($comments)): ?>
				...
				foreach ( $comments as $comment ) :
					...
					<li class="comment">
							<div
								class="comment-author <?php echo $author_photo_position ? 'comment-author-'.$author_photo_position : null; ?>">
						<?php if($author_photo_display) : ?>
						<div class="author-img">
									<img class="img-rounded"
										src="<?php echo $comment['author_image']; ?>"
										onerror="this.style.display='none'" alt="">
								</div>
						<?php endif; ?>
						<span>BY: <?php echo $comment['comment_author']; ?>, </span> <span><?php echo $comment['comment_date']; ?></span>
							</div>
							<div
								class="comment-content <?php echo $author_photo_position ? 'comment-content-'.$author_photo_position : null; ?>">
...
<div class="row">
	<div class="col-lg-12">
		<div id="comment-form" class="panel panel-default">
			<div class="panel-heading">
				<h2 class="panel-title">
					<span class="<?php echo $titleicon_comment; ?>"></span>&nbsp;<?php echo $title_commentbox; ?></h2>
			</div>
			<div class="panel-body">
			...
			<div class="form-group">
						...
						<div class="col-sm-12">
					<?php if ($login) { ?>
						<span><a href="<?php echo $login_url; ?>">Login </a>to post
								comment</span>
					<?php } ?>
					<textarea name="comment" id="comment" rows="10"
								class="form-control" data-toggle="tooltip" data-placement="top"
								data-original-title="" <?php echo ($login?'disabled':''); ?>></textarea>
