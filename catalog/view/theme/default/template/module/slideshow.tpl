<div class="row">
	<div class="col-sm-<?php echo 12-$margin_left; ?>"
		<?php if ($status_side) echo 'style="padding-right:0"';?>>
			...
			<ul class="slides">
			  ...
			  <li>
			    ...
			    <a href="<?php echo $banner['link']; ?>"><img
						...
						alt="<?php echo implode(',',$banner['title']); ?>"
	...
	<?php if ($status_side) { ?>
		<div class="col-sm-<?php echo $margin_left; ?>"
		style="padding-left: 0">
			<?php foreach ($side_banners as $banner) { ?>
			  <div class="item corner-fold">
				...
				data-target="<?php echo $banner['link']; ?>"><img
				src="<?php echo $banner['image']; ?>"
