...
<p>
	...
	<br /> Our customer has enquired about followed products. Please <a
		href="{supplierquote}"
		data-tooltip="Please use the login credentials provided to login or use forgot password to reset your password.">click
		here</a> to reply to this enquiry with smart quotation.
</p>
