<div class="modal" id="<?php echo $modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      	...
      	<form id="product_add_form" class="form-horizontal">
          	<div class="col-sm-12" id="enquiry-product-details">
				...
				<div class="form-group">
	          		...
	          		<div class="col-sm-9">
	          			<textarea type="text" id="enquiry-description" class="form-control" name="description" rows="4"></textarea>
	          		</div>
	          	</div>
	          	<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<div class="row">
							<div class="col-sm-5">
		          				<a type="text" class="btn btn-default btn-block" id="button-upload">Upload</a>
		          			</div>
		          			<div class="col-sm-5 pull-right">
								<a type="text" class="btn btn-default btn-block" id="button-addproduct">Add Product</a>
							</div>
						</div>
	          		</div>
	          	</div>
      ...
      <button type="button" class="btn btn-default" id="view-enquiry">Enquiries <span class="badge">0</span></button>
