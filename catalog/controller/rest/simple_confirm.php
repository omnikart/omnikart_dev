...
class ControllerRestSimpleConfirm extends RestController {
	...
	private function pay($data) {
		$response = '<html lang="en">' . '<head>' . '<meta charset="utf-8">' . '<meta http-equiv="X-UA-Compatible" content="IE=edge">' . '<meta name="viewport" content="width=device-width, initial-scale=1">' . '<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">' . '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>' . '<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>' . '</head>' . '<body>' . $this->load->view ( 'default/template/checkout/confirm.tpl', $data ) . '</body>' . '</html>';
		echo ($response);
		die ();
	}
}