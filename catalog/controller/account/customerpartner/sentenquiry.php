<?php
class ControllerAccountCustomerpartnerSentEnquiry extends Controller {
	private $error = array ();
	private $data = array ();
	public function index() {
		...
		if (file_exists ( DIR_TEMPLATE . $this->config->get ( 'config_template' ) . '/template/account/customerpartner/sentenquiry.tpl' )) {
			$this->response->setOutput ( $this->load->view ( $this->config->get ( 'config_template' ) . '/template/account/customerpartner/sentenquiry.tpl', $this->data ) );
		} else {
			$this->response->setOutput ( $this->load->view ( 'default/template/account/customerpartner/sentenquiry.tpl', $this->data ) );
		}
	}
