<?php
class ControllerAccountCustomerpartnerUserregistration extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->session->data['success'] = "Success: You have successfully added user under your company";
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('account/customerpartner/userregistration', '', 'SSL')
		);

		$data['heading_title'] = $this->language->get('heading_title');

		$data['text_account_already'] = '';
		$data['text_your_details'] = str_replace("Your","",$this->language->get('text_your_details'));
		$data['text_your_address'] = str_replace("Your","",$this->language->get('text_your_address'));
		$data['text_your_password'] = str_replace("Your","",$this->language->get('text_your_password'));
		...
		$data['action'] = $this->url->link('account/customerpartner/userregistration', '', 'SSL');
