...
class ControllerModuleBlogComment extends Controller {
	...
	public function index($settings) {
		...
		$comments = $this->model_blog_comment->comments ( array (
				"bc.comment_post_ID" => "='" . $post_id . "'",
				"bc.comment_approve" => "='publish'" 
		), "bc.comment_ID DESC", ($page - 1) * $limit, $limit );
		$totla_comment = $this->model_blog_comment->total_comment ( array (
		...
		$post_info = $this->model_blog_post->getPost ( array (
				"ID" => "='" . $post_id . "'" 
		) );
