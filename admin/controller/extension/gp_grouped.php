...
class ControllerExtensionGpGrouped extends Controller {
	...
	public function index() {
		...
		// Display Child Info
		$data['get_child_infos'] = array('model', 'sku', 'upc', 'ean', 'jan', 'isbn', 'mpn', 'quantity', 'stock', 'manufacturer', 'points', 'date_available', 'weight', 'length', 'width', 'height', 'date_added', 'date_modified');
