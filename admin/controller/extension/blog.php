...
class ControllerExtensionBlog extends Controller {
	...
	protected function getForm() {
		...
		if (isset ( $this->request->post ['related_product'] )) {
			...
			$products = $this->model_extension_blog_post->productByPostid ( array (
	...
	public function comment_edit() {
		...
		$this->load->model ( 'extension/blog/comment' );
		$this->data ['comment'] = $this->model_extension_blog_comment->getComment ( array (
				"c.comment_ID" => "='" . $this->comment_id . "'" 
		) );
	...
	public function setting() {
		...
		$this->data ['setting_option'] = $this->model_extension_blog_setting->settings ( array (
				"setting_keyword" => "='option'" 
		), "position" );
		$this->data ['setting_image'] = $this->model_extension_blog_setting->settings ( array (
				"setting_keyword" => "='image'" 
		), "position" );
		$this->data ['setting_color'] = $this->model_extension_blog_setting->settings ( array (
				"setting_keyword" => "='color'" 
		), "position" );
		$this->data ['setting_social'] = $this->model_extension_blog_setting->settings ( array (
				"setting_keyword" => "='social'" 
		), "position" );
