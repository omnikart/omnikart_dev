...
class ControllerCommonStats extends Controller {
	public function index() {
		...
		$complete_total = $this->model_sale_order->getTotalOrders ( array (
		...
		$processing_total = $this->model_sale_order->getTotalOrders ( array (
		...
		$other_total = $this->model_sale_order->getTotalOrders ( array (
				'filter_order_status' => implode ( ',', $order_status_data ) 
		) );
