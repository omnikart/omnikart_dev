...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (! isset ( $this->request->get ['token'] ) || ! isset ( $this->session->data ['token'] ) || ($this->request->get ['token'] != $this->session->data ['token'])) {
			...
			// Processing Orders
			$data ['order_status_total'] = $this->model_sale_order->getTotalOrders ( array (
			...
			$return_total = $this->model_sale_return->getTotalReturns ( array (
			...
			$customer_total = $this->model_sale_customer->getTotalCustomers ( array (
			...
			$review_total = $this->model_catalog_review->getTotalReviews ( array (
					'filter_status' => false 
			) );
