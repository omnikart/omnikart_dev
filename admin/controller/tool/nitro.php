...
class ControllerToolNitro extends Controller {
	...
	public function clearnitrocaches() {
		...
		$result = $this->model_tool_nitro->clearPageCache () && $this->model_tool_nitro->clearHeadersCache () && $this->model_tool_nitro->clearDBCache () && $this->model_tool_nitro->clearCSSCache () && $this->model_tool_nitro->clearJSCache () && $this->model_tool_nitro->clearTempJSCache ();
	...
	public function clearallcaches() {
		...
		$result = $this->model_tool_nitro->clearPageCache () && $this->model_tool_nitro->clearHeadersCache () && $this->model_tool_nitro->clearDBCache () && $this->model_tool_nitro->clearImageCache () && $this->model_tool_nitro->clearCSSCache () && $this->model_tool_nitro->clearJSCache () && $this->model_tool_nitro->clearTempJSCache () && $this->model_tool_nitro->clearSystemCache () && $this->model_tool_nitro->clearVqmodCache ();
	...
	public function smush_read_dir($dir, $fh, &$total_images) {
		if (! file_exists ( $dir ))
			throw new RuntimeException ( "<b>Error:</b> Directory/file " . $dir . " could not be found" );
