...
class ControllerPaymentPPExpress extends Controller {
	...
	public function index() {
		...
		$data ['text_paypal_link'] = 'https://www.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?' . 'countryCode=' . $country ['iso_code_2'] . '&integrationType=F' . '&merchantId=David111' . '&displayMode=minibrowser' . '&partnerId=9PDNYE4RZBVFJ' . '&productIntentID=addipmt' . '&receiveCredentials=TRUE' . '&returnToPartnerUrl=' . base64_encode ( html_entity_decode ( $this->url->link ( 'payment/pp_express/live', 'token=' . $this->session->data ['token'], 'SSL' ) ) ) . '&subIntegrationType=S';
		
		$data ['text_paypal_link_sandbox'] = 'https://www.sandbox.paypal.com/webapps/merchantboarding/webflow/externalpartnerflow?' . 'countryCode=' . $country ['iso_code_2'] . '&integrationType=F' . '&merchantId=David111' . '&displayMode=minibrowser' . '&partnerId=T4E8WSXT43QPJ' . '&productIntentID=addipmt' . '&receiveCredentials=TRUE' . '&returnToPartnerUrl=' . base64_encode ( html_entity_decode ( $this->url->link ( 'payment/pp_express/sandbox', 'token=' . $this->session->data ['token'], 'SSL' ) ) ) . '&subIntegrationType=S';
