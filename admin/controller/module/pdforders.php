...
class Controllermodulepdforders extends Controller {
	...
	public function index() {
    	...
    	$data['formats'] = array("A4"=>"A4 - 210mm x 297mm","A0"=>"A0 - 841mm x 1189mm","A1"=>"A1 - 594mm x 841mm","A2"=>"A2 - 420mm x 594mm","A3"=>"A3 - 297mm x 420mm","A5"=>"A5 - 148mm x 210mm","LETTER"=>"LETTER -  216mm x 279mm","USLEGAL"=>"USLEGAL - 216mm x 356mm");
		...
		$data['fontstyles'] = array("helvetica"=>"HELVETICA","times"=>"TIMES","courier"=>"COURIER");
		...
		$data['orientations'] = array("P"=>"POTRAIT","L"=>"LANDSCAPE");
