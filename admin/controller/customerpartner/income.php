	...
	function index() {
		...
		foreach ($sellers as $key => $seller) {
			...
			$data['income_details'][] = array(
				...
				'total' => $this->currency->format($total,$this->config->get('currency_id')),
				'seller_total' => $this->currency->format($selleramount,$this->config->get('currency_id')),
				'admin_total' => $this->currency->format($admin,$this->config->get('currency_id')),
				'paid_total' => $this->currency->format($paid,$this->config->get('currency_id')),
				'amount_to_pay' => $this->currency->format($rem,$this->config->get('currency_id')),
				...
				'pay' => $this->language->get('button_pay')." ".$this->currency->format($rem,$this->config->get('currency_id')),
		...
		$data['grand_total'] = $this->currency->format($data['grand_total'],$this->config->get('currency_id'));
		$data['grand_total_seller'] = $this->currency->format($data['grand_total_seller'],$this->config->get('currency_id'));
		$data['grand_total_paid'] = $this->currency->format($data['grand_total_paid'],$this->config->get('currency_id'));
		$data['grand_total_admin'] = $this->currency->format($data['grand_total_admin'],$this->config->get('currency_id'));
		$data['grand_total_rem'] = $this->currency->format($data['grand_total_rem'],$this->config->get('currency_id'));
