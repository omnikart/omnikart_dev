...
class ControllerCustomerpartnerCommission extends Controller {
	...
	public function category() {
		...
		$this->data ['delete'] = $this->url->link ( 'customerpartner/commission/delete', 'token=' . $this->session->data ['token'], 'SSL' );
		$this->data ['insert'] = $this->url->link ( 'customerpartner/commission/addcategory', 'token=' . $this->session->data ['token'], 'SSL' );
		...
		foreach ( $results as $result ) {
			...
			$this->data ['commission'] [] = array (
					...
					'id' => $result ['id'],
					'name' => $result ['name'],
					'value' => '<span class="fixed">' . $this->data ['entry_fixed'] . '</span> - ' . $result ['fixed'] . ' + <span class="percentage">' . $this->data ['entry_percentage'] . '</span> - ' . $result ['percentage'] . ' %',
					'action' => $this->url->link ( 'customerpartner/commission/addcategory&id=' . $result ['id'], 'token=' . $this->session->data ['token'] ) 
			);
		}
		...
		$this->data ['sort_name'] = $this->url->link ( 'customerpartner/commission', 'token=' . $this->session->data ['token'] . '&sort=cd.name' . $url, 'SSL' );
		$this->data ['sort_id'] = $this->url->link ( 'customerpartner/commission', 'token=' . $this->session->data ['token'] . '&sort=cc.id' . $url, 'SSL' );
		...
		$this->response->setOutput ( $this->load->view ( 'customerpartner/commission_category.tpl', $this->data ) );
	}
	public function addcategory() {
		...
		$this->data ['cancel'] = $this->url->link ( 'customerpartner/commission', 'token=' . $this->session->data ['token'] . $url, 'SSL' );
		$this->data ['save'] = $this->url->link ( 'customerpartner/commission/categorySave', 'token=' . $this->session->data ['token'] . $url, 'SSL' );
		...
		foreach ( $post_array as $postdata ) {
			if (isset ( $this->request->post [$postdata] ))
				$this->data [$postdata] = $this->request->post [$postdata];
			else
				$this->data [$postdata] = '';
		}
		...
		$this->data ['category'] = $this->model_customerpartner_commission->getCategories ( array () );
		$added_category = $this->model_customerpartner_commission->getAddedCategories ();
		$this->data ['added_category'] = array ();
		foreach ( $added_category as $value ) {
			$this->data ['added_category'] [] = $value ['category_id'];
		}
		
		$this->data ['commission_add'] = $this->config->get ( 'marketplace_commission_add' );
		
		$this->data ['header'] = $this->load->controller ( 'common/header' );
		$this->data ['footer'] = $this->load->controller ( 'common/footer' );
		$this->data ['column_left'] = $this->load->controller ( 'common/column_left' );
		
		$this->response->setOutput ( $this->load->view ( 'customerpartner/commission_category_form.tpl', $this->data ) );
	}
	...
	public function manual() {
		...
		$this->data ['delete'] = $this->url->link ( 'customerpartner/commission/deleteManual', 'token=' . $this->session->data ['token'], 'SSL' );
		$this->data ['insert'] = $this->url->link ( 'customerpartner/commission/addManual', 'token=' . $this->session->data ['token'], 'SSL' );
		...
		foreach ( $results as $result ) {
			...
			$this->data ['commission'] [] = array (
					...
					'name' => $result ['name'],
					'value' => '<span class="fixed">' . $this->data ['entry_fixed'] . '</span> - ' . $result ['fixed'] . ' + <span class="percentage">' . $this->data ['entry_percentage'] . '</span> - ' . $result ['percentage'] . ' %',
					'action' => $this->url->link ( 'customerpartner/commission/addManual&id=' . $result ['id'], 'token=' . $this->session->data ['token'] ) 
			);
		}
		...
		$this->data ['sort_name'] = $this->url->link ( 'customerpartner/commission/manual', 'token=' . $this->session->data ['token'] . '&sort=cd.name' . $url, 'SSL' );
		$this->data ['sort_id'] = $this->url->link ( 'customerpartner/commission/manual', 'token=' . $this->session->data ['token'] . '&sort=cc.id' . $url, 'SSL' );
	...
	public function addManual() {
		...
		$this->data ['cancel'] = $this->url->link ( 'customerpartner/commission/manual', 'token=' . $this->session->data ['token'] . $url, 'SSL' );
		$this->data ['save'] = $this->url->link ( 'customerpartner/commission/manualSave', 'token=' . $this->session->data ['token'] . $url, 'SSL' );
