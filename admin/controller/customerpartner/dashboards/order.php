...
class Controllercustomerpartnerdashboardsorder extends Controller {
	public function index() {
		...
		$today = $this->model_customerpartner_customerpartner->getSellerOrdersTotal ( array (
				'filter_date' => date ( 'Y-m-d', strtotime ( '-1 day' ) ) 
		), $customer_id );
		
		$yesterday = $this->model_customerpartner_customerpartner->getSellerOrdersTotal ( array (
