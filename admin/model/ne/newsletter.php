...
class ModelNeNewsletter extends Model {
	public function send($data) {
		...
		if (is_dir ( dirname ( DIR_DOWNLOAD ) . DIRECTORY_SEPARATOR . 'attachments' . DIRECTORY_SEPARATOR . $data ['attachments_id'] )) {
			foreach ( glob ( dirname ( DIR_DOWNLOAD ) . DIRECTORY_SEPARATOR . 'attachments' . DIRECTORY_SEPARATOR . $data ['attachments_id'] . DIRECTORY_SEPARATOR . '*' ) as $path ) {
				if (file_exists ( $path )) {
					$attachments [] = array (
