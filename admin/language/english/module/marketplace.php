...
$_['entry_customergroup']   			= 'Customer Group at Registration page ';
$_['entry_customergroupinfo']   		= 'Using this option, you can visible Become Customer Group for Customer at registration page .';

$_['entry_customergroupdisableaction']   			= 'Customer Group disable action';
$_['entry_customergroupdisableactioninfo']   		= 'Disable it if you want that whenever any customer group is disabled then all the customers under that customer group will be disabled else leave it enable';

$_['entry_productapprov']   			= 'Approve Product Automatic  ';
$_['entry_productapprovinfo']   		= 'Using this option, you don\'t have to approve/disapprove Products manually, products will be approve/disapprove to your store automatically.';

$_['entry_partnerapprov']   			= 'Approve Partner Automatic  ';
$_['entry_partnerapprovinfo']   		= 'Using this option, you don\'t have to approve Partners manually, Customers will become Partners or will not according to your selection as they apply.';

$_['wkentry_mailtoseller']  			= 'Mail to Seller/Partner After Order ';
$_['entry_mailtosellerinfo']  			= 'Using this, mail will send to Partners as any customer will buy there Products.';

$_['entry_customer_delete_product']  	= 'Partner Delete Product From Store ';
$_['entry_customer_add_product']  	= 'Partner Add Product From Store ';
$_['entry_customer_delete_productinfo'] = 'After enabling this when any customer delete product from his/her store then Product will automatically remove from your store too.';
$_['entry_customer_add_productinfo'] = 'After enabling this when any customer add product from his/her store then Product will automatically added to your store too.';

$_['wkentry_seller_order_status']  		= 'Partner can change Order Status ';
$_['wkentry_seller_order_statusinfo']  	= 'If you enable this then Partner can change status of Order related to his/her products or after disable it, he/she can only add order history with status added by admin.';
...
$_['entry_commission_workedinfo']  		= 'If you select this then all categories related to product combine commission will be your amount or one category will use for commission.';
...
$_['entry_priority_commissioninfo']  	= 'You can select commission priority but will use one if any found form top to bottom, please use mouse drop to reposition.';
...
$_['entry_alowed_product_columnsinfo']  = 'Select Product fields for partner to add/edit any product. We suggest you to at least enable Model, Price, Quantity. ';
...
$_['entry_seo_default_nameinfo']  = 'This will be used as seller\'s info if seller\'s info does not exist as per the above selection';
...
$_['entry_default_imageinfo']  		= 'It will be used as default image if image not uploaded by seller for profile or other values';
