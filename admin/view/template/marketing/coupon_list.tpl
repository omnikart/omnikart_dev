		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-coupon').submit() : false;">
			...
			<div class="panel-body">
                ...
                <tr>
                    ...
                    <input type="checkbox" name="selected[]"
										value="<?php echo $coupon['coupon_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]"
                    ...
                    <?php } ?></td>
									...
									<td class="text-right"><a href="<?php echo $coupon['edit']; ?>"
