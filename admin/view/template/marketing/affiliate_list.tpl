		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').submit() : false;">
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
                ...
                <tr>
                    ...
                    <a href="<?php echo $affiliate['approve']; ?>"
                    ...
                    <a href="<?php echo $affiliate['unlock']; ?>"
                    ...
                    <?php } ?>                   
                    <a href="<?php echo $affiliate['edit']; ?>"
