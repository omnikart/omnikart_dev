	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-marketing" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-marketing"
              ...
              <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-example"><span
							data-toggle="tooltip" title="<?php echo $help_example; ?>"><?php echo $entry_example; ?></span></label>
						<div class="col-sm-10">
							<input type="text" placeholder="<?php echo $entry_example; ?>"
								id="input-example1" class="form-control" /> <br /> <input
								type="text" placeholder="<?php echo $entry_example; ?>"
								id="input-example2" class="form-control" />
						</div>
					</div>
				</form>
			</div>
