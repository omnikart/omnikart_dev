	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-usps" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-usps"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-user-id"><?php echo $entry_user_id; ?></label>
						<div class="col-sm-10">
							<input type="text" name="usps_user_id"
								value="<?php echo $usps_user_id; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="usps_postcode"
								value="<?php echo $usps_postcode; ?>"
              ...
              <?php } ?>
                    ...
                    <input type="checkbox" name="usps_domestic_00"
                    ...
                    <input type="checkbox" name="usps_domestic_01"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_02"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_03"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_1"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_2"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_3"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_4"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_5"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_6"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_7"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_12"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_13"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_16"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_17"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_18"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_19"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_22"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_23"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_25"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_27"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_domestic_28"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_1"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_2"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_4"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_5"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_6"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_7"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_8"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_9"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_10"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_11"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_12"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_13"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_14"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_15"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_16"
										value="1" checked="checked" />
                    ...
                    <input type="checkbox" name="usps_international_21"
										value="1" checked="checked" />
                ...
                <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-4">
									<input type="text" name="usps_length"
										value="<?php echo $usps_length; ?>"
										placeholder="<?php echo $entry_length; ?>" id="input-length"
										class="form-control" />
								</div>
								<div class="col-sm-4">
									<input type="text" name="usps_width"
										value="<?php echo $usps_width; ?>"
										placeholder="<?php echo $entry_width; ?>" id="input-width"
										class="form-control" />
								</div>
								<div class="col-sm-4">
									<input type="text" name="usps_height"
										value="<?php echo $usps_height; ?>"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="usps_sort_order"
								value="<?php echo $usps_sort_order; ?>"
