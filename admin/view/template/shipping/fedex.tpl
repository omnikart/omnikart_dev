	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-fedex" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-fedex"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-key"><?php echo $entry_key; ?></label>
						<div class="col-sm-10">
							<input type="text" name="fedex_key"
								value="<?php echo $fedex_key; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="fedex_password"
								value="<?php echo $fedex_password; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="fedex_account"
								value="<?php echo $fedex_account; ?>"
								placeholder="<?php echo $entry_account; ?>" id="input-account"
								class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="fedex_meter"
								value="<?php echo $fedex_meter; ?>"
								placeholder="<?php echo $entry_meter; ?>" id="input-meter"
								class="form-control" />
              <?php if ($error_meter) { ?>
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="fedex_postcode"
								value="<?php echo $fedex_postcode; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-4">
									<input type="text" name="fedex_length"
										value="<?php echo $fedex_length; ?>"
										placeholder="<?php echo $entry_length; ?>" id="input-length"
										class="form-control" />
								</div>
								<div class="col-sm-4">
									<input type="text" name="fedex_width"
										value="<?php echo $fedex_width; ?>"
										placeholder="<?php echo $entry_width; ?>" id="input-width"
										class="form-control" />
								</div>
								<div class="col-sm-4">
									<input type="text" name="fedex_height"
										value="<?php echo $fedex_height; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="fedex_length_class_id" id="input-length-class"
								class="form-control">
                ...
                <input type="radio" name="fedex_display_weight"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="fedex_sort_order"
								value="<?php echo $fedex_sort_order; ?>"
