			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="flat_cost"
								value="<?php echo $flat_cost; ?>"
								placeholder="<?php echo $entry_cost; ?>" id="input-cost"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="flat_sort_order"
								value="<?php echo $flat_sort_order; ?>"
