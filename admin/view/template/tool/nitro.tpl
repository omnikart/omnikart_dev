...
<div id="content">
    ...
    <div class="alert alert-danger">
			<i class="icon-exclamation-sign"></i> <?php echo $error_warning; ?></div>
    <?php } ?>
    <?php if ($success) { ?>
    <div class="alert alert-success">
			<i class="icon-ok-sign"></i> <?php echo $success; ?></div>
    <?php } ?>

    <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="icon-plane"></i> <?php echo $heading_title; ?></h3>
			</div>
						...
						<div class="tab-navigation">
							<ul class="nav nav-tabs mainMenuTabs">
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown">Cache Systems <b class="caret"></b></a>
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown">CDN <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href="#cdn" data-toggle="tab">Generic CDN Service</a></li>
										<li><a href="#cdn-amazon" data-toggle="tab">Amazon
												CloudFront/S3 CDN</a></li>
										<li><a href="#cdn-rackspace" data-toggle="tab">Rackspace CDN</a></li>
										<li><a href="#cdn-cloudflare" data-toggle="tab">CloudFlare CDN</a></li>
										<li class="divider"></li>
										<li><a href="#cdn-network-status"
											onclick="checkNetworkStatus()" data-toggle="tab">Network
												Status</a></li>
									</ul></li>
								<li><a href="#cron_tab" data-toggle="tab">CRON</a></li>
								<li><a href="#smushit" data-toggle="tab">Image Optimization</a></li>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown">Get Support <b class="caret"></b></a>
									<ul class="dropdown-menu">
										<li><a href="#isense_support" data-toggle="tab">Get Support
												and Updates</a></li>
										<li><a href="#qa" data-toggle="tab">Frequently Asked Questions</a></li>
										<li class="divider"></li>
										<li><a href="#support-premium-services"
											class="premiumServicesMenuItem" data-toggle="tab"><i
												class="icon-briefcase"></i> &nbsp;&nbsp;Premium Services</a></li>
									</ul></li>
							</ul>
							<div class="tab-buttons">
								<div class="btn-group">
									<a href="javascript:void(0)"
										...
										class="icon-trash"></i> &nbsp;Clear Cache&nbsp; <span
										class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearnitrocaches&token=<?php echo $_GET['token']; ?>'"><i
												class="icon-trash"></i> Clear Nitro Cache</a></li>
										<li class="divider"></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearpagecache&token=<?php echo $_GET['token']; ?>'">Clear
												Page Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/cleardbcache&token=<?php echo $_GET['token']; ?>'">Clear
												Database Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearsystemcache&token=<?php echo $_GET['token']; ?>'">Clear
												System Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearimagecache&token=<?php echo $_GET['token']; ?>'">Clear
												Image Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearcsscache&token=<?php echo $_GET['token']; ?>'">Clear
												CSS Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearjscache&token=<?php echo $_GET['token']; ?>'">Clear
												JavaScript Cache</a></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearvqmodcache&token=<?php echo $_GET['token']; ?>'">Clear
												vQmod Cache</a></li>
										<li class="divider"></li>
										<li><a href="javascript:void(0)"
											onclick="document.location='index.php?route=tool/nitro/clearallcaches&token=<?php echo $_GET['token']; ?>'"><i
												class="icon-trash"></i> Clear All Caches</a></li>
									</ul>
								</div>
							...
							<div id="pane1" class="tab-pane active googlePageReportWidget">
								<div class="row">
									<div class="col-md-8">
										<div class="box-heading">
											<h1>
												Page Report &nbsp;<i class="icon-refresh"
													title="Re-gather report data"
													onclick="document.location='index.php?route=<?php echo $_GET['route']; ?>&token=<?php echo $_GET['token']; ?>&action=refreshgps'"></i><i
													class="icon-pagespeed"></i>
											</h1>
										</div>
                                ...
                                <?php require_once(DIR_APPLICATION.'view/template/tool/nitro/pagespeed_widget.php'); ?>
									...
									<div class="col-md-4">
										<div class="box-heading">
											<h1>
												<i class="icon-briefcase"></i> Want to speed your store even
												more?
											</h1>
										</div>
										<div class="box-content mini-jumbotron">
											<p>NitroPack does an awesome array of cool techy things that
												give your store an amazing speed boost, improve SEO and SEM
												and achieve higher search engine scores. Since every store
												has an unique set-up, there are many theme-specific and
												server-specific optimizations that can improve site loading
												speed even further. Our Premium Services are a proven method
												to overachieve and redefine what a fast OpenCart website is.
												All services are hand-coded, by our development team. Please
												get in touch with us at for a free consultation.</p>
											<a
												href="mailto:sales@isenselabs.com?subject=Free Consultation"
												class="btn btn-default pull-right" target="_blank"> <i
												class="icon-thumbs-up"></i> Get Free Consultation
											</a>
										</div>
									</div>
								</div>
