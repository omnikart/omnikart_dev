<table class="form browserCache">
  ...
  <tr>
    ...
    <td>
		<input class="form-control" type="text" name="Nitro[OpenCartCache][ExpireTime]" value="<?php echo !empty($data['Nitro']['OpenCartCache']['ExpireTime']) ? $data['Nitro']['OpenCartCache']['ExpireTime'] : '3600'?>" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
		<a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearsystemcache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default"><i class="icon-trash"></i> Clear OpenCart System Cache</a>
    </td>
  </tr>
</table>            
