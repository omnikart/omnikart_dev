    ...
    <div class="box-content">
      <table class="form browserCache">
        ...
        <tr>
          ...
          <td>
              <input class="form-control" type="number" name="Nitro[ImageCache][JPEGCompression]" max="100" min="0" value="<?php echo !empty($data['Nitro']['ImageCache']['JPEGCompression']) ? $data['Nitro']['ImageCache']['JPEGCompression'] : '90'?>" />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
              <a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearimagecache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default"><i class="icon-trash"></i> Clear OpenCart Image Cache</a>
          </td>
        </tr>
      </table>         
