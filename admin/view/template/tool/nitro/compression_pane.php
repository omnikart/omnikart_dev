         	...
         	<div id="compress-css" class="tab-pane active">
                <table class="form compression" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <td>
                      <select name="Nitro[Compress][CSSLevel]" val="<?php echo (!empty($data['Nitro']['Compress']['CSSLevel'])) ? $data['Nitro']['Compress']['CSSLevel'] : '4';?>" class="form-control compressionLevel" id="compressionLevel1">
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                  ...
                  <tr>
                  <td colspan="2"><a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearcsscache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default clearJSCSSCache"><i class="icon-trash"></i> Clear compressed CSS files cache</a></td>
                  </tr>
                </table> 
            </div>
         	<div id="compress-javascript" class="tab-pane">
                <table class="form compression" style="margin-top:-10px;">
                  ...
                  <tr>
                    <td>Compression Level<span class="help"><strong>Recommended: </strong>4</span></td>
                    <td>
                      <select name="Nitro[Compress][JSLevel]" val="<?php echo (!empty($data['Nitro']['Compress']['JSLevel'])) ? $data['Nitro']['Compress']['JSLevel'] : '4';?>" class="form-control compressionLevel" id="compressionLevel2">
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                  ...
                  <tr>
                  <td colspan="2"><a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearjscache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default clearJSCSSCache"><i class="icon-trash"></i> Clear compressed JavaScript files cache</a></td>
                  </tr>
                </table> 
            </div>
            ...
            <?php endif; ?>
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    <td>Compression Level<span class="help"><strong>Recommended: </strong>4</span></td>
                    <td>
                      <select name="Nitro[Compress][HTMLLevel]" val="<?php echo (!empty($data['Nitro']['Compress']['HTMLLevel'])) ? $data['Nitro']['Compress']['HTMLLevel'] : '4';?>" class="form-control compressionLevel" id="compressionLevel3">
                        <option>0</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
