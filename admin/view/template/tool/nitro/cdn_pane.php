  ...
  <div class="box-content">
    <table class="form cdnpanetable">
      <tr>
        ...
        <td>
          <input class="form-control" type="text" name="Nitro[CDNStandard][GenericURL]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['GenericURL'])) ? $data['Nitro']['CDNStandard']['GenericURL'] : ''?>" />
        </td>
      </tr>
    </table>
  </div>
  ...
  <div class="box-content">
    <table class="form cdnpanetable">
      <tr>
        ...
        <td>
        <select name="Nitro[CDNStandard][Enabled]" class="form-control NitroCDNStandard">
         	...
         	<div id="cdn-standard-images" class="tab-pane active">
                <table class="form cdnstandard" style="margin-top:-10px;">
                  <tr>
                    ...
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][ImagesHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['ImagesHttpUrl'])) ? $data['Nitro']['CDNStandard']['ImagesHttpUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>Images CDN HTTPS URL<span class="help">This is the SSL URL of your CDN server<br /><strong>https://&lt;FTP-Server&gt;/</strong></span></td>
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][ImagesHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['ImagesHttpsUrl'])) ? $data['Nitro']['CDNStandard']['ImagesHttpsUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                    <select class="form-control" name="Nitro[CDNStandard][ServeImages]">
         	...
         	<div id="cdn-standard-css" class="tab-pane">
                <table class="form cdnstandard" style="margin-top:-10px;">
                  <tr>
                    ...
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][CSSHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['CSSHttpUrl'])) ? $data['Nitro']['CDNStandard']['CSSHttpUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>CSS CDN HTTPS URL<span class="help">This is the SSL URL of your CDN server<br /><strong>https://&lt;FTP-Server&gt;/</strong></span></td>
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][CSSHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['CSSHttpsUrl'])) ? $data['Nitro']['CDNStandard']['CSSHttpsUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                    <select class="form-control" name="Nitro[CDNStandard][ServeCSS]">
         	...
         	<div id="cdn-standard-js" class="tab-pane">
                <table class="form cdnstandard" style="margin-top:-10px;">
                  <tr>
                    ...
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][JavaScriptHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['JavaScriptHttpUrl'])) ? $data['Nitro']['CDNStandard']['JavaScriptHttpUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                        <input class="form-control" type="text" name="Nitro[CDNStandard][JavaScriptHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNStandard']['JavaScriptHttpsUrl'])) ? $data['Nitro']['CDNStandard']['JavaScriptHttpsUrl'] : ''?>" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                    <select class="form-control" name="Nitro[CDNStandard][ServeJavaScript]">
    ...
    <div class="col-md-5">
    	<div class="cdnstandard-tabbable-parent">
            ...
            <div class="box-content cdnstandard-ftp-tabbable-parent" style="min-height:100px; line-height:20px;">
                ...
                <input class="form-control" type="hidden" name="Nitro[CDNStandardFTP][LastUpload]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['LastUpload']) ? $data['Nitro']['CDNStandardFTP']['LastUpload'] : ''; ?>" />
                ...
                <table class="form">
                  <tr class="cdnstandard-tabbable-parent">
                    ...
                    <td>
                    <select class="form-control" name="Nitro[CDNStandardFTP][Protocol]">
                  ...
                  <tr>
                    <td>FTP Host</td>
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNStandardFTP][Host]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['Host']) ? $data['Nitro']['CDNStandardFTP']['Host'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>FTP Port<span class="help">If left empty, 21 will be considered as default.</span></td>
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNStandardFTP][Port]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['Port']) ? $data['Nitro']['CDNStandardFTP']['Port'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>FTP Username<span class="help">This value will be hidden for users without modify access.</span></td>
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNStandardFTP][Username]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['Username']) ? $data['Nitro']['CDNStandardFTP']['Username'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>FTP Password<span class="help">This value will be hidden for users without modify access.</span></td>
                    <td>
                    <input class="form-control" type="password" name="Nitro[CDNStandardFTP][Password]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['Password']) ? $data['Nitro']['CDNStandardFTP']['Password'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td>FTP Root<span class="help">The directory your content is stored in. Normally 'public_html/'.</span></td>
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNStandardFTP][Root]" value="<?php echo !empty($data['Nitro']['CDNStandardFTP']['Root']) ? $data['Nitro']['CDNStandardFTP']['Root'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                  	<td colspan="2">
                    	<label class="ftp-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNStandardFTP][SyncImages]" <?php if (!empty($data['Nitro']['CDNStandardFTP']['SyncImages'])) echo 'checked="checked"'; ?>/> Upload all local images to CDN via FTP</label>
                        <label class="ftp-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNStandardFTP][SyncCSS]" <?php if (!empty($data['Nitro']['CDNStandardFTP']['SyncCSS'])) echo 'checked="checked"'; ?>/> Upload all local CSS files to CDN via FTP</label>
                        <label class="ftp-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNStandardFTP][SyncJavaScript]" <?php if (!empty($data['Nitro']['CDNStandardFTP']['SyncJavaScript'])) echo 'checked="checked"'; ?>/> Upload all local JavaScript files to CDN via FTP</label>
                    </td>
                  </tr>
                  <tr>
                  	<td colspan="2">
                    	
                        <a class="ftp-upload btn btn-primary"><i class="icon-circle-arrow-up icon-white"></i> <span class="ftp-button-text">Upload to CDN Server</span></a>
                        <a class="ftp-cancel btn btn-default"><i class="icon-remove icon-white"></i> <span class="ftp-cancel-text">Abort</span></a>
