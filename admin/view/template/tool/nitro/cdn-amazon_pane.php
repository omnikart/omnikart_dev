    ...
    <div class="box-content">
      <table class="form cdnpanetable">
        <tr>
          ...
          <td>
          <select name="Nitro[CDNAmazon][Enabled]" class="form-control NitroCDNAmazon">
          ...
          <div id="cdn-amazon-images" class="tab-pane active">
            <table class="form cdnamazon" style="margin-top:-10px;">
              <tr>
                ...
                <td>
                <input class="form-control" type="text" name="Nitro[CDNAmazon][ImageBucket]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['ImageBucket']) ? $data['Nitro']['CDNAmazon']['ImageBucket'] : ''; ?>" />
                </td>
              </tr>
              <tr>
                ...
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][ImageHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['ImageHttpUrl'])) ? $data['Nitro']['CDNAmazon']['ImageHttpUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                ...
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][ImageHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['ImageHttpsUrl'])) ? $data['Nitro']['CDNAmazon']['ImageHttpsUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                ...
                <td>
                <select class="form-control" name="Nitro[CDNAmazon][ServeImages]">
          ...
          <div id="cdn-amazon-css" class="tab-pane">
            <table class="form cdnamazon" style="margin-top:-10px;">
              <tr>
                ...
                <td>
                <input class="form-control" type="text" name="Nitro[CDNAmazon][CSSBucket]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['CSSBucket']) ? $data['Nitro']['CDNAmazon']['CSSBucket'] : ''; ?>" />
                </td>
              </tr>
              <tr>
                <td>Amazon CloudFront/S3 CDN HTTP URL<span class="help">Use the bucket Domain Name from <a target="_blank" href="https://console.aws.amazon.com/?nc2=h_m_mc">Amazon CloudFront</a> in the following way:<br /><strong>http://&lt;Bucket-Domain-Name&gt;/</strong></span></td>
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][CSSHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['CSSHttpUrl'])) ? $data['Nitro']['CDNAmazon']['CSSHttpUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                <td>Amazon CloudFront/S3 CDN HTTPS URL<span class="help">Use the bucket Domain Name from <a target="_blank" href="https://console.aws.amazon.com/?nc2=h_m_mc">Amazon CloudFront</a> in the following way:<br /><strong>https://&lt;Bucket-Domain-Name&gt;/</strong></span></td>
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][CSSHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['CSSHttpsUrl'])) ? $data['Nitro']['CDNAmazon']['CSSHttpsUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                ...
                <td>
                <select class="form-control" name="Nitro[CDNAmazon][ServeCSS]">
          ...
          <div id="cdn-amazon-js" class="tab-pane">
            <table class="form cdnamazon" style="margin-top:-10px;">
              <tr>
                ...
                <td>
                <input class="form-control" type="text" name="Nitro[CDNAmazon][JavaScriptBucket]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['JavaScriptBucket']) ? $data['Nitro']['CDNAmazon']['JavaScriptBucket'] : ''; ?>" />
                </td>
              </tr>
              <tr>
                <td>Amazon CloudFront/S3 CDN HTTP URL<span class="help">Use the bucket Domain Name from <a target="_blank" href="https://console.aws.amazon.com/?nc2=h_m_mc">Amazon CloudFront</a> in the following way:<br /><strong>http://&lt;Bucket-Domain-Name&gt;/</strong></span></td>
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][JavaScriptHttpUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['JavaScriptHttpUrl'])) ? $data['Nitro']['CDNAmazon']['JavaScriptHttpUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                <td>Amazon CloudFront/S3 CDN HTTPS URL<span class="help">Use the bucket Domain Name from <a target="_blank" href="https://console.aws.amazon.com/?nc2=h_m_mc">Amazon CloudFront</a> in the following way:<br /><strong>https://&lt;Bucket-Domain-Name&gt;/</strong></span></td>
                <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][JavaScriptHttpsUrl]" value="<?php echo(!empty($data['Nitro']['CDNAmazon']['JavaScriptHttpsUrl'])) ? $data['Nitro']['CDNAmazon']['JavaScriptHttpsUrl'] : ''?>" />
                </td>
              </tr>
              <tr>
                ...
                <td>
                <select class="form-control" name="Nitro[CDNAmazon][ServeJavaScript]">
    ...
    <div class="col-md-5">
    	<div class="CDNAmazon-tabbable-parent">
            ...
            <div class="box-content" style="min-height:100px; line-height:20px;">
              ...
              <input class="form-control" type="hidden" name="Nitro[CDNAmazon][LastUpload]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['LastUpload']) ? $data['Nitro']['CDNAmazon']['LastUpload'] : ''; ?>" />
                ...
                <table class="form">
                  <tr>
                    ...
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][AccessKeyID]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['AccessKeyID']) ? $data['Nitro']['CDNAmazon']['AccessKeyID'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                    <input class="form-control" type="text" name="Nitro[CDNAmazon][SecretAccessKey]" value="<?php echo !empty($data['Nitro']['CDNAmazon']['SecretAccessKey']) ? $data['Nitro']['CDNAmazon']['SecretAccessKey'] : ''; ?>" />
                    </td>
                  </tr>
                  <tr>
                  	<td colspan="2">
                    	<label class="amazon-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNAmazon][SyncImages]" <?php if (!empty($data['Nitro']['CDNAmazon']['SyncImages'])) echo 'checked="checked"'; ?>/> Upload all local images to Amazon CloudFront/S3 CDN</label>
                        <label class="amazon-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNAmazon][SyncCSS]" <?php if (!empty($data['Nitro']['CDNAmazon']['SyncCSS'])) echo 'checked="checked"'; ?>/> Upload all local CSS files to Amazon CloudFront/S3 CDN</label>
                        <label class="amazon-upload-label"><input class="form-control" type="checkbox" value="1" name="Nitro[CDNAmazon][SyncJavaScript]" <?php if (!empty($data['Nitro']['CDNAmazon']['SyncJavaScript'])) echo 'checked="checked"'; ?>/> Upload all local JavaScript files to Amazon CloudFront/S3 CDN</label>
                    </td>
                  </tr>
                  <tr>
                  	<td colspan="2">
                    	<a class="amazon-upload btn btn-primary"><i class="icon-circle-arrow-up icon-white"></i> <span class="amazon-button-text">Sync with Amazon CDN</span></a>
                        <a class="amazon-cancel btn btn-default"><i class="icon-remove icon-white"></i> <span class="amazon-cancel-text">Abort</span></a>
