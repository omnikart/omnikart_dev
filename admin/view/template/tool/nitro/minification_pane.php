         	...
         	<div id="mini-css" class="tab-pane active">
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <textarea class="form-control" placeholder="e.g. slideshow.css, each file on a new line" style="width:400px; height:180px;" name="Nitro[Mini][CSSExclude]"><?php echo(!empty($data['Nitro']['Mini']['CSSExclude'])) ? $data['Nitro']['Mini']['CSSExclude'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
                  <td colspan="2"><a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearcsscache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default clearJSCSSCache"><i class="icon-trash"></i> Clear minified CSS files cache</a></td>
                  </tr>
                </table> 
            </div>
         	<div id="mini-javascript" class="tab-pane">
                <table class="form minification" style="margin-top:-10px;">
                  ...
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                    <textarea class="form-control" placeholder="e.g. slideshow.js, each file on a new line" style="width:400px; height:180px;" name="Nitro[Mini][JSExclude]"><?php echo(!empty($data['Nitro']['Mini']['JSExclude'])) ? $data['Nitro']['Mini']['JSExclude'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style="vertical-align:top;">
                    <textarea class="form-control" placeholder="e.g. $('.date, .datetime, .time').bgIframe();" style="width:400px; height:180px;" name="Nitro[Mini][JSExcludeInline]"><?php echo(!empty($data['Nitro']['Mini']['JSExcludeInline'])) ? $data['Nitro']['Mini']['JSExcludeInline'] : ''?></textarea>
                    </td>
                  </tr>
                  <tr>
                  <td colspan="2"><a href="javascript:void(0)" onclick="document.location='index.php?route=tool/nitro/clearjscache&token=<?php echo $_GET['token']; ?>'" class="btn btn-default clearJSCSSCache"><i class="icon-trash"></i> Clear minified JavaScript files cache</a></td>
                  </tr>
                </table> 
