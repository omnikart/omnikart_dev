	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-combos').submit() : false;"><i class="fa fa-trash-o"></i></button>
			</div>
	...
	<div class="container-fluid">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
			<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-combos">
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="<?php echo $combo['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> <a href="<?php echo $combo['switch']; ?>" data-toggle="tooltip" title="<?php echo $combo['title']; ?>" <?php if ($combo['title'] == 'Enabled') echo 'class="btn btn-success"'; else echo 'class="btn btn-danger"'?>><i class="fa fa-<?php echo $combo['status'];?>"></i></a></td>
                </tr>
                <?php } ?>
				<tr>
