...
<div id="content">
  ...
  <div class="box">
					...
					<div class="megamenu-form">
						...
						<table class="form">
							<tr>
								...
								<td><select
									name="pavmegamenubase_module[<?php echo $module_row; ?>][layout_id]">
							...
							<tr>
								...
								<td><select
									name="pavmegamenubase_module[<?php echo $module_row; ?>][position]">
							...
							<tr>
								...
								<td><select
									name="pavmegamenubase_module[<?php echo $module_row; ?>][status]">
							...
							<tr>
								...
								<td><input type="text"
									name="pavmegamenubase_module[<?php echo $module_row; ?>][sort_order]"
		...
		<div style="font-size: 10px; color: #666">
			<p>
				Pav Mega Menu is free to use. it's released under GPL/V2. Power By <a
					href="http://www.pavothemes.com">PavoThemes.Com</a>
