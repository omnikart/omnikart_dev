      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-rest_api" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="input-entry-client_secret"><?php echo $entry_client_secret; ?></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="rest_api_order_id" value="<?php echo $rest_api_order_id; ?>" />
                </div>
            </div>
        </form>
      </div>
