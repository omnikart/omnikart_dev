...
<script type="text/javascript"
	src="view/javascript/bootstrap/js/bootstrap.js"></script>

<script type="text/javascript"
	src="view/javascript/jquery/ui/jquery-ui.min.js"></script>
<link type="text/css" href="view/javascript/jquery/ui/jquery-ui.min.css"
	rel="stylesheet" />
<link type="text/css" href="view/javascript/bootstrap/css/bootstrap.css"
	rel="stylesheet" />
...
<div id="page-content">
	<div id="menu-form"
		style="display: none; left: 340px; top: 15px; max-width: 600px"
		class="popover top out form-setting">
		<div class="arrow"></div>
		<h3 style="display: block;" class="popover-title">
			Sub Menu Setting <span class="badge pull-right"><?php echo $olang->get('text_close');?></span>
		</h3>
		<div class="popover-content">
			<form method="post" action="<?php echo $liveedit_action;?>"
				...
				<div class="col-lg-12">
					<table class="table table-hover">
						...
						<tr>
							...
							<td><select name="menu_submenu" class="menu_submenu form-control">
						...
						<tr>
							...
							<td><input type="text" name="menu_subwidth"
								class="form-control menu_subwidth"></td>
						</tr>
							...
							<td>
								<div class="btn-group button-alignments">
									<button type="button" class="btn btn-default"
										data-option="aligned-left">
										<span class="fa fa-align-left"></span>
									</button>
									<button type="button" class="btn btn-default"
										data-option="aligned-center">
										<span class="fa fa-align-center"></span>
									</button>
									<button type="button" class="btn btn-default"
										data-option="aligned-right">
										<span class="fa fa-align-right"></span>
									</button>
									<button type="button" class="btn btn-default"
										data-option="aligned-fullwidth">
	...
	<div id="content-s">
		...
		<div id="column-form" style="display: none; left: 340px; top: 45px;"
			class="popover top   form-setting">
			<div class="arrow"></div>
			<h3 style="display: block;" class="popover-title">
				Column Setting <span class="badge pull-right"><?php echo $olang->get('text_close');?></span>
			</h3>
			<div class="popover-content">
				<form method="post" action="<?php echo $liveedit_action;?>"
					enctype="multipart/form-data">
					<table class="table table-hover">
						<tr>
							...
							<td><input type="text" class="form-control" name="colclass"></td>
						</tr>
						<tr>
							<td>Column Width</td>
							<td><select class="colwidth form-control" name="colwidth">
							<?php for( $i = 1; $i<=12; $i++ )  { ?>
		...
		<div id="submenu-form" style="display: none; left: 340px; top: 45px;"
			class="popover top  form-setting">
			<div class="arrow"></div>
			<h3 style="display: block;" class="popover-title"><?php echo $olang->get('text_setting_sub_submenu');?><span
					class="badge pull-right"><?php echo $olang->get('text_close');?></span>
			</h3>
			<div class="popover-content">
				<form method="post" action="<?php echo $liveedit_action;?>"
					enctype="multipart/form-data">
					...
					<table class="table table-hover">
						<tr>
							...
							<td><select class="form-control" name="submenu_group">
									<option value="0"><?php echo $olang->get('text_no');?></option>
									<option value="1"><?php echo $olang->get('text_yes');?></option>
							</select></td>
						</tr>
				...
				<div id="menu-toolbars">
					...
					<div>
						<div class="pull-right">
							...
							<a id="unset-data-menu" href="#"
								class="btn btn-danger btn-action"><?php echo $olang->get('text_reset_megamenu');?></a>
							<button id="save-data-menu" class="btn btn-warning">Save</button>
						</div>
						<a id="save-data-back" class="btn btn-default"
							href="<?php echo $action_backlink;?>"><?php echo $olang->get('text_back');?></a>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-submit btn-danger"
					data-type="save"><?php echo $olang->get('text_save'); ?></button>
...
<!-- Widgets -->
<div class="modal fade" id="mdwidgetbuttons" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="wpo-widgets clearfix">
					...
					<div class="widgets-filter">
						<div class="form-group has-success clearfix">
							...
							<div class="col-lg-10">
								<input class="form-control" type="text" id="searchwidgets"
									name="searchwidgets">
							</div>
						</div>
						...
						<div class="form-group clearfix">
							...
							<div class="col-lg-10" id="filterbygroups">
								<ul class="nav nav-pills">
									<li class="filter-option" data-option="all"><a href="#"><?php echo $olang->get('All');?><span
