...
<div id="content">
	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button class="btn btn-primary" title="<?php echo $button_save; ?>"
					onclick="$('#form').submit();"><?php echo $button_save; ?></button>
				<a class="btn btn-info"
					title="<?php echo $objlang->get('button_save_edit'); ?>"
					onclick="$('#save_mode').val('save-edit');$('#form').submit();"><?php echo $objlang->get('button_save_edit'); ?></a>
				<a class="btn btn-success"
					title="<?php echo $objlang->get('button_save_new'); ?>"
					onclick="$('#save_mode').val('save-new');$('#form').submit();"><?php echo $objlang->get('button_save_new'); ?></a>
				| <a class="btn btn-warning"
					title="<?php echo $objlang->get('text_live_edit'); ?>"
					href="<?php echo $liveedit_url; ?>"><?php echo $objlang->get('text_live_edit'); ?></a>
				<a class="btn btn-danger" title="<?php echo $button_cancel; ?>"
					href="<?php echo $cancel; ?>"><?php echo $button_cancel; ?></a> | <a
					class="btn btn-info" title="<?php echo $objlang->get('Guide'); ?>"
					id="btn-guide"
					href="http://www.pavothemes.com/guides/pav_megamenu/"><?php echo $objlang->get('Guide');?></a>
			</div>
	...
	<div id="page-content" class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<ul id="grouptabs" class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#manage-menus" role="tab"
						data-toggle="tab"><?php echo $objlang->get('tab_manage_megamenus'); ?></a></li>
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="manage-widgets">
						<p>
							<i><?php echo $objlang->get('text_explain_widgets'); ?></i>
						</p>
						<a class="btn btn-info btn-modal"
							href="index.php?route=module/pavmegamenu/addwidget&token=<?php echo $token; ?>"><?php echo $objlang->get('text_create_widget'); ?></a>
						<br />
						<br />
						<table class="table">
							<tr>
							...
							<tr>
								...
								<td><a class="btn-action-widget btn-modal" rel="edit"
									href="index.php?route=module/pavmegamenu/addwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $objlang->get('text_edit'); ?></a>
									| <a
									onclick="return confirm('<?php echo $objlang->get('text_confirm_delete');?>');"
									rel="edit"
									href="index.php?route=module/pavmegamenu/delwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $objlang->get('text_delete'); ?></a>
								</td>
							<?php } ?>
							</tr>
							<?php } ?>
						...
						<form action="<?php echo $action; ?>" method="post"
							...
							<div class="buttons">
								...
								<select class="form-control" name="stores" id="pavstores"
									...
									<?php endif;?>
									<?php endforeach;?>
								</select> <input type="hidden" value="<?php echo $store_id;?>"
									name="megamenu[store_id]" /></br>
								</br> <a class="btn btn-primary"
									title="<?php echo $objlang->get('button_import_categories'); ?>"
									onclick="$('#save_mode').val('import-categories');$('#form').submit();"><?php echo $objlang->get('button_import_categories'); ?></a>
								<a class="btn btn-danger"
									title="<?php echo $objlang->get('button_delete_categories'); ?>"
									data-toggle="modal" data-target=".deleteTree-modal-sm"><?php echo $objlang->get('button_delete_categories'); ?></a>
							</div>
							<br />
							<br />
							...
							<div class="megamenu">
								<div class="tree-megamenu">
									...
									<a class="btn btn-success btn-updatetree" name="serialize"
										id="serialize"><?php echo $objlang->get('button_update_order'); ?></a>	
									<?php echo $tree; ?>
									<a class="btn btn-success btn-updatetree" name="serialize"
										id="serialize"><?php echo $objlang->get('button_update_order'); ?></a>
									<p class="note">
										<i><?php echo $objlang->get("text_explain_drapanddrop");?></i>
									</p>
								</div>
		...
		<div id="info" style="font-size: 10px; color: #666">
			<p>
				Pav Mega Menu is free to use. it's released under GPL/V2. Powered By
				<a href="http://www.pavothemes.com">PavoThemes.Com</a>
...
<div id="cmodal" class="modal fade deleteTree-modal-sm" tabindex="-1"
