	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-amazon-pay" data-toggle="tooltip"
	...
	<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-amazon-pay"
					class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-button-type"><?php echo $entry_button_type; ?></label>
						<div class="col-sm-10">
							<select name="amazon_pay_button_type" id="input-button-type"
								class="form-control">
				...
				<?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_pay_button_colour" id="input-button-colour"
								class="form-control">
				...
				<?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_pay_button_size" id="input-button-size"
								class="form-control">
				...
				<?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_pay_status" id="input-status"
								class="form-control">
