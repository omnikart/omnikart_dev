...
<div id="content">
		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<a class="btn btn-success"
					onclick="$('#action').val('save_stay');$('#form').submit();"><?php echo $objlang->get('button_save_stay'); ?></a>
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="pull-right">
					<a id="btnocmanage" href="<?php echo $link; ?>"
						class="btn btn-info"><i class="fa fa-cubes"></i> <?php echo $olang->get('text_add_new_module'); ?></a>
				</div>
				...
				<div class="row">
					<ul class="nav nav-tabs" role="tablist">
						<li <?php if( $selectedid ==0 ) { ?> class="active" <?php } ?>><a
							href="<?php echo $link; ?>"> <span class="fa fa-plus"></span> <?php echo $olang->get('button_add_module');?></a></li>
                    <?php $i=1; foreach( $moduletabs as $key => $moduletab ){ ?>
                    <li role="presentation"
							<?php if( $moduletab['module_id']==$selectedid ) {?>
							class="active" <?php } ?>><a
							href="<?php echo $link; ?>&module_id=<?php echo $moduletab['module_id']?>"
							aria-controls="bannermodule-<?php echo $key; ?>"> <span
								class="fa fa-pencil"></span> <?php echo $moduletab['name']?>
                       </a></li>
                    <?php $i++ ;} ?>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-modules">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<select class="form-control no-width" class="form-control"
										name="pavreassurance_module[<?php echo $module_row;?>][status]"
							...
							<div class="form-group row">
								<label class="col-sm-2 control-label" for="input-status">Only
									Modal</label>
								<div class="col-sm-10">
									<select class="form-control no-width" class="form-control"
										name="pavreassurance_module[<?php echo $module_row;?>][onlymodal]"
										id="input-status" class="form-control">
							...
							<div class="module-class form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control"
										name="pavreassurance_module[<?php echo $module_row;?>][name]"
										value="<?php if(isset($module['name'])){ echo $module['name']; }?>">
								</div>
							</div>
							<hr>
							<div class="module-class form-group row">
								...
								<div class="col-sm-10">
									<input class="form-control"
										name="pavreassurance_module[<?php echo $module_row;?>][prefix]"
										value="<?php if(isset($module['prefix'])){ echo $module['prefix']; }?>">
								</div>
							</div>
						...
						<div class="col-sm-2">
			                ...
			                <li><a
										href="#tab-module<?php echo $reassurence_row; ?>"
										data-toggle="tab"><i class="fa fa-minus-circle"
											onclick="$('a[href=\'#tab-module<?php echo $reassurence_row; ?>\']').parent().remove(); $('#tab-module<?php echo $reassurence_row; ?>').remove(); $('#module a:first').tab('show');"></i> <?php echo $tab_module . ' ' . $reassurence_row; ?></a></li>
			                	<?php $reassurence_row++; ?>
								<?php } ?>
							<?php } //end check isset reassuarances data?>
			                <li id="module-add"><a onclick="addModule();"><i
											class="fa fa-plus-circle"></i> <?php echo $button_module_add; ?></a></li>
								</ul>
							</div>
							<div class="col-sm-10">
								...
								<?php if(isset($module['pavreassurances']) && !empty($module['pavreassurances'])) { ?>
									...
									<?php foreach ($module['pavreassurances'] as $reassuarance) { ?>
									<div class="tab-pane"
										id="tab-module<?php echo $reassurence_row; ?>">
										...
										<table class="table table-bordered table-hover">
											<tr>
												...
												<td class="col-sm-10"><input class="form-control"
													style="width: 55%;"
													name="pavreassurance_module[<?php echo $module_row; ?>][pavreassurances][<?php echo $reassurence_row; ?>][select_icon]"
													value="<?php echo ( isset($reassuarance['select_icon'])?$reassuarance['select_icon']:'' ) ?>"
													size="50" /> <span class="help"><?php echo $lang_description ?> <a
														href="http://fortawesome.github.io/Font-Awesome/icons/">fortawesome.github.io/Font-Awesome/icons/</a></span>
												</td>
											</tr>
											<tr>
												...
												<td class="col-sm-10"><input class="form-control"
													style="width: 55%;"
													name="pavreassurance_module[<?php echo $module_row; ?>][pavreassurances][<?php echo $reassurence_row; ?>][reassurance_prefixclass]"
													value="<?php echo ( isset($reassuarance['reassurance_prefixclass'])?$reassuarance['reassurance_prefixclass']:'' ) ?>"
													size="50" /></td>
											</tr>
											<tr>
												<td class="col-sm-2">3rd Party Modal</td>
												<td class="col-sm-10"><input class="form-control"
													style="width: 55%;"
													name="pavreassurance_module[<?php echo $module_row; ?>][pavreassurances][<?php echo $reassurence_row; ?>][reassurance_3rdmodel]"
													value="<?php echo ( isset($reassuarance['reassurance_3rdmodel'])?$reassuarance['reassurance_3rdmodel']:'' ) ?>"
													size="50" /></td>
											</tr>
										</table>
...
/*
										...
										?>
										<ul class="nav nav-tabs"
											id="language<?php echo $reassurence_row; ?>">
					                      <?php foreach ($languages as $language) { ?>
					                      <li><a
												href="#tab-module<?php echo $reassurence_row; ?>-language<?php echo $language['language_id']; ?>"
												data-toggle="tab"><img
...
/*
										...
										?>
											<?php foreach ($languages as $language) { ?>
											<div class="tab-pane"
												id="tab-module<?php echo $reassurence_row; ?>-language<?php echo $language['language_id']; ?>">
												<table class="table table-bordered table-hover">
													...
													<tr>
														...
														<td class="col-sm-10"><input class="form-control"
															...
															name="pavreassurance_module[<?php echo $module_row; ?>][pavreassurances][<?php echo $reassurence_row; ?>][title][<?php echo $language['language_id']; ?>]"
															value="<?php echo isset($reassuarance['title'][$language['language_id']]) ? $reassuarance['title'][$language['language_id']] : ''; ?>"
															size="50" /></td>
													</tr>
