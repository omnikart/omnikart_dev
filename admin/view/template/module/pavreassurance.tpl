									...
									<div class="tab-pane" id="tab-module<?php echo $reassurence_row; ?>">
										...
										<table class="table table-bordered table-hover">
											...
											<tr>
												...
												<td class="col-sm-10">
													<input class="form-control" style="width:55%;" name="pavreassurance_module[<?php echo $module_row; ?>][pavreassurances][<?php echo $reassurence_row; ?>][reassurance_3rdmodel]" value="<?php echo ( isset($reassuarance['reassurance_3rdmodel'])?$reassuarance['reassurance_3rdmodel']:'' ) ?>" size="50" />
												</td>
											</tr>
										</table>
