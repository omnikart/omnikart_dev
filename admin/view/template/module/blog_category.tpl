	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-blog_category"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-blog_category"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="listicon"
								value="<?php echo $listicon; ?>"
								placeholder="<?php echo $entry_listicon; ?>" id="input-listicon"
								class="form-control" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="sublist_icon"
								value="<?php echo $sublist_icon; ?>"
								placeholder="<?php echo $sublist_icon; ?>"
								id="input-sublist_icon" class="form-control" />
						</div>
					</div>
