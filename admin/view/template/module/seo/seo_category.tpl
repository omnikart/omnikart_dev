	...
	<table class="table table-bordered table-hover">
		...
		<tbody id="products">
			...
			<tr id="prod-<?php echo $key; ?>">
				<td class="category_id"><input name="selected[]" value="<?php echo $product['category_id']; ?>" type="checkbox"></td>
				<td class="name"><input name="products[<?php echo $product['category_id']; ?>][name]" value="<?php echo $product['name']; ?>" type="text" /></td>
				<td class="keyword"><input name="products[<?php echo $product['category_id']; ?>][keyword]" value="<?php echo $product['keyword']; ?>" type="text" /></td>
				<td class="meta_title"><input name="products[<?php echo $product['category_id']; ?>][meta_title]" value="<?php echo $product['meta_title']; ?>" type="text" /></td>
				<td class="meta_keyword"><input name="products[<?php echo $product['category_id']; ?>][meta_keyword]" value="<?php echo $product['meta_keyword']; ?>" type="text" /></td>
				<td class="meta_description"><textarea name="products[<?php echo $product['category_id']; ?>][meta_description]" rows="1"><?php echo $product['meta_description']; ?></textarea></td>
