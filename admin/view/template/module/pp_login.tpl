	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-pp-login" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-pp-login"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="entry-client_id"><?php echo $entry_client_id; ?></label>
						<div class="col-sm-10">
							<input type="text" name="pp_login_client_id"
								value="<?php echo $pp_login_client_id; ?>"
								placeholder="<?php echo $entry_client_id; ?>"
								id="entry-client_id" class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="pp_login_secret"
								value="<?php echo $pp_login_secret; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="entry-sandbox"><span
							data-toggle="tooltip" title="<?php echo $help_sandbox; ?>"><?php echo $entry_sandbox; ?></span></label>
						<div class="col-sm-10">
							<select name="pp_login_sandbox" id="entry-sandbox"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-loggin"><span
							data-toggle="tooltip" title="<?php echo $help_debug_logging; ?>"><?php echo $entry_debug; ?></span></label>
						<div class="col-sm-10">
							<select name="pp_login_debug" id="input-logging"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-customer-group"><span
							data-toggle="tooltip" title="<?php echo $help_customer_group; ?>"><?php echo $entry_customer_group; ?></span></label>
						<div class="col-sm-10">
							<select name="pp_login_customer_group_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="pp_login_button_colour" id="input-button_colour"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-seamless"><span
							data-toggle="tooltip" title="<?php echo $help_seamless; ?>"><?php echo $entry_seamless; ?></span></label>
						<div class="col-sm-10">
							<select name="pp_login_seamless" id="input-logging"
								class="form-control">
              ...
              <div class="input-group">
								<span class="input-group-addon"><img
									...
									title="<?php echo $language['name']; ?>" /></span> <select
									name="pp_login_locale[<?php echo $language['language_id']; ?>]"
									class="form-control">
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" readonly id="return-url"
								value="<?php echo $return_url; ?>" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-status"><?php echo $entry_status; ?></label>
						<div class="col-sm-10">
							<select name="pp_login_status" id="input-status"
								class="form-control">
