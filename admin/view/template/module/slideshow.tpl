	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-slideshow" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-slideshow"
              ...
              <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-margin_left"><?php echo $entry_margin_left; ?></label>
						<div class="col-sm-10">
							<input type="text" name="margin_left"
								value="<?php echo $margin_left; ?>"
								placeholder="<?php echo $entry_margin_left; ?>" id="input-width"
								class="form-control" />
              <?php if ($error_margin_left) { ?>
              <div class="text-danger"><?php echo $error_margin_left; ?></div>
              <?php } ?>
            </div>
					</div>
					<div class="form-group">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="status_side" id="input-status-side"
								class="form-control">
                <?php if ($status_side) { ?>
                <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
								<option value="0"><?php echo $text_disabled; ?></option>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="side_banner_id" id="input-banner-side"
								class="form-control">
                <?php foreach ($banners as $banner) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="side_width"
								value="<?php echo $side_width; ?>"
								placeholder="<?php echo $entry_width; ?>" id="input-width-side"
								class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="side_height"
								value="<?php echo $side_height; ?>"
								placeholder="<?php echo $entry_height; ?>"
								id="input-height-side" class="form-control" />
