...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-featured" data-toggle="tooltip"
    ...
    <div class="alert alert-info">
			<i class="fa fa-exclamation-circle"></i> <?php echo $text_about; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
		</div>
		<div class="alert alert-warning">
			<i class="fa fa-exclamation-circle"></i> <?php echo $text_register; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
		</div>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-featured"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="ebay_listing_description" id="input-description"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="ebay_listing_limit"
								value="<?php echo $ebay_listing_limit; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="ebay_listing_width"
								value="<?php echo $ebay_listing_width; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="ebay_listing_height"
								value="<?php echo $ebay_listing_height; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="ebay_listing_sort" id="input-sort"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="ebay_listing_site" id="input-site"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="ebay_listing_status" id="input-status"
								class="form-control">
