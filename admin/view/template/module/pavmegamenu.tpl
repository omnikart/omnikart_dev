					...
					<div class="megamenu-form">
						...
						<table class="form">
							<tr>
								...
								<td><select
									name="pavmegamenu_module[<?php echo $module_row; ?>][layout_id]">
							...
							<tr>
								...
								<td><select
									name="pavmegamenu_module[<?php echo $module_row; ?>][position]">
							...
							<tr>
								...
								<td><select
									name="pavmegamenu_module[<?php echo $module_row; ?>][status]">
							...
							<tr>
								...
								<td><input type="text"
									name="pavmegamenu_module[<?php echo $module_row; ?>][sort_order]"
