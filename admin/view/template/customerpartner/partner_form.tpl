			...
			<div class="panel-body">
				...
				<form action="<?php echo $action; ?>" method="post"
					...
					<ul class="nav nav-tabs">
						...
						<li class="active"><a href="#tab-dashboard" data-toggle="tab"><?php echo "Dashboard"; ?>  <i
								class="fa fa-spinner fa-spin remove-me"></i></a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane " id="tab-profile">
							...
							<div class="alert alert-info">
								<i class="fa fa-exclamation-circle"></i> <?php echo $tab_profile_info; ?>
              <button type="button" class="close" data-dismiss="alert">&times;</button>
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-screenname"><span
									data-toggle="tooltip"
									title="<?php echo $entry_screenname_info; ?>"><?php echo $entry_screenname; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="customer[screenname]"
										value="<?php echo $screenname; ?>" placeholder=""
										id="input-screenname" class="form-control" />
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-image"><span
									data-toggle="tooltip" title="<?php echo $entry_avatar_info; ?>"><?php echo $entry_avatar; ?></span></label>
								<div class="col-sm-10">
									<a href="" id="thumb-image-avatar" data-toggle="image"
										class="img-thumbnail"> <img
										src="<?php echo $avatar_placeholder; ?>" alt="" title=""
										data-placeholder="<?php echo $placeholder; ?>" />
									</a> <input type="hidden" name="customer[avatar]"
										value="<?php echo $avatar; ?>" id="input-image-avatar" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea name="customer[shortprofile]" id="input-shortprofile"
										class="form-control"><?php echo $shortprofile; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="customer[companyname]"
										value="<?php echo $companyname; ?>" placeholder=""
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="customer[twitterid]"
										value="<?php echo $twitterid; ?>" placeholder=""
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="customer[facebookid]"
										value="<?php echo $facebookid; ?>" placeholder=""
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="input-companylocality"><?php echo $entry_locality; ?></label>
								<div class="col-sm-10">
									<input type="text" name="customer[companylocality]"
										value="<?php echo $companylocality; ?>" placeholder=""
                    ...
                    <?php if(file_exists(DIR_IMAGE.'../image/flags/'.strtolower($country).'.png')){ ?>
                      <img
												src="../image/flags/<?php echo strtolower($country); ?>.png"
												id="country">
                    <?php }else{ ?>
                      <img src="" id="country">
                    <?php } ?>
                  </i></span> <select name="customer[country]"
                    ...
                    <?php if($countries){ ?>
                      <?php foreach($countries as $value_country){ ?>
                        <?php if($value_country['iso_code_2'] == $country){ ?>
                            <option
												value="<?php echo $value_country['iso_code_2']; ?>" selected><?php echo $value_country['name']; ?></option>
                        <?php }else{ ?>                    
                            <option
												value="<?php echo $value_country['iso_code_2']; ?>"><?php echo $value_country['name']; ?></option>
                        <?php } ?>
                      <?php } ?>
                    <?php } ?>
                  </select>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									...
									title="<?php echo $entry_theme; ?>"><?php echo $entry_theme; ?></span></label>
								<div class="col-sm-10">
									<div class="input-group colorpicker">
										<span class="input-group-addon"><i></i></span> <input
											type="text" name="customer[backgroundcolor]"
											value="<?php echo $backgroundcolor; ?>" placeholder=""
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-image"><span
									data-toggle="tooltip" title="<?php echo $entry_banner_info; ?>"><?php echo $entry_banner; ?></span></label>
								<div class="col-sm-10">
									<a href="" id="thumb-image-companybanner" data-toggle="image"
										class="img-thumbnail"> <img
										src="<?php echo $companybanner_placeholder; ?>" alt=""
										title="" data-placeholder="<?php echo $placeholder; ?>" />
									</a> <input type="hidden" name="customer[companybanner]"
										value="<?php echo $companybanner; ?>"
										id="input-image-companybanner" />
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-image"><span
									data-toggle="tooltip" title="<?php echo $entry_logo_info; ?>"><?php echo $entry_logo; ?></span></label>
								<div class="col-sm-10">
									<a href="" id="thumb-image-companylogo" data-toggle="image"
										class="img-thumbnail"> <img
										src="<?php echo $companylogo_placeholder; ?>" alt="" title=""
										data-placeholder="<?php echo $placeholder; ?>" />
									</a> <input type="hidden" name="customer[companylogo]"
										value="<?php echo $companylogo; ?>"
										id="input-image-companylogo" />
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="input-companydescription"><?php echo $entry_store; ?></label>
								<div class="col-sm-10">
									<textarea name="customer[companydescription]"
										id="input-companydescription" class="form-control"><?php echo $companydescription; ?></textarea>
								</div>
							</div>
						...
						<div class="tab-pane" id="tab-transaction">
							...
							<div class="alert alert-info">
								<i class="fa fa-exclamation-circle"></i> <?php echo $tab_transaction_info; ?>
              <button type="button" class="close" data-dismiss="alert">&times;</button>
							</div>
							...
							<div class="text-right">
								<button type="button" id="button-transaction"
									...
									<i class="fa fa-plus-circle"></i> <?php echo $button_add_transaction; ?></button>
							</div>
						</div>
						...
						<div class="tab-pane" id="tab-order">
							...
							<div class="alert alert-info">
								<i class="fa fa-exclamation-circle"></i> <?php echo $tab_order_info; ?>
              <button type="button" class="close" data-dismiss="alert">&times;</button>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<h3 class="panel-title">
										<i class="fa fa-shopping-cart"></i> <?php echo $tab_order; ?></h3>
								</div>
                      ...
                      <?php foreach($partner_orders as $partner_order){ ?>
                        <tr>
												...
												<td class="text-left"><a
													href="<?php echo $partner_order['view']; ?>"
													data-toggle="tooltip" title="<?php echo $text_view; ?>"
													class="btn btn-primary"><i class="fa fa-eye"></i></a> <a
													href="<?php echo $partner_order['edit']; ?>"
													data-toggle="tooltip" title="<?php echo $text_edit; ?>"
                    ...
                    <?php } ?>
						...
						<div class="tab-pane" id="tab-product">
							...
							<div class="alert alert-info">
								<i class="fa fa-exclamation-circle"></i> <?php echo $tab_product_info; ?>
              <button type="button" class="close" data-dismiss="alert">&times;</button>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="input-group">
										<input type="text" name="customer[commission]"
											value="<?php echo $commission; ?>"
											placeholder="<?php echo $entry_commission; ?>"
											id="input-commission" class="form-control" /> <span
											class="input-group-addon"> <b>%</b>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="customer[paypalid]"
										value="<?php echo $paypalid; ?>"
										placeholder="<?php echo $entry_paypalid; ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea name="customer[otherpayment]"
										placeholder="<?php echo $entry_otherinfo; ?>"
										id="input-otherpayment" class="form-control"><?php echo $otherpayment; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-product"><span
									data-toggle="tooltip"
									title="<?php echo $entry_product_id_info; ?>"><?php echo $entry_product_id; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="product" value=""
										placeholder="<?php echo $entry_product_id; ?>"
										id="input-product" class="form-control" />
									<div id="product-product" class="well well-sm"
						...
						<!-- tab location -->
						<div class="tab-pane" id="tab-location"></div>
...
$('input[name=\'product\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=customerpartner/product/autocomplete&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>&filter_name=' +  encodeURIComponent(request)+'&filter_for_seller=1',
      dataType: 'json',     
...
//--></script>
	<link
		href="view/javascript/color-picker/css/bootstrap-colorpicker.min.css"
		rel="stylesheet">
	<script
		src="view/javascript/color-picker/js/bootstrap-colorpicker.min.js"></script>
	<script type="text/javascript">
$(function(){
