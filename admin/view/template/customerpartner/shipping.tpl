	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<a href="<?php echo $addshipping; ?>" data-toggle="tooltip"
					title="<?php echo $button_shipping; ?>" class="btn btn-primary"><i
					class="fa fa-plus"></i></a>
				<button type="button" data-toggle="tooltip"
					title="<?php echo $button_delete; ?>" class="btn btn-danger"
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form').submit() : false;">
			...
			<div class="panel-body">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class='input-group'>
									<input type="text" name="filter_name"
										...
										placeholder="<?php echo $customer_name; ?>" id="input-name"
							...
							<div class="form-group">
								...
								<input type="text" name="filter_country"
									...
									placeholder="<?php echo $shipping_country; ?>"
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_zip_to"
									...
									placeholder="<?php echo $zip_to; ?>" id="input-zip_to"
									class="form-control" />
							</div>
							<div class="form-group">
								...
								<input type="text" name="filter_zip_from"
									...
									placeholder="<?php echo $zip_from; ?>" id="input-zip_from"
									class="form-control" />
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_price"
									...
									placeholder="<?php echo $price; ?>" id="input-price"
									class="form-control" />
							</div>
							<div class="form-group">
								...
								<input type="text" name="filter_weight_to"
									...
									placeholder="<?php echo $weight_to; ?>" id="input-weight_to"
									class="form-control" />
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type='text' name="filter_weight_from"
									...
									placeholder="<?php echo $weight_from; ?>"
									id="input-weight_from" class="form-control date" />
							</div>
						</div>
				...
				<form action="<?php echo $delete; ?>" method="post"
                    ...
                    <a href="<?php echo $sort_name; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $customer_name; ?></a>
                    <?php } else { ?>
