		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-commission').submit() : false;">
			...
			<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class='input-group'>
									<input type="text" name="filter_name"
										...
										placeholder="<?php echo $entry_category; ?>" id="input-name"
				...
				<form action="<?php echo $delete; ?>" method="post"
                    ...
                    <a href="<?php echo $sort_name; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_category; ?></a>
                    <?php } else { ?>
                  ...
                  <tr>
                      ...
                      <?php } ?>
									...
									<td class="text-right"><a
										...
										title="<?php echo $entry_edit; ?>" class="btn btn-primary"><i
