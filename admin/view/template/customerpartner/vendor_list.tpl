...
<div id="content">
		...
		<div class="container-fluid">
			<div class="pull-right">
				<button type="button" data-toggle="tooltip"
					title="<?php echo "delete"; ?>" class="btn btn-danger"
					onclick="confirm('<?php echo "confirm"; ?>') ? $('#form-attribute1').submit() : false;">
					<i class="fa fa-trash-o"></i>
				</button>
				<button type="button" data-toggle="modal" data-enquiryid="0"
					data-target="#supplier-modal" class="btn btn-primary">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-list"></i> <?php echo  "Vendor List"; ?></h3>
			</div>
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<input type="text" name="filter_mail"
									placeholder="<?php echo $entry_mail; ?>" id="input-mail"
									class="form-control" />
							</div>
						</div>
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<input type="text" name="filter_brand"
									placeholder="<?php echo $entry_brand; ?>" id="input-brand"
									class="form-control" />
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_trade"
									placeholder="<?php echo $entry_trade; ?>" id="input-trade"
									class="form-control" />
							</div>
							<div class="form-group">
				...
				<form action="<?php echo $delete; ?>" method="post"
					enctype="multipart/form-data" id="form-attribute1">
						...
						<table class="table table-bordered table-hover"
							...
							<tbody>
									...
									<td class="text-center"><input type="checkbox"
										name="selected[]" value="<?php echo $enquiry['id']; ?>"></td>
									...
									<td class=text-right><input type="hidden" name="enquiry_id"
										value="<?php echo $enquiry['id']; ?>" />
										<div class="btn-group" role="group" style="width: 134px;">
											<button type="button" class="btn btn-primary"
												data-toggle="modal"
												data-enquiryid="<?php echo $enquiry['id']; ?>"
											...
											<button type="button" class="btn btn-primary"
												data-toggle="modal" data-target="#getSchedule"
												data-enquiryid="<?php echo $enquiry['id']; ?>">
				...
				<div class="modal-body bgColorWhite">
					<div class="panel-body">
						<form id="supplier_form1" class="form-horizontal">
							<input name="enquiry_id" id="enquiry_id" class="form-control"
								type="hidden" value="" />
							<div class="form-group required">
								<label class="control-label col-sm-4" for="comment">What did he
									say?</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="registration" class="form-control" placeholder=""
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="pricelist" class="form-control" placeholder=""
										type="checkbox" id="pri" />
								</div>
							</div>
						</form>
	...
	<div class="modal fade" id="supplier-modal" role="dialog"
		aria-labelledby="supplier-modal">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body bgColorWhite"></div>
				<div class="modal-footer ">
					<button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
				</div>
			</div>
