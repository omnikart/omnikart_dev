    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $save; ?>" method="post" enctype="multipart/form-data" id="form-transaction" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-details"><span data-toggle="tooltip" title="<?php echo $entry_details; ?>"><?php echo $entry_details; ?></span></label>
            <div class="col-sm-10">             
            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php if($orders) { 
                  foreach ($orders as $key => $order) { ?>
                    <tr>
                      <td class="text-center" width="1">
                        <input type="checkbox" name="select[<?php echo $order['order_id'] ?>][]" value="<?php echo $order['order_product_id']; ?>" <?php if($order['status']) echo "disabled='true'"; else echo "checked='true'"; ?> />
                  ...
                  <?php } ?>
                <?php } else { ?>
                    <tr><td colspan="7" class="text-center"><?php echo $text_no_record; ?></td></tr>
                <?php } ?>
              </tbody>
            </table>
          </div>
