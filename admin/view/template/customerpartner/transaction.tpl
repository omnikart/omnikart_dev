		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-transaction').submit() : false;">
			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_id"
									...
									placeholder="<?php echo $entry_id; ?>" id="input-id"
									class="form-control" />
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class='input-group'>
									<input type="text" name="filter_name"
										...
										placeholder="<?php echo $entry_seller; ?>" id="input-name"
							...
							<div class="form-group">
								...
								<input type="text" name="filter_details"
									value="<?php echo $filter_details; ?>"
									placeholder="<?php echo $entry_details; ?>" id="input-details"
									class="form-control" />
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class='input-group date' id='datetimepicker2'>
									<input type='text' name="filter_date"
										...
										placeholder="<?php echo $entry_date; ?>" id="input-date"
										class="form-control date" /> <span class="input-group-addon"><span
				...
				<form action="<?php echo $delete; ?>" method="post"
                  ...
                  <a href="<?php echo $sort_id; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_id; ?></a>
                  <?php } else { ?>
                  ...
                  <a href="<?php echo $sort_name; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_seller; ?></a>
                  <?php } else { ?>
                  ...
                  <a href="<?php echo $sort_amount; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_amount; ?></a>
                  <?php } else { ?>
                  ...
                  <a href="<?php echo $sort_details; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_details; ?></a>
                  <?php } else { ?>
                  ...
                  <a href="<?php echo $sort_date; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_date; ?></a>
                  <?php } else { ?>
              ...
              <?php foreach ($transactions as $result) { ?>
                <tr>
                    ...
                    <input type="checkbox" name="selected[]"
										value="<?php echo $result['id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]"
