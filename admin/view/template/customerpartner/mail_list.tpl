			...
			<div class="panel-body">
						...
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<input type="text" name="filter_message"
									value="<?php echo $filter_message; ?>"
									placeholder="<?php echo $entry_message; ?>" id="input-message"
									class="form-control" />
							</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_subject"
									...
									placeholder="<?php echo $entry_subject; ?>" id="input-subject"
									class="form-control" />
							</div>
						</div>
				...
				<form action="<?php echo $delete; ?>" method="post"
                  ...
                  <a href="<?php echo $sort_name; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_name; ?></a>
                  <?php } else { ?>
                  ...
                  <?php } ?>               
									...
									<td class="text-left">
                  <?php if ($sort == 'subject') { ?>
                  <a href="<?php echo $sort_subject; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_subject; ?></a>
                  <?php } else { ?>
                  ...
                  <a href="<?php echo $sort_message; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_message; ?></a>
                  <?php } else { ?>
                ...
                <tr>
                    ...
                    <?php } ?>
									...
									<td class="text-right"><a
										href="<?php echo $result['action']; ?>" data-toggle="tooltip"
										title="<?php echo $text_edit; ?>" class="btn btn-primary"><i
...
function filter() {
  ...
  url = 'index.php?route=customerpartner/mail&token=<?php echo $token; ?>';
