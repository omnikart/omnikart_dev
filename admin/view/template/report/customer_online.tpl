			...
			<div class="panel-body">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="filter_ip"
									value="<?php echo $filter_ip; ?>" id="input-ip"
              ...
              <tr>
								...
								<td class="text-left"><a href="<?php echo $customer['url']; ?>"
									target="_blank"><?php echo implode('<br/>', str_split($customer['url'], 30)); ?></a></td>
								<td class="text-left"><?php if ($customer['referer']) { ?>
                  <a href="<?php echo $customer['referer']; ?>"
									target="_blank"><?php echo implode('<br/>', str_split($customer['referer'], 30)); ?></a>
                  <?php } ?></td>
