	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-layout" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-layout"
              ...
              <tr id="route-row<?php echo $route_row; ?>">
								<td class="text-left"><select
									name="layout_route[<?php echo $route_row; ?>][store_id]"
									class="form-control">
                    ...
                    <?php } ?>
								...
								<td class="text-left"><input type="text"
									...
									placeholder="<?php echo $entry_route; ?>" class="form-control" /></td>
								<td class="text-left"><button type="button"
										onclick="$('#route-row<?php echo $route_row; ?>').remove();"
              ...
              <?php } ?>
						...
						<tfoot>
							<tr>
								<td colspan="2"></td>
								<td class="text-left"><button type="button"
										onclick="addRoute();" data-toggle="tooltip"
										title="<?php echo $button_route_add; ?>"
              ...
              <tr id="module-row<?php echo $module_row; ?>">
								<td class="text-left"><select
									name="layout_module[<?php echo $module_row; ?>][code]"
									class="form-control">
								...
								<td class="text-left"><select
									...
									class="form-control">
										<option value="content_top"
											<?php echo ($layout_module['position'] == 'content_top'?'selected="selected"':'');?>><?php echo $text_content_top; ?></option>
										<option value="content_bottom"
											<?php echo ($layout_module['position'] == 'content_bottom'?'selected="selected"':'');?>><?php echo $text_content_bottom; ?></option>
										<option value="column_left"
											<?php echo ($layout_module['position'] == 'column_left'?'selected="selected"':'');?>><?php echo $text_column_left; ?></option>
										<option value="column_right"
											<?php echo ($layout_module['position'] == 'column_right'?'selected="selected"':'');?>><?php echo $text_column_right; ?></option>
										<option value="footer"
											<?php echo ($layout_module['position'] == 'footer'?'selected="selected"':'');?>>Footer</option>
										<option value="header"
											<?php echo ($layout_module['position'] == 'header'?'selected="selected"':'');?>>Header</option>
										<option value="ct_left"
											<?php echo ($layout_module['position'] == 'ct_left'?'selected="selected"':'');?>>Content
											Top Left</option>
										<option value="ct_right"
											<?php echo ($layout_module['position'] == 'ct_right'?'selected="selected"':'');?>>Content
											Top Right</option>
								</select></td>
              ...
              <?php } ?>
						...
						<tfoot>
							<tr>
								<td colspan="3"></td>
								<td class="text-left"><button type="button"
										onclick="addModule();" data-toggle="tooltip"
...
function addModule() {
    ...
    html += '    <option value="ct_left">Content Top Left</option>';
    html += '    <option value="ct_right">Content Top Right</option>';
    html += '  </select></td>';
