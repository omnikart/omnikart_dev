...
<div id="content">
	<div class="page-header">
        ...
        <?php if ($voucher_id) { ?>
        <button type="button" id="button-send" data-toggle="tooltip"
					title="<?php echo $button_send; ?>" class="btn btn-primary">
					<i class="fa fa-envelope"></i>
				</button>
        <?php } ?>
        <button type="submit" form="form-voucher" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-voucher"
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="from_name"
										...
										placeholder="<?php echo $entry_from_name; ?>"
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="from_email"
										...
										placeholder="<?php echo $entry_from_email; ?>"
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="to_email"
										value="<?php echo $to_email; ?>"
										placeholder="<?php echo $entry_to_email; ?>"
