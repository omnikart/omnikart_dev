		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-return').submit() : false;">
			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="filter_return_id"
									value="<?php echo $filter_return_id; ?>"
									placeholder="<?php echo $entry_return_id; ?>"
									id="input-return-id" class="form-control" />
							</div>
							<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<div class="form-group">
								...
								<input type="text" name="filter_product"
						...
						<div class="col-sm-3">
							...
							<div class="form-group">
								...
								<select name="filter_return_status_id" id="input-return-status"
									class="form-control">
									<option value="*"></option>
                ...
                <tr>
                    ...
                    <input type="checkbox" name="selected[]"
										value="<?php echo $return['return_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]"
                    ...
                    <?php } ?></td>
									...
									<td class="text-right"><a href="<?php echo $return['edit']; ?>"
