		...
		<div class="container-fluid">
			<div class="pull-right">
				<a href="<?php echo $add; ?>" data-toggle="tooltip"
					...
					href="index.php?route=module/excelport&token=<?php echo $_SESSION['token']; ?>"
					class="btn btn-info" data-toggle="tooltip" title="Export / Import"><i
					class="fa fa-file-excel-o"></i></a>

				<button type="button" data-toggle="tooltip"
					title="<?php echo $button_delete; ?>" class="btn btn-danger"
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-customer').submit() : false;">
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="well">
                  ...
                  <?php } ?>
							...
							<div class="form-group">
								...
								<input type="text" name="filter_ip"
									value="<?php echo $filter_ip; ?>"
                ...
                <tr>
                    ...
                    <a href="<?php echo $customer['approve']; ?>"
                    ...
                    <a href="<?php echo $customer['unlock']; ?>"
										data-toggle="tooltip" title="<?php echo $button_unlock; ?>"
