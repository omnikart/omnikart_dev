	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-custom-field" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-custom-field"
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-sort-order"><span
							data-toggle="tooltip" title="<?php echo $help_sort_order; ?>"><?php echo $entry_sort_order; ?></span></label>
						<div class="col-sm-10">
              ...
              <tr
								id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
                  ...
                  <div class="input-group">
										<span class="input-group-addon"><img
											...
											placeholder="<?php echo $entry_custom_value; ?>"
											class="form-control" />
									</div>
                  ...
                  <?php } ?></td>
								...
								<td class="text-left"><button
										onclick="$('#custom-field-value-row<?php echo $custom_field_value_row; ?>').remove();"
						...
						<tfoot>
							<tr>
								...
								<td class="text-left"><button type="button"
										onclick="addCustomFieldValue();" data-toggle="tooltip"
										title="<?php echo $button_custom_field_value_add; ?>"
