	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-return" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-return"
            ...
            <?php } ?>
                  ...
                  <?php  } ?>
                    ...
                    <?php } else { ?>
                    <option
												value="<?php echo $return_reason['return_reason_id']; ?>"><?php echo $return_reason['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
									</div>
                    ...
                    <?php } else { ?>
                    <option
												value="<?php echo $return_action['return_action_id']; ?>"><?php echo $return_action['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
									</div>
          ...
          <div class="tab-pane" id="tab-history">
                    ...
                    <?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea name="history_comment" rows="8"
											id="input-history-comment" class="form-control"></textarea>
									</div>
								</div>
