			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_order_recurring_id"
									...
									placeholder="<?php echo $entry_order_id; ?>"
									id="input-order-id" class="form-control" />
							</div>
							<div class="form-group">
								<label class="control-label" for="input-reference"><?php echo $entry_reference; ?></label>
								<input type="text" name="filter_reference"
									value="<?php echo $filter_reference; ?>"
									placeholder="<?php echo $entry_reference; ?>"
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select name="filter_status" id="input-filter-status"
									class="form-control">
							...
							<div class="form-group">
								...
								<div class="input-group date">
									<input type="text" name="filter_date_added"
										...
										data-date-format="YYYY-MM-DD" id="input-date-date_added"
				...
				<form action="" method="post" enctype="multipart/form-data"
                    ...
                    <a href="<?php echo $sort_order_recurring; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_order_recurring; ?></a>
                    <?php } else { ?>
                    ...
                    <a href="<?php echo $sort_order; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_order_id; ?></a>
                    <?php } else { ?>
                    ...
                    <a href="<?php echo $sort_reference; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_reference; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_reference; ?>"><?php echo $entry_reference; ?></a>
                    <?php }  ?></td>
									<td class="text-left"><?php if ($sort == 'customer') { ?>
                    <a href="<?php echo $sort_customer; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_customer ?></a>
                    <?php } else { ?>
                    ...
                    <a href="<?php echo $sort_status; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_status; ?></a>
                    <?php } else { ?>
                    ...
                    <a href="<?php echo $sort_date_added; ?>"
										class="<?php echo strtolower($order); ?>"><?php echo $entry_date_added ?></a>
                    <?php } else { ?>
                ...
                <tr>
									...
									<td class="text-left"><a
										href="<?php echo $recurring['order_link']; ?>"
										data-toggle="tooltip"
										title="<?php echo $button_view; ?> <?php echo $recurring['order_id'] ?>"
									...
									<td class="text-right"><a
										href="<?php echo $recurring['view']; ?>" data-toggle="tooltip"
