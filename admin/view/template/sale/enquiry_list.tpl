	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" id="button-delete" form="form-enquiry"
					formaction="<?php echo $action; ?>" data-toggle="tooltip"
					title="Delete Seleted Queries" class="btn btn-danger">
					<i class="fa fa-times"></i>
				</button>
				<button type="submit" id="button-update" form="form-enquiry"
					formaction="<?php echo $update; ?>" data-toggle="tooltip"
					title="Update Seleted Queries" class="btn btn-info">
			...
			<?php foreach ($enquiries as $enquiry) { ?>
				<div class="panel panel-default">
						...
						<a href="" data-toggle="modal" data-target="#chatModal"
										style="margin-left: 500px;">Chat with customer</a> <a
										href="javascript:void();"
										data-enquiryId="<?php echo $enquiry['enquiry_id']; ?>"
										class="pull-right" data-toggle="modal"
										data-target="#enquiryModal">Reply with Smart Quotation</a>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form" id="form-quotation">
						<input type="hidden" name="enquiry_id" value="" /> <input
							type="hidden" name="revision_id" value="1" /> <input
							type="hidden" name="comment" value="1" />
						<div class="table-responsive">
							<table class="table table-bordered table-hover">
									...
									<tr>
										<td colspan="6">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Contact Person :</label> <input
															type="text" name="firstname" value="" id="input-name"
															class="form-control">
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Company Name :</label> <input
															...
															id="input-company_name" class="form-control">
													</div>
												</div>
											</div>
											<div class="form-group">
												<label class="control-label" for="input-address">Address</label>
												<select name="address" id="input-address"
													class="form-control">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group required">
														<label class="control-label" for="input-address-1">Address
															1:</label> <input type="text" name="address_1" value=""
															id="input-address-1" class="form-control" />
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group required">
														<label class="control-label" for="input-address-2">Address
															2:</label> <input type="text" name="address_2" value=""
				                    ...
				                    <?php } ?>
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Contact No :</label> <input
															type="text" value="" name="phone" id="input-phone"
															class="form-control">
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Email :</label> <input
															type="text" value="" name="email" id="input-email"
															class="form-control">
													</div>
												</div>
											</div>
										...
										<td colspan="6">
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<div class="input-group date">
															<input type="text" name="date" value="" id="input-date"
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<div class="input-group date">
															<input type="text" name="quote_expiration_date" value=""
																id="input-date" class="form-control"> <span
											...
											<div class="form-group">
												...
												<input type="text" name="omnikart_contact_name" value=""
													id="input-name" class="form-control">
											</div>
											<div class="form-group">
												<label class="control-label">Omnikart Contact No :</label> <input
													type="text" name="omnikart_contact_no" value=""
													class="form-control">
											</div>
											<div class="row">
												<div class="col-sm-6">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Price :</label> <input
															type="text" name="price" value="" class="form-control">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-sm-6">
													...
													<div class="form-group">
														...
														<input type="text" name="packing_forwarding" value=""
															class="form-control">
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Octroi :</label> <input
															type="text" name="lead_time" value=""
															class="form-control">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Payment Method :</label> <input
															type="text" name="payment_method" value=""
															class="form-control">
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label class="control-label">Payment Terms :</label> <input
															type="text" name="payment_terms" value=""
															class="form-control">
													</div>
												</div>
											</div>
								...
								<tfoot>
									<tr>
										<td colspan="12" border="0">
											<button id="add_button" title="add-button" type="button"
				...
				<div class="container">
					<div class="col-sm-4">
						<b>Commercial Terms and Conditions</b> </br> 1 Tax & Duties : 5%
						(Inclusive in Unit Price) </br> 2 Price : As quoted </br> 3
						Packing and Forwarding : Nil </br> 4 Octroi : Nil </br> 5 Payment
						Method : Cash/Cheque </br> 6 Payment Terms : 100% Advance </br> 7
						Special Terms if Any : The above prices are subject to change if
						the quantity and material vary at the time of placing order. </br>
						</br>
						</br>
					</div>
					<div class="col-sm-4">
						<b>Omnikart Bank Details </b> </br> Bank Name & Branch : HDFC
						Bank, Powai </br> Acoount Name : Omnikart Engineering Pvt Ltd </br>
						Account Number : 50200008446091 </br> IFSC Code : HDFC0000239 </br>
					</div>
					<div class="col-sm-4">
						<b>Vat/Tin Details </b> </br> CIN U29253MH2014PTC257831 </br> PAN
						N0 AACCO0433A </br> VAT TIN 27641098315 V </br> CST TIN
						27641098315 C </br>
					</div>
				</div>
				<div align="center">
					<a target="_blank" href="" id="pdf_link" type="button"
						class="btn btn-default"><i class="fa fa-2x fa-paper-plane"></i></a>
					<button id="button-form-update" data-toggle="tooltip"
						title="Update Seleted Queries" class="btn btn-info">
