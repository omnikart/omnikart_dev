			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					...
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab-data" data-toggle="tab"><?php echo $tab_group; ?></a></li>
                  ...
                  <?php } ?>               
                    ...
                    <?php } ?>
						...
						<div class="tab-pane" id="tab-gp">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="">GP Template</label>
								<div class="col-sm-10">
									<select type="text" name="gp_template" class="form-control">
										<option value="default" selected="selected">gp_grouped_default.tpl</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for=""><span
									...
									data-original-title="The prices (Start,From,To) displayed in list pages (category,search,etc). Fixed Price or #ID for auto check (ID:Load increases).">Price
										Mask</span></label>
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-6">
											<div class="input-group">
												<span class="input-group-addon">Min</span> <input
													type="text" name="gp_price_min" value="" title=""
													class="form-control">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="input-group">
												<span class="input-group-addon">Max</span> <input
													type="text" name="gp_price_max" value=""
													class="form-control">
											</div>
										</div>
									</div>
								...
								<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr class="info">
											...
											<td class="text-left text-nowrap">Name</td>
											<td class="text-left text-nowrap">Model</td>
											<td class="text-left text-nowrap">Price</td>
											<td class="text-left text-nowrap" style="width: 1px;">Sort
												Order</td>
