                  ...
                  <tbody>
                    ...
                    <?php } ?>
						...
						<div class="tab-pane" id="tab-gp">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for=""><span data-toggle="tooltip" title="" data-original-title="The prices (Start,From,To) displayed in list pages (category,search,etc). Fixed Price or #ID for auto check (ID:Load increases).">Price Mask</span></label>
								<div class="col-sm-10"><div class="row">
									<div class="col-sm-6"><div class="input-group">
										<span class="input-group-addon">Min</span>
										<input type="text" name="gp_price_min" value="" title="" class="form-control">
									</div></div>
									<div class="col-sm-6"><div class="input-group">
										<span class="input-group-addon">Max</span>
										<input type="text" name="gp_price_max" value="" class="form-control">
									</div></div>
								</div></div>
							</div>
							<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover">
								<thead>
									<tr class="info">
										...
										<td class="text-left text-nowrap" style="width:1px;">Sort Order</td>
