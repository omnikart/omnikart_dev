	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-recurring" data-toggle="tooltip"
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-recurring"
              ...
              <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="duration"
									...
									placeholder="<?php echo $entry_duration; ?>"
									id="input-duration" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="cycle" value="<?php echo $cycle; ?>"
									placeholder="<?php echo $entry_cycle; ?>" id="input-cycle"
									class="form-control" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="frequency" id="input-frequency"
									class="form-control">
                  <?php foreach ($frequencies as $frequency_option) { ?>
                  <?php if ($frequency == $frequency_option['value']) { ?>
                  <option
										value="<?php echo $frequency_option['value']; ?>"
										selected="selected"><?php echo $frequency_option['text']; ?></option>
                  <?php } else { ?>
                  <option
										value="<?php echo $frequency_option['value']; ?>"><?php echo $frequency_option['text']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
							</div>
                  ...
                  <?php } ?>
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="trial_price"
									value="<?php echo $trial_price; ?>"
									placeholder="<?php echo $entry_trial_price; ?>"
									id="input-trial-price" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-trial-duration"><?php echo $entry_trial_duration; ?></label>
							<div class="col-sm-10">
								<input type="text" name="trial_duration"
									value="<?php echo $trial_duration; ?>"
									placeholder="<?php echo $entry_trial_duration; ?>"
									id="input-trial-duration" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-trial-cycle"><?php echo $entry_trial_cycle; ?></label>
							<div class="col-sm-10">
								<input type="text" name="trial_cycle"
									value="<?php echo $trial_cycle; ?>"
									placeholder="<?php echo $entry_trial_cycle; ?>"
									id="input-trial-cycle" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-trial-frequency"><?php echo $entry_trial_frequency; ?></label>
							<div class="col-sm-10">
								<select name="trial_frequency" id="input-trial-frequency"
									class="form-control">
                  <?php foreach ($frequencies as $frequency_option) { ?>
                  ...
                  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="trial_status" id="input-trial-status"
									class="form-control">
                  <?php if ($trial_status) { ?>
                  <option value="0"><?php echo $text_disabled ?></option>
									<option value="1" selected="selected"><?php echo $text_enabled ?></option>
