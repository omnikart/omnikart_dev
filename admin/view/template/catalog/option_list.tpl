		...
		<div class="container-fluid">
			<div class="pull-right">
				...
				<button type="button" data-toggle="tooltip"
					...
					onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-option').submit() : false;">
			...
			<div class="panel-body">
                ...
                <tr>
                    ...
                    <input type="checkbox" name="selected[]"
										value="<?php echo $option['option_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]"
                    ...
                    <?php } ?></td>
									...
									<td class="text-right"><a href="<?php echo $option['edit']; ?>"
