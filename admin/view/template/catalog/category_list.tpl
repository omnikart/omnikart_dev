		...
		<div class="container-fluid">
			<div class="pull-right">
				<a href="<?php echo $add; ?>" data-toggle="tooltip"
					...
					class="fa fa-file-excel-o"></i></a> <a
					href="<?php echo $repair; ?>" data-toggle="tooltip"
					title="<?php echo $button_rebuild; ?>" class="btn btn-default"><i
			...
			<div class="panel-body">
				<div class="well">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label" for="input-name">Parent</label> <input
									type="text" name="filter_parent"
									value="<?php echo $filter_parent; ?>" placeholder="parent name"
                ...
                <tr>
                    ...
                    <?php } ?></td>
									...
									<td class="text-right"><a
										href="<?php echo $category['edit']; ?>" data-toggle="tooltip"
