    ...
    <div class="panel panel-default">
            ...
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea
												...
												id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
										</div>
									</div>
									<div class="form-group required">
										<label class="col-sm-2 control-label"
                ...
                <?php } ?>
						...
						<div class="tab-pane" id="tab-gp">
								...
								<div class="col-sm-10">
									<select type="text" name="gp_template" class="form-control">
										...
										<option value="<?php echo $value['template']; ?>"
											selected="selected"><?php echo $value['file']; ?></option>
										<?php } else { ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for=""><span
									data-toggle="tooltip"
									title="<?php echo $help_gp_price_mask; ?>"><?php echo $entry_gp_price_mask; ?></span></label>
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-6">
											<div class="input-group">
												<span class="input-group-addon"><?php echo $text_gp_min; ?></span>
												<input type="text" name="gp_price_min"
													value="<?php echo $gp_price_min; ?>" title=""
													class="form-control" />
											</div>
										</div>
										<div class="col-sm-6">
											<div class="input-group">
												...
												<input type="text" name="gp_price_max"
													value="<?php echo $gp_price_max; ?>" class="form-control" />
											</div>
										</div>
									</div>
								</div>
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tr id="gp-row-child-<?php echo $child['child_id']; ?>">
											...
											<td class="text-left"><a title="edit"
												onclick="window.open('<?php echo $child['href']; ?>','','width=1200,height=500,top=99');"><?php echo $child['name']; ?></a></td>
											...
											<td class="text-left"><input type="text"
												name="gp_child[<?php echo $child['child_id']; ?>][child_sort_order]"
												value="<?php echo $child['child_sort_order']; ?>"
												class="form-control" /></td>
											<td class="text-left"><button type="button"
													onclick="$(this).tooltip('destroy');$('#gp-row-child-<?php echo $child['child_id']; ?>').remove();"
									...
									<tfoot>
										<tr>
											...
											<td class="text-left"><input type="text"
												onkeyup="gpAddChild($(this), 'name');" value=""
												class="form-control" /></td>
											<td class="text-left"><input type="text"
												onkeyup="gpAddChild($(this), 'model');" value=""
												class="form-control" /></td>
											<td class="text-left"></td>
											<td class="text-left"></td>
											<td class="text-left"></td>
            ...
            <div class="tab-pane" id="tab-data">
                  ...
                  <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-sku"><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-upc"><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-ean"><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-jan"><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-isbn"><span
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-mpn"><span
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-stock-status"><span
									data-toggle="tooltip" title="<?php echo $help_stock_status; ?>"><?php echo $entry_stock_status; ?></span></label>
								<div class="col-sm-10">
                  ...
                  <?php } ?>               
                    ...
                    <?php } ?>
						...
						<div class="tab-pane" id="tab-links">
							<div class="form-group" id="form-group-gp-parent-id">
								<label class="col-sm-2 control-label" for="input-gp-parent"><span
									data-toggle="tooltip" title="<?php echo $help_gp_parent; ?>"><?php echo $entry_gp_parent; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="gp_parent"
										value="<?php echo $gp_parent ?>"
										placeholder="<?php echo $entry_gp_parent; ?>"
										id="input-gp-parent" class="form-control" /> <input
										type="hidden" name="gp_parent_id"
										value="<?php echo $gp_parent_id; ?>" />
								</div>
							</div>
							<script type="text/javascript"><!--
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-manufacturer"><span
									data-toggle="tooltip" title="<?php echo $help_manufacturer; ?>"><?php echo $entry_manufacturer; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="manufacturer"
										value="<?php echo $manufacturer ?>"
										placeholder="<?php echo $entry_manufacturer; ?>"
										id="input-manufacturer" class="form-control" /> <input
										type="hidden" name="manufacturer_id"
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-filter"><span
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-download"><span
                    ...
                    <?php } ?>
									...
									<tfoot>
										<tr>
											<td colspan="2"></td>
											<td class="text-left"><button type="button"
													onclick="addRecurring()" data-toggle="tooltip"
                    ...
                    <tr id="discount-row<?php echo $discount_row; ?>">
                          ...
                          <?php } ?>
											...
											<td class="text-right"><input type="text"
												...
												placeholder="<?php echo $entry_price; ?>"
												class="form-control" /></td>
											<td class="text-left" style="width: 20%;"><div
									...
									<tfoot>
										<tr>
											...
											<td class="text-left"><button type="button"
													...
													title="<?php echo $button_discount_add; ?>"
													class="btn btn-primary">
													<i class="fa fa-plus-circle"></i>
												</button></td>
										</tr>
									...
									<tfoot>
										<tr>
											...
											<td class="text-left"><button type="button"
													...
													title="<?php echo $button_special_add; ?>"
													class="btn btn-primary">
													<i class="fa fa-plus-circle"></i>
												</button></td>
										</tr>
						...
						<div class="tab-pane" id="tab-vendor">
							<div class="table-responsive">
								<table id="vendor"
									...
									<thead>
										<tr>
											<td class="text-left">Vendor Id</td>
                  ...
                  <?php if (isset($suppliers)) { ?>
										<?php foreach ($suppliers as $supplier) { ?>
											<tr>
											<td><?php echo $supplier['customer_id']; ?><input
												type="hidden"
												value="<?php echo $supplier['customer_id']; ?>"
												name="vendor[<?php echo $supplier['customer_id']; ?>][id]"></td>
											<td><?php echo $supplier['firstname'].' '.$supplier['lastname']; ?></td>
											<td><?php echo $supplier['email']; ?></td>
											<td><input type="text"
												name="vendor[<?php echo $supplier['customer_id']; ?>][price]"
												value="<?php echo $supplier['price']; ?>"
												class="form-control" size=3></td>
											<td><input type="text"
												name="vendor[<?php echo $supplier['customer_id']; ?>][quantity]"
												value="<?php echo $supplier['quantity']; ?>"
												class="form-control" size=3></td>
											<td><input type="text"
												name="vendor[<?php echo $supplier['customer_id']; ?>][sort_order]"
												value="<?php echo $supplier['sort_order']; ?>"
												class="form-control" size=3></td>
											<td><a onclick="$(this).parent().parent().remove()"
								...
								<table class="table table-bordered table-hover">
									...
									<tbody>
										<tr>
											...
											<td class="text-left"><select name="product_layout[0]"
												class="form-control">
													<option value=""></option>
