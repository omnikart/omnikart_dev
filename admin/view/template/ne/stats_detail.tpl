...
<div id="content">
        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-bar-chart"></i> <?php echo $entry_heading; ?></h3>
			</div>
			<div class="panel-body">
                ...
                <fieldset>
					...
					<div id="chart-views"
						style="width: 100%; height: 260px; margin-bottom: 20px;"></div>
				</fieldset>
                <?php if ($attachements) { ?>
                    <fieldset>
					<legend><?php echo $entry_attachements; ?></legend>
                        <?php foreach ($attachements as $key => $attachement) { ?>
                            <?php echo ($key + 1) . '. '; ?><a
						href="<?php echo $store_url . $attachement['path']; ?>"
						target="_blank" class="btn btn-link"><i class="fa fa-paperclip"></i> <?php echo $attachement['filename']; ?></a><br />
                        <?php } ?>
                    </fieldset>
                <?php } ?>
                <fieldset>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select name="filter_success" id="input-success"
										class="form-control">
										<option value=""></option>
						...
						<table class="table table-bordered table-hover">
							<thead>
								...
								<td class="text-right">
                                    <?php if ($sort == 'clicks') { ?>
                                        <a
									href="<?php echo $sort_clicks; ?>"
									class="<?php echo strtolower($order); ?>"><?php echo $column_clicks; ?></a>
                                    <?php } else { ?>
                                        <a
									href="<?php echo $sort_clicks; ?>"><?php echo $column_clicks; ?></a>
                                    <?php } ?>
                                </td>
								<td class="text-right">
                                    <?php if ($sort == 'success') { ?>
                                        <a
									href="<?php echo $sort_success; ?>"
									class="<?php echo strtolower($order); ?>"><?php echo $column_success; ?></a>
                                    <?php } else { ?>
                                        <a
									href="<?php echo $sort_success; ?>"><?php echo $column_success; ?></a>
                                    <?php } ?>
                                </td>
							...
							<tbody>
                                <?php if ($recipients) { ?>
									...
									<td align="right"><a
										href="<?php echo $detail_link . $recipient['stats_personal_id']; ?>"
										data-toggle="tooltip" title="<?php echo $button_details; ?>"
										class="btn btn-primary show-detail"><i class="fa fa-eye"></i></a>
									</td>
								</tr>
                                    <?php } ?>
                                <?php } else { ?>
	...
	<script type="text/javascript"
		src="view/javascript/jquery/flot/jquery.flot.js"></script>
	<script type="text/javascript"
		src="view/javascript/jquery/flot/jquery.flot.resize.min.js"></script>
