    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo $csv; ?>" data-toggle="tooltip" title="<?php echo $button_csv; ?>" class="btn btn-default"><i class="fa fa-file-text-o"></i></a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-users"></i> <?php echo $text_marketing_subscribers; ?></h3>
            </div>
            <div class="panel-body">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="input-emails"><span data-toggle="tooltip" title="<?php echo $help_subscribers; ?>"><?php echo $entry_subscribers; ?></span></label>
                            <div class="col-sm-10">
                        ...
                        <?php foreach ($stores as $store) { ?>
                            <?php if (isset($list_data[$store['store_id']]) && $list_data[$store['store_id']]) { ?>
                                <div class="form-group list-display" id="list-<?php echo $store['store_id']; ?>">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <?php foreach ($list_data[$store['store_id']] as $key => $list) { ?>
                                            <div class="checkbox">
                                                <label>
                                                    <input name="list[<?php echo $store['store_id']; ?>][]" type="checkbox" value="<?php echo $key; ?>" />
                            ...
                            <?php } ?>
                        <?php } ?>
                        <button type="submit" form="form" data-toggle="tooltip" title="<?php echo $button_insert; ?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i></button>
                    </fieldset>
                </form>
                <fieldset>
                    ...
                    <div class="well">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php if ($list_data) { ?>
                                    <?php foreach ($stores as $store) { ?>
                                        <div class="form-group list-store-display" id="list-store-<?php echo $store['store_id']; ?>">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php if ($marketing['subscribed']) { ?>
                                                        <a href="<?php echo $unsubscribe . $marketing['marketing_id']; ?>" data-toggle="tooltip" title="<?php echo $button_unsubscribe; ?>" class="btn btn-danger"><i class="fa fa-minus"></i></a>
                                                    <?php } else { ?>
                                                        <a href="<?php echo $subscribe . $marketing['marketing_id']; ?>" data-toggle="tooltip" title="<?php echo $button_subscribe; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <tr>
                                            <td class="text-center" colspan="<?php echo ($list_data ? 8 : 7); ?>"><?php echo $text_no_results; ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
