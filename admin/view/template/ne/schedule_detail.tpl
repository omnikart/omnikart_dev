...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<a id="button-preview" href="#" data-toggle="tooltip"
					title="<?php echo $button_preview; ?>" class="btn btn-info"><i
					class="fa fa-eye"></i></a>
				<button type="submit" form="form" data-toggle="tooltip"
					title="<?php echo $button_save; ?>" class="btn btn-success">
        ...
        <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					...
					<input type="hidden" name="date_next"
						value="<?php echo $date_next; ?>" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="name" value="<?php echo $name; ?>"
								id="input-name" placeholder="<?php echo $entry_name; ?>"
								class="form-control" />
                            <?php if ($error_name) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="radio-inline">
                                <?php if ($recurrent) { ?>
                                    <input type="radio" name="recurrent"
								value="1" checked="checked" />
                                    <?php echo $entry_yes; ?>
                                <?php } else { ?>
                                    <input type="radio" name="recurrent"
					...
					<div class="form-group once">
						...
						<div class="col-sm-10">
							<div class="form-inline">
								...
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
									<label><?php echo $text_at; ?></label> <select name="time"
										class="form-control">
										<option value="0"
											<?php echo $time == '0' ? ' selected="selected"' : "" ?>>00:00</option>
										<option value="1"
											<?php echo $time == '1' ? ' selected="selected"' : "" ?>>01:00</option>
										<option value="2"
											<?php echo $time == '2' ? ' selected="selected"' : "" ?>>02:00</option>
										<option value="3"
											<?php echo $time == '3' ? ' selected="selected"' : "" ?>>03:00</option>
										<option value="4"
											<?php echo $time == '4' ? ' selected="selected"' : "" ?>>04:00</option>
										<option value="5"
											<?php echo $time == '5' ? ' selected="selected"' : "" ?>>05:00</option>
										<option value="6"
											<?php echo $time == '6' ? ' selected="selected"' : "" ?>>06:00</option>
										<option value="7"
											<?php echo $time == '7' ? ' selected="selected"' : "" ?>>07:00</option>
										<option value="8"
											<?php echo $time == '8' ? ' selected="selected"' : "" ?>>08:00</option>
										<option value="9"
											<?php echo $time == '9' ? ' selected="selected"' : "" ?>>09:00</option>
										<option value="10"
											<?php echo $time == '10' ? ' selected="selected"' : "" ?>>10:00</option>
										<option value="11"
											<?php echo $time == '11' ? ' selected="selected"' : "" ?>>11:00</option>
										<option value="12"
											<?php echo $time == '12' ? ' selected="selected"' : "" ?>>12:00</option>
										<option value="13"
											<?php echo $time == '13' ? ' selected="selected"' : "" ?>>13:00</option>
										<option value="14"
											<?php echo $time == '14' ? ' selected="selected"' : "" ?>>14:00</option>
										<option value="15"
											<?php echo $time == '15' ? ' selected="selected"' : "" ?>>15:00</option>
										<option value="16"
											<?php echo $time == '16' ? ' selected="selected"' : "" ?>>16:00</option>
										<option value="17"
											<?php echo $time == '17' ? ' selected="selected"' : "" ?>>17:00</option>
										<option value="18"
											<?php echo $time == '18' ? ' selected="selected"' : "" ?>>18:00</option>
										<option value="19"
											<?php echo $time == '19' ? ' selected="selected"' : "" ?>>19:00</option>
										<option value="20"
											<?php echo $time == '20' ? ' selected="selected"' : "" ?>>20:00</option>
										<option value="21"
											<?php echo $time == '21' ? ' selected="selected"' : "" ?>>21:00</option>
										<option value="22"
											<?php echo $time == '22' ? ' selected="selected"' : "" ?>>22:00</option>
										<option value="23"
											<?php echo $time == '23' ? ' selected="selected"' : "" ?>>23:00</option>
									</select>
								</div>
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
					...
					<div class="form-group recurrent">
						...
						<div class="col-sm-10">
							<select name="frequency" class="form-control">
								<option value="1"
									<?php echo $frequency == '1' ? ' selected="selected"' : "" ?>>
                                    <?php echo $text_daily; ?>
                                </option>
								<option value="7"
									<?php echo $frequency == '7' ? ' selected="selected"' : "" ?>>
                                    <?php echo $text_weekly; ?>
                                </option>
								<option value="30"
									<?php echo $frequency == '30' ? ' selected="selected"' : "" ?>>
						...
						<div class="col-sm-10">
							<div class="form-inline">
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
									<select name="day"
										<?php echo ( $frequency == '1' ) ? 'disabled="disabled"' : ''?>
										class="form-control">
										<option value="1"
											<?php echo $day == '1' ? ' selected="selected"' : "" ?>><?php echo $text_monday; ?></option>
										<option value="2"
											<?php echo $day == '2' ? ' selected="selected"' : "" ?>><?php echo $text_tuesday; ?></option>
										<option value="3"
											<?php echo $day == '3' ? ' selected="selected"' : "" ?>><?php echo $text_wednesday; ?></option>
										<option value="4"
											<?php echo $day == '4' ? ' selected="selected"' : "" ?>><?php echo $text_thursday; ?></option>
										<option value="5"
											<?php echo $day == '5' ? ' selected="selected"' : "" ?>><?php echo $text_friday; ?></option>
										<option value="6"
											<?php echo $day == '6' ? ' selected="selected"' : "" ?>><?php echo $text_saturday; ?></option>
										<option value="0"
											<?php echo $day == '0' ? ' selected="selected"' : "" ?>><?php echo $text_sunday; ?></option>
                                        <?php if ( $frequency == '1' ) { ?>
                                        <option value=""
											selected="selected"><?php echo $text_daily; ?></option>
                                        <?php } ?>
                                    </select>
								</div>
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
									<label><?php echo $text_at; ?></label> <select name="rtime"
										class="form-control">
										<option value="0"
											<?php echo $time == '0' ? ' selected="selected"' : "" ?>>00:00</option>
										<option value="1"
						...
						<div class="col-sm-10">
							<select name="template_id" class="form-control">
                                <?php foreach ($templates as $template) { ?>
									...
									selected="selected"><?php echo $template['name']; ?></option>
                                    <?php } else { ?>
                                        <option
									value="<?php echo $template['template_id']; ?>"><?php echo $template['name']; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
						</div>
						...
						<div class="col-sm-10">
							<select name="language_id" class="form-control">
                                <?php foreach ($languages as $language) { ?>
                                    ...
                                    <?php } else { ?>
                                        <option
									value="<?php echo $language['language_id']; ?>"><?php echo $language['name']; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
							<div class="checkbox">
								<label>
                                    <?php if ($only_selected_language) { ?>
                                        <input type="checkbox"
									name="only_selected_language" value="1" checked="checked" />
                                    <?php } else { ?>
                                        <input type="checkbox"
									name="only_selected_language" value="1" />
                                    <?php } ?>
							...
							<select name="currency" class="form-control">
                                <?php foreach ($currencies as $cur) { ?>
                                    <?php if ($cur['code'] == $currency) { ?>
                                        <option
									value="<?php echo $cur['code']; ?>" selected="selected"><?php echo $cur['title']; ?></option>
                                    <?php } else { ?>
                                        <option
									value="<?php echo $cur['code']; ?>"><?php echo $cur['title']; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
						</div>
						...
						<div class="col-sm-10">
							<select name="to" id="input-to" class="form-control">
                                ...
                                <?php if ($to == 'rewards') { ?>
									...
									selected="selected"><?php echo $text_rewards; ?></option>
                                <?php } else { ?>
                                    <option value="rewards"><?php echo $text_rewards; ?></option>
                                <?php } ?>
                                <?php if ($to == 'rewards_all') { ?>
                                    <option value="rewards_all"
									selected="selected"><?php echo $text_rewards_all; ?></option>
                                <?php } else { ?>
                    ...
                    <?php if ($list_data) { ?>
						...
						<div class="col-sm-10">
                                <?php foreach ($stores as $store) { ?>
                                    <div
								class="well well-sm list-display marketing-list-<?php echo $store['store_id']; ?>"
								style="height: 150px; overflow: auto;">
									...
									<label>
                                                    <?php if ($marketing_list && is_array($marketing_list) && in_array($store['store_id'] . '_' . $key, $marketing_list)) { ?>
                                                        <input
										type="checkbox" name="marketing_list[]"
							...
							<div class="checkbox">
								<label>
                                    <?php if ($customer_group_only_subscribers) { ?>
                                        <input type="checkbox"
									name="customer_group_only_subscribers" value="1"
									checked="checked" />
                                    <?php } else { ?>
                                        <input type="checkbox"
									name="customer_group_only_subscribers" value="1" />
					...
					<div class="form-group to to-customer">
						...
						<div class="col-sm-10">
							...
							<div id="customer" class="well well-sm"
								style="height: 150px; overflow: auto;">
                                <?php foreach ($customers as $customer) { ?>
                                    <div
									id="customer-<?php echo $customer['customer_id']; ?>">
									<i class="fa fa-minus-circle"></i> <?php echo $customer['name']; ?>
                                        <input type="hidden"
										name="customer[]"
					...
					<div class="form-group to to-affiliate">
						...
						<div class="col-sm-10">
							<input type="text" name="affiliates" value=""
								placeholder="<?php echo $entry_affiliate; ?>"
								id="input-affiliate" class="form-control" autocomplete="off">
							<div id="affiliate" class="well well-sm"
								style="height: 150px; overflow: auto;">
                                <?php foreach ($affiliates as $affiliate) { ?>
                                    <div
									id="affiliate-<?php echo $affiliate['affiliate_id']; ?>">
									<i class="fa fa-minus-circle"></i> <?php echo $affiliate['name']; ?>
                                        <input type="hidden"
										name="affiliate[]"
					...
					<div class="form-group required random">
						<label class="col-sm-2 control-label" for="input-random-count"><span
							data-toggle="tooltip" title="<?php echo $help_random_count; ?>"><?php echo $entry_random_count; ?></span></label>
						<div class="col-sm-10 col-md-2">
							<input type="text" name="random_count"
								value="<?php echo $random_count; ?>" class="form-control"
								id="input-random-count" size="2">
						</div>
					</div>
					...
					<div class="form-group defined-product">
						...
						<div class="col-sm-10">
							<input type="text" name="defined_product_text" value=""
								placeholder="<?php echo $entry_section_name; ?>"
								class="form-control" />
						</div>
					</div>
					<div class="form-group defined-product">
						...
						<div class="col-sm-10">
							<input type="text" name="defined_products" value=""
								placeholder="<?php echo $entry_product; ?>"
								id="input-defined-products" class="form-control"
								autocomplete="off">
							<div id="defined-product" class="well well-sm"
								style="height: 150px; overflow: auto;">
                                <?php foreach ($defined_products as $product) { ?>
                                    <div
									id="defined-product-<?php echo $product['product_id']; ?>">
									<i class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
                                        <input type="hidden"
                    ...
                    <?php foreach ($defined_products_more as $index => $dpm) { ?>
						...
						<label class="col-sm-2 control-label"
							for="input-section-name-<?php echo $index; ?>"><?php echo $entry_section_name; ?></label>
						<div class="col-sm-10">
							<div class="input-group">
								<input type="text"
									name="defined_product_more[<?php echo $index; ?>][text]"
									value="<?php echo $dpm['text']; ?>"
									id="input-section-name-<?php echo $index; ?>"
									placeholder="<?php echo $entry_section_name; ?>"
									class="form-control" /> <span class="input-group-btn">
									<button onclick="removeSection(this);" class="btn btn-default"
										type="button">
					...
					<div class="form-group defined-product">
						<label class="col-sm-2 control-label"
							for="input-defined-products-<?php echo $index; ?>"><?php echo $entry_product; ?></label>
						<div class="col-sm-10">
							<input type="text" name="defined_products_<?php echo $index; ?>"
								value="" placeholder="<?php echo $entry_product; ?>"
								id="input-defined-products-<?php echo $index; ?>"
								data-id="<?php echo $index; ?>" class="form-control"
								autocomplete="off">
							<div id="defined-product-<?php echo $index; ?>"
								class="well well-sm" style="height: 150px; overflow: auto;">
                                    <?php foreach ($dpm['products'] as $product) { ?>
                                        <div
									id="defined-product-entry-<?php echo $index; ?>-<?php echo $product['product_id']; ?>">
									<i class="fa fa-minus"></i> <?php echo $product['name']; ?>
                                            <input type="hidden"
										name="defined_product_more[<?php echo $index; ?>][products][]"
										value="<?php echo $product['product_id']; ?>" />
								</div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="form-group defined-product">
						<div class="col-sm-10 col-sm-offset-2">
							<button id="button-add-defined-section" class="btn btn-primary"
								type="button">
							...
							<div class="checkbox checkbox-special">
								<label>
                                    <?php if (!empty($skip_out_of_stock["special"])) { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[special]" value="1" checked="checked" />
                                    <?php } else { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[special]" value="1" />
                                    <?php } ?>
							...
							<div class="checkbox checkbox-latest">
								<label>
                                    <?php if (!empty($skip_out_of_stock["latest"])) { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[latest]" value="1" checked="checked" />
                                    <?php } else { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[latest]" value="1" />
                                    <?php } ?>
                                    <?php echo $text_skip_out_of_stock; ?>
                                </label>
							</div>
							...
							<div class="checkbox checkbox-popular">
								<label>
                                    <?php if (!empty($skip_out_of_stock["popular"])) { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[popular]" value="1" checked="checked" />
                                    <?php } else { ?>
                                        <input type="checkbox"
									name="skip_out_of_stock[popular]" value="1" />
                                    <?php } ?>
                                    <?php echo $text_skip_out_of_stock; ?>
                                </label>
							</div>
						...
						<div class="col-sm-10">
							<label class="radio-inline">
                                <?php if ($defined_categories) { ?>
                                    <input type="radio"
								name="defined_categories" value="1" checked="checked" />
                                    <?php echo $entry_yes; ?>
                                <?php } else { ?>
                                    <input type="radio"
								name="defined_categories" value="1" />
                                    <?php echo $entry_yes; ?>
                                <?php } ?>
                            </label> <label class="radio-inline">
                                <?php if (!$defined_categories) { ?>
                                    <input type="radio"
								name="defined_categories" value="0" checked="checked" />
                                    <?php echo $entry_no; ?>
                                <?php } else { ?>
                                    <input type="radio"
								name="defined_categories" value="0" />
                                    <?php echo $entry_no; ?>
                                <?php } ?>
                            </label>
						</div>
						...
						<div class="col-sm-10 col-sm-offset-2">
							...
							<div class="form-inline">
								<div class="form-group"
									...
									<input type="text" name="defined_category_limit"
										value="<?php echo $defined_category_limit; ?>"
										class="form-control" id="input-defined-categories-limit"
										size="2">
								</div>
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
									<label><?php echo $entry_sort_by; ?></label> <select
										name="defined_category_sort" class="form-control">
                                        <?php if ($defined_category_sort == 'date_added') { ?>
                                            <option value="date_added"
											selected="selected"><?php echo $text_date_added; ?></option>
                                        <?php } else { ?>
                                            <option value="date_added"><?php echo $text_date_added; ?></option>
                                        <?php } ?>
                                        <?php if ($defined_category_sort == 'sort_order') { ?>
                                            <option value="sort_order"
											selected="selected"><?php echo $text_sort_order; ?></option>
                                        <?php } else { ?>
								...
								<div class="form-group"
									style="margin-left: 0; margin-right: 15px;">
									<label><?php echo $entry_order; ?></label> <select
										name="defined_category_order" class="form-control">
                                        <?php if (!$defined_category_order) { ?>
                                            <option value="0"
											selected="selected"><?php echo $text_ascending; ?></option>
                                        <?php } else { ?>
                                            <option value="0"><?php echo $text_ascending; ?></option>
                                        <?php } ?>
                                        <?php if ($defined_category_order) { ?>
                                            <option value="1"
											selected="selected"><?php echo $text_descending; ?></option>
                                        <?php } else { ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="subject" value="<?php echo $subject; ?>"
								id="input-subject" placeholder="<?php echo $entry_subject; ?>"
								class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea name="text_message" id="input-text-message" rows="10"
								class="form-control"><?php echo $text_message; ?></textarea>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="radio-inline">
                                <?php if ($text_message_products) { ?>
                                    <input type="radio"
								name="text_message_products" value="1" checked="checked" />
                                    <?php echo $entry_yes; ?>
                                <?php } else { ?>
                                    <input type="radio"
								name="text_message_products" value="1" />
                                    <?php echo $entry_yes; ?>
                                <?php } ?>
                            </label> <label class="radio-inline">
                                <?php if (!$text_message_products) { ?>
                                    <input type="radio"
								name="text_message_products" value="0" checked="checked" />
                                    <?php echo $entry_no; ?>
                                <?php } else { ?>
                                    <input type="radio"
								name="text_message_products" value="0" />
                                    <?php echo $entry_no; ?>
                                <?php } ?>
                            </label>
						</div>
	...
	<script type="text/javascript"
		src="view/javascript/ne/ckeditor/ckeditor.js"></script>
	<script type="text/javascript"><!--
