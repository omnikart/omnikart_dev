    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-bar-chart"></i> <?php echo $text_stats; ?></h3>
            </div>
                                ...
                                <?php if ($stats) { ?>
                                    <?php foreach ($stats as $stat) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $detail . $stat['stats_id']; ?>" data-toggle="tooltip" title="<?php echo $button_details; ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
