        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-check-square-o"></i> <?php echo $text_subscribe_box; ?></h3>
			</div>
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="fields" class="form-control">
                                    <?php if ($fields == '1') { ?>
                                        <option value="1"
										selected="selected"><?php echo $text_only_email; ?></option>
                                    <?php } else { ?>
                                        <option value="1"><?php echo $text_only_email; ?></option>
                                    <?php } ?>
                                    <?php if ($fields == '2') { ?>
                                        <option value="2"
										selected="selected"><?php echo $text_email_name; ?></option>
                                    <?php } else { ?>
                                        <option value="2"><?php echo $text_email_name; ?></option>
                                    <?php } ?>
                                    <?php if ($fields == '3') { ?>
                                        <option value="3"
										selected="selected"><?php echo $text_email_full; ?></option>
                                    <?php } else { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="type" class="form-control">
                                    <?php if ($type == '1') { ?>
                                        <option value="1"
										selected="selected"><?php echo $text_content_box; ?></option>
                                    <?php } else { ?>
                                        <option value="1"><?php echo $text_content_box; ?></option>
                                    <?php } ?>
                                    <?php if ($type == '2') { ?>
                                        <option value="2"
										selected="selected"><?php echo $text_modal_popup; ?></option>
                                    <?php } else { ?>
                                        <option value="2"><?php echo $text_modal_popup; ?></option>
                                    <?php } ?>
                                    <?php if ($type == '3') { ?>
                                        <option value="3"
										selected="selected"><?php echo $text_content_box_to_modal; ?></option>
                                    <?php } else { ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="list_type" class="form-control">
                                    ...
                                    <?php } else { ?>
                                        <option value="0"
										selected="selected"><?php echo $text_checkboxes; ?></option>
					...
					<fieldset class="subscribe-modal">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-modal-timeout"><span
								data-toggle="tooltip" title="<?php echo $help_modal_timeout; ?>"><?php echo $entry_modal_timeout; ?></span></label>
							<div class="col-sm-10 col-md-2">
								<input type="text" name="modal_timeout"
									value="<?php echo $modal_timeout; ?>" id="input-modal-timeout"
									class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-repeat-time"><span
								data-toggle="tooltip"
								title="<?php echo $help_modal_repeat_time; ?>"><?php echo $entry_modal_repeat_time; ?></span></label>
							<div class="col-sm-10 col-md-2">
								<input type="text" name="repeat_time"
									value="<?php echo $repeat_time; ?>" id="input-repeat-time"
									class="form-control" />
							</div>
						</div>
					</fieldset>
					<fieldset class="subscribe-modal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10 col-md-4">
								<div class="input-group color">
									<input type="text" name="modal_bg_color"
										value="<?php echo $modal_bg_color; ?>"
										id="input-modal-bg-color" class="form-control" /> <span
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"
								for="input-modal-line-color"><?php echo $entry_modal_line_color; ?></label>
							<div class="col-sm-10 col-md-4">
								<div class="input-group color">
									<input type="text" name="modal_line_color"
										value="<?php echo $modal_line_color; ?>"
										id="input-modal-line-color" class="form-control" /> <span
										class="input-group-addon"><i></i></span>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label"
								for="input-modal-heading-color"><?php echo $entry_modal_heading_color; ?></label>
							<div class="col-sm-10 col-md-4">
								<div class="input-group color">
									<input type="text" name="modal_heading_color"
										value="<?php echo $modal_heading_color; ?>"
										id="input-modal-heading-color" class="form-control" /> <span
										class="input-group-addon"><i></i></span>
								</div>
							</div>
						</div>
					...
					<div class="tab-content">
                        <?php foreach ($languages as $language) { ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="input-heading-<?php echo $language['language_id']; ?>"><?php echo $entry_heading; ?></label>
								<div class="col-sm-10">
									<input type="text"
										name="heading[<?php echo $language['language_id']; ?>]"
										value="<?php echo isset($heading[$language['language_id']]) ? $heading[$language['language_id']] : ''; ?>"
										placeholder="<?php echo $entry_heading; ?>"
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="input-text-<?php echo $language['language_id']; ?>"><?php echo $entry_text; ?></label>
								<div class="col-sm-10">
									<textarea name="text[<?php echo $language['language_id']; ?>]"
										id="input-text-<?php echo $language['language_id']; ?>"
										class="form-control"><?php echo isset($text[$language['language_id']]) ? $text[$language['language_id']] : ''; ?></textarea>
								</div>
							</div>
						</div>
                        <?php } ?>
