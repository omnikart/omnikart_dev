        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-ban"></i> <?php echo $text_blacklisted_emails; ?></h3>
			</div>
				...
				<form action="<?php echo $action; ?>" method="post"
					...
					<fieldset>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<textarea name="emails" placeholder="" rows="5"
						...
						<div class="form-group">
							<div class="col-sm-12 text-right">
								<button type="submit" form="form" data-toggle="tooltip"
									title="<?php echo $button_insert; ?>" class="btn btn-primary">
								...
								<tbody>
                                    <?php if ($blacklisted) { ?>
										...
										<td class="text-center">
											...
											value="<?php echo $entry['blacklist_id']; ?>"
											checked="checked" />
                                                    <?php } else { ?>
                                                        <input
											type="checkbox" name="selected[]"
