...
<div id="content">
		...
		<div class="container-fluid">
			<div class="pull-right">
				<a id="button-preview" href="#" data-toggle="tooltip"
					...
					onclick="$('input[name=spam_check]').val('1');send('index.php?route=ne/newsletter/send&token=<?php echo $token; ?>');return false;"
					href="#" data-toggle="tooltip" title="<?php echo $button_check; ?>"
					class="btn btn-warning"><i class="fa fa-check-square-o"></i></a> <a
					onclick="$('#form').ajaxFormUnbind();$('#form').attr('action', '<?php echo $save; ?>');$('#form').submit();return false;"
					href="#" data-toggle="tooltip"
					title="<?php echo ($back ? $button_update : $button_save); ?>"
					class="btn btn-success"><i class="fa fa-floppy-o"></i></a> <a
					id="button-send" href="#" data-toggle="tooltip"
					title="<?php echo $button_send; ?>" class="btn btn-primary"><i
					class="fa fa-envelope-o"></i></a> <a
					href="<?php echo ($back ? $back : $reset); ?>"
					data-toggle="tooltip"
					title="<?php echo ($back ? $button_back : $button_reset); ?>"
					class="btn btn-default"><i
					class="fa fa-<?php echo ($back ? 'reply' : 'undo'); ?>"></i></a>
			</div>
        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-envelope"></i> <?php echo $text_create_and_send; ?></h3>
			</div>
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form" class="form-horizontal">
					<input type="hidden" name="id" value="<?php echo $id; ?>" /> <input
						type="hidden" name="newsletter_id" value="" /> <input
						type="hidden" name="sent_count" value="" /> <input type="hidden"
						name="spam_check" value="" /> <input type="hidden"
						name="attachments_id" value="<?php echo $attachments_id; ?>" /> <input
						type="hidden" name="attachments_count" value="0" />
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-template"><?php echo $entry_template; ?></label>
						<div class="col-sm-10">
							<select name="template_id" id="input-template"
								class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="language_id" id="input-language"
								class="form-control">
					...
					<div class="form-group attachments">
						...
						<div class="col-sm-10">
							<button onclick="addFile(this);" class="btn btn-primary"
								type="button">
	...
	<script type="text/javascript"
		src="view/javascript/ne/jquery/jquery.form.js"></script>
	<script type="text/javascript"><!--
