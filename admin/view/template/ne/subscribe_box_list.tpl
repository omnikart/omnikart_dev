    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-check-square-o"></i> <?php echo $text_subscribe_boxes; ?></h3>
            </div>
                                ...
                                <?php if ($subscribe_boxes) { ?>
                                    <?php foreach ($subscribe_boxes as $subscribe_box) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $edit . $subscribe_box['subscribe_box_id']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
