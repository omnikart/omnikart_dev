        ...
        <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-users"></i> <?php echo $text_subscribers; ?></h3>
			</div>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<select name="filter_newsletter" id="input-newsletter"
									class="form-control">
									<option value=""></option>
							...
							<tr>
								...
								<td class="text-right">
                                    <?php if ($sort == 'customer_group') { ?>
                                        <a
									href="<?php echo $sort_customer_group; ?>"
									class="<?php echo strtolower($order); ?>"><?php echo $column_customer_group; ?></a>
                                    <?php } else { ?>
                                        <a
									href="<?php echo $sort_customer_group; ?>"><?php echo $column_customer_group; ?></a>
                                    <?php } ?>
                                </td>
								<td class="text-right">
                                    <?php if ($sort == 'c.newsletter') { ?>
                                        <a
									href="<?php echo $sort_newsletter; ?>"
									class="<?php echo strtolower($order); ?>"><?php echo $column_newsletter; ?></a>
                                    <?php } else { ?>
                                        <a
									href="<?php echo $sort_newsletter; ?>"><?php echo $column_newsletter; ?></a>
                                    <?php } ?>
                                </td>
								<td class="text-right">
                            ...
                            <?php if ($customers) { ?>
								...
								<td class="text-right">
                                            <?php if ($customer['newsletter']) { ?>
                                                <a
									href="<?php echo $unsubscribe . $customer['customer_id']; ?>"
									data-toggle="tooltip"
									title="<?php echo $button_unsubscribe; ?>"
									class="btn btn-danger"><i class="fa fa-minus"></i></a>
                                            <?php } else { ?>
                                                <a
									href="<?php echo $subscribe . $customer['customer_id']; ?>"
									data-toggle="tooltip" title="<?php echo $button_subscribe; ?>"
