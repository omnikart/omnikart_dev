    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <button onclick="$('#form').attr('action', '<?php echo $copy_default; ?>');$('#form').submit();return false;" data-toggle="tooltip" title="<?php echo $button_copy_default; ?>" class="btn btn-default"><i class="fa fa-clipboard"></i></button>
                <button onclick="$('#form').attr('action', '<?php echo $copy; ?>');$('#form').submit();return false;" data-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-default"><i class="fa fa-files-o"></i></button>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-users"></i> <?php echo $text_templates; ?></h3>
            </div>
                                ...
                                <?php if ($templates) { ?>
                                    <?php foreach ($templates as $template) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo $edit . $template['template_id']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
