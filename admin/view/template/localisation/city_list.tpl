	        ...
	        <div class="table-responsive">
                <table class="table table-bordered table-hover">
	              <thead>
	                <tr>
	                  ...
	                  <td class="text-left"><?php if ($sort == 'z.name') { ?>
	                    <a href="<?php echo $sort_zone; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_iso_code_2; ?></a>
	                    <?php } else { ?>
	                    <a href="<?php echo $sort_zone; ?>"><?php echo $column_zone; ?></a>
	                    <?php } ?></td>
	                  <td class="text-left"><?php if ($sort == 'ct.name') { ?>
	                    <a href="<?php echo $sort_country; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_iso_code_3; ?></a>
	                    <?php } else { ?>
	                    <a href="<?php echo $sort_country; ?>"><?php echo $column_country; ?></a>
	                    <?php } ?></td>
	                  <td class="text-right"><?php echo $column_initial_postcode; ?></td>
	                  <td class="text-right"><?php echo $column_final_postcode; ?></td>
	              ...
	              <tbody>
	                ...
	                <tr>
	                  <td style="text-align: center;"><?php if (in_array($city['city_id'], $selected)) { ?>
		              ...
		              <td class="left"><?php echo $city['initial_postcode']; ?></td>
		              <td class="left"><?php echo $city['final_postcode']; ?></td>
	                  <td class="text-right"><a href="<?php echo $city['edit']; ?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
	                </tr>
	                <?php } ?>
	                <?php } else { ?>
	                <tr>
