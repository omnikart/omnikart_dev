	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-tax-class" data-toggle="tooltip"
			...
			<div class="panel-body">
              ...
              <tr id="tax-rule-row<?php echo $tax_rule_row; ?>">
								<td class="text-left"><select
									name="tax_rule[<?php echo $tax_rule_row; ?>][tax_rate_id]"
									class="form-control">
                    ...
                    <?php } else { ?>
                    <option
											value="<?php echo $tax_rate['tax_rate_id']; ?>"><?php echo $tax_rate['name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select></td>
								<td class="text-left"><select
									name="tax_rule[<?php echo $tax_rule_row; ?>][based]"
									class="form-control" id="tax-address">
										<option value="shipping"
											<?php  echo (($tax_rule['based']=='shipping')?'selected="selected"':''); ?>><?php echo $text_shipping; ?></option>
										<option value="payment"
											<?php  echo (($tax_rule['based']=='payment')?'selected="selected"':''); ?>><?php echo $text_payment; ?></option>
										<option value="store"
											<?php  echo (($tax_rule['based']=='store')?'selected="selected"':''); ?>><?php echo $text_store; ?></option>
										<option value="sanesa"
											<?php  echo (($tax_rule['based']=='sanesa')?'selected="selected"':''); ?>>Shipping
											and Seller Addresses</option>
										<option value="seller"
											<?php  echo (($tax_rule['based']=='seller')?'selected="selected"':''); ?>>Seller
											Addresses</option>
										<option value="saesa"
											<?php  echo (($tax_rule['based']=='saesa')?'selected="selected"':''); ?>>Shipping
											and Seller Addresses Same</option>
								</select></td>
								...
								<td class="text-left"><button type="button"
										onclick="$('#tax-rule-row<?php echo $tax_rule_row; ?>').remove();"
              ...
              <?php } ?>
						...
						<tfoot>
							<tr>
								<td colspan="3"></td>
								<td class="text-left"><button type="button" onclick="addRule();"
										data-toggle="tooltip" title="<?php echo $button_rule_add; ?>"
