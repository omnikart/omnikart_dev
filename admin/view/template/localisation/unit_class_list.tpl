    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $delete; ?>" method="post"
					enctype="multipart/form-data" id="form-unit-class">
                ...
                <tr>
									<td class="text-center"><?php if (in_array($unit_class['unit_class_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]"
										value="<?php echo $unit_class['unit_class_id']; ?>"
										checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]"
										value="<?php echo $unit_class['unit_class_id']; ?>" />
