  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        	...
        	<button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-postcode').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="well">
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_code" value="<?php echo $filter_code; ?>" placeholder="Code" id="input-code" class="form-control" />
              </div>
              <div class="form-group">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select name="filter_status" id="input-status" class="form-control">
                  <option value="*"></option>
                  <option value="1" <?php echo (($filter_status)?'selected="selected"':'');  ?>>Enabled</option>
                  <option value="0" <?php echo ((!$filter_status && !is_null($filter_status))?'selected="selected"':'');  ?> >Disabled</option>
                </select>
              </div>
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-postcode">
        	<div class="well">
        		<div class="row">
	        		<div class="col-sm-4">
					...
					<div class="col-sm-4">
						<button type="submit" class="btn btn-default pull-right" form="form-postcode" formaction="<?php echo $update; ?>" id="update" formmethod="post">Action</button>
					</div>
		      	</div>
	       	</div>
                ...
                <table class="table table-bordered table-hover">
	              <thead>
	                <tr>
	                  ...
	                  <td class="text-left">
	                    <a href="<?php echo $sort_postcode; ?>" class="<?php echo (($sort == 'p.postcode')?strtolower($order):''); ?>"><?php echo $column_name; ?></a>
	                  </td>
	                  <td class="text-left">
	                    <a href="<?php echo $sort_city; ?>" class="<?php echo (($sort == 'c.name')?strtolower($order):''); ?>"><?php echo $column_city; ?></a>
	                  </td>
	                  <td class="text-left">
	                    <a href="<?php echo $sort_zone; ?>" class="<?php echo (($sort == 'z.name')?strtolower($order):''); ?>"><?php echo $column_zone; ?></a>
	                  </td>
	                  <td class="text-left">
	                    <a href="<?php echo $sort_country; ?>" class="<?php echo (($sort == 'ct.name')?strtolower($order):''); ?>"><?php echo $column_country; ?></a>
	                  </td>
		             ...
		             if ($postcodes) { ?>
		                ...
		                <tr>
		                  <td style="text-align: center;">
		                    <input type="checkbox" name="selected[]" value="<?php echo $postcode['postcode_id']; ?>" <?php echo (in_array($postcode['postcode_id'], $selected)?'checked="checked"':''); ?> />
		                  </td>
