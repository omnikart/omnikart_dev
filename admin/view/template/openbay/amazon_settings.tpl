...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="settings-form" data-toggle="tooltip"
	...
	<div class="container-fluid">
		<form action="" method="post" enctype="multipart/form-data"
			id="settings-form" class="form-horizontal">
			...
			<div class="tab-content">
				<div class="tab-pane active" id="tab-settings">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="openbay_amazon_status" id="amazon-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="openbay_amazon_token"
								value="<?php echo $openbay_amazon_token; ?>"
								placeholder="<?php echo $entry_token; ?>" id="entry-token"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="openbay_amazon_enc_string1"
								...
								placeholder="<?php echo $entry_string1; ?>" id="entry-string1"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="openbay_amazon_enc_string2"
								...
								placeholder="<?php echo $entry_string2; ?>" id="entry-string2"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
              ...
              <?php if (!$API_status) { ?>
              <h4>
								<span class="label label-danger"><i class="fa fa-minus-square"></i> <?php echo $text_api_error; ?></span>
							</h4>
              <?php } else if (!$API_auth) { ?>
              <h4>
								<span class="label label-danger"><i class="fa fa-minus-square"></i> <?php echo $text_api_auth_error; ?></span>
							</h4>
              <?php } else { ?>
              <h4>
								<span class="label label-success"><i
									class="fa fa-check-square-o"></i> <?php echo $text_api_ok; ?></span>
							</h4>
              <?php } ?>
            </div>
					</div>
				...
				<div class="tab-pane" id="tab-product">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="entry-tax-percentage"><span
							data-toggle="tooltip" data-container="#tab-product"
						...
						<div class="col-sm-10">
							<div class="input-group col-xs-2">
								<input type="text" name="openbay_amazon_listing_tax_added"
									...
									placeholder="<?php echo $entry_tax_percentage; ?>"
									id="entry-tax-percentage" class="form-control" /> <span
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="openbay_amazon_listing_default_condition"
								id="entry-default-condition" class="form-control">
								<option></option>
            ...
            <div class="form-group">
							...
							<div class="col-sm-10">
								<select name="openbay_amazon_order_status_<?php echo $key ?>"
									class="form-control">
            ...
            <?php } ?>
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="entry-import-tax"><span
							...
							<div class="col-sm-10">
								<div class="input-group col-xs-2">
									<input type="text" name="openbay_amazon_order_tax"
										value="<?php echo $openbay_amazon_order_tax;?>"
										id="entry-import-tax" class="form-control"
										placeholder="<?php echo $entry_import_tax; ?>" /> <span
										class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="entry-customer-group"><span
								data-toggle="tooltip" data-container="#tab-orders"
								title="<?php echo $help_customer_group; ?>"><?php echo $entry_customer_group; ?></span></label>
							<div class="col-sm-10">
								<select name="openbay_amazon_order_customer_group"
									id="entry-customer-group" class="form-control">
                  ...
                  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="openbay_amazon_notify_admin"
									id="entry-notify-admin" class="form-control">
                  ...
                  <?php } ?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"
								for="entry-default-shipping"><span data-toggle="tooltip"
								data-container="#tab-orders"
								title="<?php echo $help_default_shipping; ?>"><?php echo $entry_default_shipping; ?></span></label>
							<div class="col-sm-10">
								<select name="openbay_amazon_default_carrier"
									id="entry-default-shipping" class="form-control">
