    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
                  ...
                  <?php } ?>
                </select> <span class="help-block"><?php echo $text_template_choose_help; ?></span>
								</div>
							</div>
						</div>
						<div class="tab-pane" id="tab-gallery">
										...
										<div class="col-sm-3">
											<div class="input-group">
												...
												<input type="text" name="data[ebay_gallery_height]"
													...
													maxlength="4" class="form-control" /> <span
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-3">
											<div class="input-group">
												<span class="input-group-addon">Width</span> <input
													type="text" name="data[ebay_thumb_height]"
										...
										<div class="col-sm-3">
											<div class="input-group">
												<span class="input-group-addon">Height</span> <input
													type="text" name="data[ebay_thumb_width]"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" name="data[ebay_supersize]" value="0" /> <input
										type="checkbox" name="data[ebay_supersize]" value="1"
										<?php if (isset($data['ebay_supersize']) && $data['ebay_supersize'] == 1){ echo 'checked="checked"'; } ?> />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="checkbox" name="data[ebay_gallery_plus]" value="1"
										<?php if (isset($data['ebay_gallery_plus']) && $data['ebay_gallery_plus'] == 1){ echo 'checked="checked"'; } ?> />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><?php echo $text_image_all_ebay; ?></label>
								<div class="col-sm-10">
									<input type="hidden" name="data[ebay_img_ebay]" value="0" /> <input
										type="checkbox" name="data[ebay_img_ebay]" value="1"
										<?php if (isset($data['ebay_img_ebay']) && $data['ebay_img_ebay'] == 1){ echo 'checked="checked"'; } ?> />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="checkbox" name="data[ebay_img_template]" value="1"
										<?php if (isset($data['ebay_img_template']) && $data['ebay_img_template'] == 1){ echo 'checked="checked"'; } ?> />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="checkbox" name="data[default_img_exclude]"
										value="1"
										<?php if (isset($data['default_img_exclude']) && $data['default_img_exclude'] == 1){ echo 'checked="checked"'; } ?> />
