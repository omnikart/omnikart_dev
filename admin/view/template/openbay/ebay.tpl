...
<div id="content">
    ...
    <div class="row">
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_settings; ?>" id="settings-link"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
      ...
      <div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_sync; ?>"> <span class="fa-stack fa-3x">
							<i class="fa fa-square-o fa-stack-2x"></i> <i
							class="fa fa-cog fa-stack-1x"></i>
					</span>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_subscribe; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_usage; ?>"> <span class="fa-stack fa-3x">
							<i class="fa fa-square-o fa-stack-2x"></i> <i
							class="fa fa-bar-chart-o fa-stack-1x"></i>
					</span>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_itemlink; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_itemimport; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_orderimport; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_summary; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_profile; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $links_template; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
      ...
      <div class="col-md-3 text-center">
				<div class="well">
					<a href="https://account.openbaypro.com/ebay/apiRegister/"
						target="_BLANK"> <span class="fa-stack fa-3x"> <i
