		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-list"></i> <?php echo $text_summary; ?></h3>
			</div>
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div id="selling-limits" class="alert alert-warning"
				...
				<div class="row">
					<div class="col-md-6">
						<div class="panel panel-default dsr-table">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-bar-chart-o fa-lg"></i> <?php echo $text_report_30; ?></h3>
							</div>
							<div class="panel-body">
					...
					<div class="col-md-6">
						<div class="panel panel-default dsr-table">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="fa fa-bar-chart-o fa-lg"></i> <?php echo $text_report_52; ?></h3>
							</div>
							<div class="panel-body">
				...
				<div class="well">
					<div class="row">
						<div class="col-sm-12 text-right">
							<a class="btn btn-primary" id="load-usage"><i
								class="fa fa-cog fa-lg fa-spin"></i></a>
						</div>
					</div>
				</div>
			</div>
