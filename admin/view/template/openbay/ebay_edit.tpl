		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-pencil"></i> <?php echo $text_listing_info; ?></h3>
			</div>
			<div class="panel-body">
				<div class="alert alert-info" id="form-loading">
					<i class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_loading; ?> </div>
				<div class="alert alert-danger" id="form-error"
					style="display: none;">
					<div class="row">
						<div class="col-sm-8"><?php echo $text_error_loading; ?></div>
						<div class="col-sm-4 text-right">
							<a id="button-load" class="btn btn-primary"><i
								class="fa fa-refresh"></i> <?php echo $button_retry; ?></a>
						</div>
					</div>
				</div>
				<div class="content displayNone" id="form-main">
					...
					<form method="post" enctype="multipart/form-data" id="form"
						...
						<div class="form-group stdMatrix">
							...
							<input type="hidden" name="qty_ebay" value="0" id="qty_ebay" /> <input
								type="hidden" name="variant" value="0" /> <label
								class="col-sm-2 control-label" for="price"><?php echo $entry_price; ?></label>
							<div class="col-sm-2">
						...
						<div class="form-group stdMatrix">
							...
							<div class="col-sm-2">
								<input type="text" name="qty_instock" id="qty-instock"
									class="form-control" disabled="disabled" /> <span
									class="help-block"><?php echo $help_stock_store; ?></span>
							</div>
						</div>
						<div class="form-group stdMatrix">
							<label class="col-sm-2 control-label" for="qty-listed"><?php echo $entry_stock_listed; ?></label>
							<div class="col-sm-2">
								<input type="text" name="qty_listed" id="qty-listed"
									class="form-control" disabled="disabled" /> <span
									class="help-block"><?php echo $help_stock_listed; ?></span>
							</div>
						</div>
						<div class="form-group stdMatrix">
							...
							<div class="col-sm-2">
								<input type="text" name="qty_reserve" value="0" id="qty-reserve"
									class="form-control" onkeyup="updateReserveMessage();" /> <span
									class="help-block"><?php echo $help_stock_reserve; ?></span>
							</div>
						</div>
							...
							<div class="col-sm-10">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody id="matrix-active">
										...
										<input type="hidden" name="optGroupArray" value=""
											id="option-groups" />
						...
						<div class="form-group" id="variantMatrixInactive"
							style="display: none;">
					...
					<div class="well">
						<div class="row">
							<div class="col-sm-12 text-right">
								...
								<a class="btn btn-primary" href="<?php echo $view_link; ?>"
									target="_BLANK" data-toggle="tooltip"
									title="<?php echo $button_view; ?>"><i
									class="fa fa-external-link"></i></a> <a class="btn btn-primary"
									id="button-edit-item" data-toggle="tooltip"
									title="<?php echo $button_edit; ?>" style="display: none;"><i
									class="fa fa-pencil"></i></a> <a class="btn btn-primary"
									id="button-save" data-toggle="tooltip"
