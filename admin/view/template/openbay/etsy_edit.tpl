	...
	<div class="container-fluid">
		<div class="panel panel-default">
          ...
          <form action="<?php echo $action; ?>" method="post"
						...
						<input type="hidden" name="etsy_item_id"
							value="<?php echo $etsy_item_id; ?>" /> <input type="hidden"
								...
								<div class="form-group required">
									...
									<div class="col-sm-10">
										<textarea name="description"
											...
											id="input-description" class="form-control"><?php echo $listing['description']; ?></textarea>
									</div>
								</div>
								<div class="form-group required">
                      ...
                      <option value="<?php echo $value; ?>"
												<?php echo ($listing['state'] == $value) ? ' selected' : ''; ?>><?php echo $value; ?></option>
                      <?php } ?>
                    </select>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-12 text-right">
										<a data-toggle="tooltip" title="<?php echo $button_save; ?>"
											class="btn btn-primary" id="button-save"><i
