	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-etsy-settings"
    ...
    <?php if ($account_info != false) { ?>
      <?php if ($account_info['header_code'] == 200) { ?>
        <div class="alert alert-success">
			<i class="fa fa-check"></i> <?php echo $text_account_ok; ?></div>
      <?php } else { ?>
        <div class="alert alert-danger">
			<i class="fa fa-exclamation-circle"></i> <?php echo $error_account_info; ?> (<?php echo $account_info['header_code']; ?>)</div>
      <?php } ?>
    <?php } ?>
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-etsy-settings"
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="etsy_status" id="etsy_status"
                ...
                <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="etsy_token"
										value="<?php echo $etsy_token; ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="etsy_enc1"
										value="<?php echo $etsy_enc1; ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="etsy_enc2"
										value="<?php echo $etsy_enc2; ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<p>
										<a href="https://account.openbaypro.com/etsy/apiRegister/"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<textarea name="etsy_address_format" class="form-control"
										rows="3" id="etsy_address_format"><?php echo $etsy_address_format; ?></textarea>
								</div>
							</div>
							<div class="form-group">
                ...
                <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="etsy_order_status_paid"
										id="etsy_order_status_paid" class="form-control">
                ...
                <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="etsy_order_status_shipped"
										id="etsy_order_status_shipped" class="form-control">
                ...
                <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="button-import"><span
									data-toggle="tooltip" data-container="#tab-general"
									title="<?php echo $help_pull_orders; ?>"><?php echo $text_pull_orders; ?></span></label>
								<div class="col-sm-10">
									<a class="btn btn-primary" id="button-import"><i
										class="fa fa-refresh"></i></a>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="button-settings"><span
									data-toggle="tooltip" data-container="#tab-general"
									title="<?php echo $help_sync_settings; ?>"><?php echo $text_sync_settings; ?></span></label>
								<div class="col-sm-10">
									<a class="btn btn-primary" id="button-settings"><i
										class="fa fa-refresh"></i></a>
								</div>
							</div>
						</div>
