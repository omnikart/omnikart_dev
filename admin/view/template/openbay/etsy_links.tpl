...
<div id="content">
	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-plus fa-lg"></i> <?php echo $text_new_link; ?></h3>
			</div>
			<div class="panel-body">
				<div class="alert alert-success" id="alert-link-save"
					style="display: none;">
					<i class="fa fa-check fa-lg" style="color: green"></i> <?php echo $text_link_saved; ?></div>
				<div class="alert alert-danger" id="alert-link-error"
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-link fa-lg"></i> <?php echo $text_current_links; ?></h3>
			</div>
			<div class="panel-body">
              ...
              <?php foreach ($items as $id => $item) { ?>
                <tr id="row-<?php echo $item['etsy_listing_id']; ?>">
								<td class="text-left"><a
									href="<?php echo $item['link_edit']; ?>" target="_BLANK"><?php echo $item['name']; ?></a></td>
								<td class="text-center"><a
									href="<?php echo $item['link_etsy']; ?>" target="_BLANK"><?php echo $item['etsy_item_id']; ?></a></td>
                    ...
                    <?php } ?></td>
								<td class="text-center"><button class="btn btn-danger"
										...
										onclick="deleteLink('<?php echo $item['etsy_listing_id']; ?>')">
