					...
					<div class="row">
						<div class="col-sm-12">
							<form action="<?php echo $add; ?>" method="post"
								id="add-profile-form" class="form-inline pull-right" role="form">
