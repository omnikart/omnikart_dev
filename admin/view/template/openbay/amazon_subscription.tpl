...
<div id="content">
    ...
    <div class="row">
			...
			<p>
				<a href="<?php echo $link_register; ?>" class="btn btn-primary"
					target="_blank"><?php echo $button_register ?></a>
			</p>
		</div>
    <?php } else { ?>
    <div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h1 class="panel-title">
							<i class="fa fa-user"></i> <?php echo $text_current_plan; ?></h1>
					</div>
							...
							<tbody>
								<tr>
									...
									<td class="text-left"><?php echo $user_plan['merchant_id'] ?> [ <a
										href="<?php echo $link_change_seller; ?>" target="_blank"><?php echo $text_change_merchantid; ?></a>
										]</td>
								</tr>
								<tr>
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h1 class="panel-title">
							<i class="fa fa-list"></i> <?php echo $text_available_plans; ?></h1>
					</div>
					<div class="panel-body">
						<table class="table table-bordered table-hover">
							<thead>
            ...
            <div class="pull-right">
							<a href="<?php echo $link_change_plan; ?>"
