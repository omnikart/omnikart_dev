	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<a href="<?php echo $link_overview; ?>" data-toggle="tooltip"
    ...
    <div class="well">
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						...
						<select id="filter-marketplace" name="filter_marketplace"
							class="form-control">
			...
			<div class="row">
				<div class="col-sm-12 text-right">
					<a class="btn btn-primary" id="button-filter"><i
						class="fa fa-filter"></i> <?php echo $button_filter; ?></a> <a
						class="btn btn-primary" id="button-search"><i class="fa fa-search"></i> <?php echo $button_search; ?></a>
				</div>
			</div>
		</div>
		<form id="bulk-list-form" class="form-horizontal">
          ...
          <tr>
						<td class="text-center"><input class="amazon-listing"
              ...
              <input class="amazon-listing" type="radio"
              ...
              <?php if (!$checked) { ?>
              <input class="amazon-listing" checked="checked"
							type="radio"
          ...
          <?php } ?>
			...
			<div class="well">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							<div class="input-group date">
								<input type="text" class="form-control" id="input-start"
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="pull-right">
							<a class="btn btn-primary" id="button-list"><i
								class="fa fa-plus-circle"></i> <?php echo $button_list; ?></a>
						</div>
					</div>
				</div>
			</div>
