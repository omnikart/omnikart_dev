...
<div id="content">
    ...
    <div class="row">
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_settings; ?>"> <span
      ...
      <div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_subscription; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_item_link; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_bulk_linking; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_bulk_listing; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_stock_updates; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
			...
			<div class="col-md-3 text-center">
				<div class="well">
					<a href="<?php echo $link_saved_listings; ?>"> <span
						class="fa-stack fa-3x"> <i class="fa fa-square-o fa-stack-2x"></i>
      ...
      <div class="col-md-3 text-center">
				<div class="well">
					<a href="https://account.openbaypro.com/amazonus/apiRegister/"
