		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-list"></i> <?php echo $text_subscription; ?></h3>
			</div>
				...
				<div class="row">
						...
						<div class="panel panel-default" id="my-plan-container">
							<div class="panel-heading">
								<h1 class="panel-title">
									<i class="fa fa-user fa-lg"></i> <?php echo $text_subscription_current; ?></h1>
							</div>
							<div class="panel-body">
					...
					<div class="col-md-8">
						...
						<div class="panel panel-default" id="openbay-plans-container">
							<div class="panel-heading">
								<h1 class="panel-title">
									<i class="fa fa-list fa-lg"></i> <?php echo $text_subscription_avail; ?></h1>
							</div>
							<div class="panel-body">
