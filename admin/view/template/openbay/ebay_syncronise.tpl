		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-list"></i> <?php echo $text_sync; ?></h3>
			</div>
          ...
          <p><?php echo $text_sync_desc; ?></p>
				<form id="form-ebay-sync" class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="update-categories"><span
							data-toggle="tooltip"
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="update-store"><span
							data-toggle="tooltip" title="<?php echo $help_sync_shop; ?>"><?php echo $entry_sync_shop; ?></span></label>
						<div class="col-sm-10">
							<a class="btn btn-primary" id="update-store"><?php echo $button_update; ?></a>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="update-settings"><span
							data-toggle="tooltip" title="<?php echo $help_sync_setting; ?>"><?php echo $entry_sync_setting; ?></span></label>
						<div class="col-sm-10">
