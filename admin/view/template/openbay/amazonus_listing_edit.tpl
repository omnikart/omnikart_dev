...
<div id="content">
	<div class="page-header">
        ...
        <a href="<?php echo $url_create_new; ?>" data-toggle="tooltip"
					title="<?php echo $button_create_new_listing; ?>"
        ...
        <a href="<?php echo $url_delete_links; ?>" data-toggle="tooltip"
					title="<?php echo $button_remove_links; ?>" class="btn btn-danger"><i
    ...
    <div class="well">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-right">
						<a onclick="location = '<?php echo $url_saved_listings; ?>'"
							class="btn btn-primary"><?php echo $button_saved_listings; ?></a>
					</div>
				</div>
			</div>
		</div>
