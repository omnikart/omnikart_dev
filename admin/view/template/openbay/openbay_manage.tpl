...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-openbay" data-toggle="tooltip"
	...
	<div class="container-fluid">
		<form action="<?php echo $action; ?>" method="post"
			enctype="multipart/form-data" id="form-openbay"
            ...
            <?php echo $text_version_installed; ?><span
					...
					<input type="hidden" name="openbay_version"
						value="<?php echo $openbay_version; ?>" /> <input type="hidden"
						name="openbay_menu" value="<?php echo $openbay_menu; ?>" />
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-update-v2">
							...
							<div class="well">
								<div class="alert alert-danger" id="update-error"
									style="display: none;"></div>
								<div id="update-v2-box">
									<div class="form-group">
										<label class="col-sm-3 control-label" for="update-v2-beta"><span
											data-toggle="tooltip" title="<?php echo $help_ftp_beta; ?>"><?php echo $entry_ftp_beta; ?></span></label>
										<div class="col-sm-8">
						...
						<div class="tab-pane" id="tab-update-v1">
							...
							<div class="well">
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-username"><span
										data-toggle="tooltip"
										title="<?php echo $help_ftp_username; ?>"><?php echo $entry_ftp_username; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="openbay_ftp_username"
											value="<?php echo $openbay_ftp_username; ?>"
											placeholder="<?php echo $entry_ftp_username; ?>"
											id="ftp-username" class="form-control ftp-setting" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-password"><span
										data-toggle="tooltip"
										title="<?php echo $help_ftp_password; ?>"><?php echo $entry_ftp_password; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="openbay_ftp_pw"
											value="<?php echo $openbay_ftp_pw;?>"
											placeholder="<?php echo $entry_ftp_password; ?>"
											id="ftp-password" class="form-control ftp-setting" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-server"><span
										data-toggle="tooltip" title="<?php echo $help_ftp_server; ?>"><?php echo $entry_ftp_server; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="openbay_ftp_server"
											value="<?php echo $openbay_ftp_server;?>"
											placeholder="<?php echo $entry_ftp_server; ?>"
											id="ftp-server" class="form-control ftp-setting" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-root"><span
										data-toggle="tooltip" title="<?php echo $help_ftp_root; ?>"><?php echo $entry_ftp_root; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="openbay_ftp_rootpath"
											value="<?php echo $openbay_ftp_rootpath;?>"
											placeholder="<?php echo $entry_ftp_root; ?>" id="ftp-root"
											class="form-control ftp-setting" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="admin-directory"><span
										data-toggle="tooltip" title="<?php echo $help_ftp_admin; ?>"><?php echo $entry_ftp_admin; ?></span></label>
									<div class="col-sm-8">
										<input type="text" name="openbay_admin_directory"
											value="<?php echo $openbay_admin_directory;?>"
											placeholder="<?php echo $entry_ftp_admin; ?>"
											id="admin-directory" class="form-control ftp-setting" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-pasv"><span
										data-toggle="tooltip" title="<?php echo $help_ftp_pasv; ?>"><?php echo $entry_ftp_pasv; ?></span></label>
									<div class="col-sm-8">
										<select name="openbay_ftp_pasv" id="ftp-pasv"
											class="form-control ftp-setting">
                      ...
                      <?php } ?>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="ftp-beta"><span
										data-toggle="tooltip" title="<?php echo $help_ftp_beta; ?>"><?php echo $entry_ftp_beta; ?></span></label>
									<div class="col-sm-8">
										<select name="openbay_ftp_beta" id="ftp-beta"
											class="form-control ftp-setting">
                      ...
                      <?php } ?>
								...
								<div class="form-group" id="ftp-test-row">
									...
									<div class="col-sm-8">
										...
										<div class="btn btn-primary" style="display: none;"
											id="ftp-test-loading">
						...
						<div class="tab-pane" id="tab-update-patch">
							...
							<div class="well">
								<div class="form-group">
									<label class="col-sm-3 control-label" for="button-patch"><span
										data-toggle="tooltip" title="<?php echo $help_patch; ?>"><?php echo $entry_patch; ?></span></label>
									<div class="col-sm-8">
				...
				<div class="tab-pane" id="tab-setting">
					<div class="well">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="openbay_language" id="input-language"
									class="form-control">
                  <?php foreach ($languages as $key => $language) { ?>
                    <option value="<?php echo $key; ?>"
										<?php if ($key == $openbay_language) { echo'selected="selected"'; } ?>><?php echo $language; ?></option>
                  <?php } ?>
                </select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="button-clear-faq"><span
								data-toggle="tooltip" title="<?php echo $help_clear_faq; ?>"><?php echo $text_clear_faq; ?></span></label>
							<div class="col-sm-10">
				...
				<div class="tab-pane" id="tab-developer">
					<div class="well">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="button-clear-data"><span
								data-toggle="tooltip" title="<?php echo $help_empty_data; ?>"><?php echo $entry_empty_data; ?></span></label>
							<div class="col-sm-10">
