...
<div id="content">
	...
	<div class="container-fluid">
		<div class="well">
            ...
            <a id="upload_button" onclick="upload()"
							class="btn btn-primary"><i class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_upload; ?></a>
            <?php } ?>
          </div>
				</div>
			</div>
        ...
        <tr>
					...
					<td class="text-right"><a class="btn btn-primary"
						href="<?php echo $saved_product['edit_link']; ?>"
						data-toggle="tooltip"
						data-original-title="<?php echo $button_edit; ?>"><i
						...
						data-toggle="tooltip"
						data-original-title="<?php echo $button_remove; ?>"><i
