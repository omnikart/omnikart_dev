    ...
    <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-list"></i> <?php echo $text_listings; ?></h3>
			</div>
			<div class="panel-body">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" name="keywords"
									...
									id="input-keywords" class="form-control" /> <span
									class="help-block"><?php echo $help_keywords; ?></span>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select name="status" id="input-status" class="form-control">
									...
									<option value="inactive"
										<?php if ($filter['status'] == 'inactive') { echo ' selected'; } ?>>Inactive</option>
									<option value="draft"
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="hidden" name="add_link_product_id" value=""
									id="input-product-id" /> <input type="text"
									name="add_link_product" value=""
						...
						<div class="col-sm-6">
							...
							<a onclick="addLink();" class="btn btn-primary pull-right"
								id="button-submit-link"><i class="fa fa-check"></i> <?php echo $button_save; ?></a>
						</div>
					</div>
				</div>
              ...
              <tr>
                ...
                <td class="text-center"><i class="fa fa-minus"></i></td>
								<td class="text-center"><i class="fa fa-times"
                ...
                <?php } ?>
                  ...
                  <button data-toggle="tooltip"
										title="<?php echo $text_activate; ?>" class="btn btn-primary"
										onclick="activateListing('<?php echo $listing['listing']['listing_id']; ?>');"
										id="btn-activate-<?php echo $listing['listing']['listing_id']; ?>">
										<i class="fa fa-plus"></i>
									</button>
                  <?php } ?>
                  <?php if (in_array('add_link', $listing['actions'])) { ?>
                  <button data-toggle="tooltip"
										title="<?php echo $text_add_link; ?>" class="btn btn-primary"
										onclick="showLinkOption('<?php echo $listing['listing']['listing_id']; ?>');">
										<i class="fa fa-link"></i>
									</button>
                  <?php } ?>
                  <?php if (in_array('delete_link', $listing['actions'])) { ?>
                  <button data-toggle="tooltip"
										title="<?php echo $text_delete_link; ?>"
										class="btn btn-danger"
										id="btn-delete-<?php echo $listing['link']['etsy_listing_id']; ?>"
										onclick="deleteLink('<?php echo $listing['link']['etsy_listing_id']; ?>');">
										<i class="fa fa-unlink"></i>
									</button>
                  <?php } ?>
                  <?php if (in_array('end_item', $listing['actions'])) { ?>
                  <button data-toggle="tooltip"
										title="<?php echo $text_delete; ?>" class="btn btn-danger"
										onclick="endListing('<?php echo $listing['listing']['listing_id']; ?>');"
										id="btn-end-<?php echo $listing['link']['etsy_listing_id']; ?>">
										<i class="fa fa-times"></i>
									</button>
									<button data-toggle="tooltip"
										title="<?php echo $text_deactivate; ?>" class="btn btn-danger"
										onclick="deactivateListing('<?php echo $listing['listing']['listing_id']; ?>');"
										id="btn-deactivate-<?php echo $listing['listing']['listing_id']; ?>">
										<i class="fa fa-ban"></i>
									</button>
                  <?php } ?></td>
							</tr>
