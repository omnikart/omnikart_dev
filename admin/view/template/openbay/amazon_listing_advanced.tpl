...
<div id="content">
	<div class="page-header">
        ...
        <a href="<?php echo $url_remove_errors; ?>"
					data-toggle="tooltip" title="<?php echo $button_remove_error; ?>"
					class="btn btn-danger"><i class="fa fa-reply"></i></a>
        <?php } ?>
        <a href="<?php echo $cancel_url; ?>" data-toggle="tooltip"
			...
			<div class="tab-content" id="tab-content">
				<div class="tab-pane active" id="page-main">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<p>
								<a href="<?php echo $listing_url; ?>"><?php echo $listing_name; ?>
              ...
              <label class="radio-inline">
                ...
                <input class="marketplace_ids"
								id="adv_marketplace_<?php echo $mp['code'] ?>"
								<?php if (in_array($mp['id'], $default_marketplaces)) { ?>
								checked="checked" <?php } ?> type="radio"
								name="marketplace_ids[]" value="<?php echo $mp['id']; ?>">
                <?php } else { ?>
                <input class="marketplace_ids"
								id="adv_marketplace_<?php echo $mp['code'] ?>"
								<?php if (in_array($mp['id'], $saved_marketplaces)) { ?>
								checked="checked" <?php } ?> type="radio"
								name="marketplace_ids[]" value="<?php echo $mp['id']; ?>">
                <?php } ?>
              ...
              <?php } ?>
                ...
                <option
									...
									value="<?php echo $category['template'] ?>"><?php echo $category['friendly_name'] ?></option>
                <?php } ?>
              </select>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12 text-right">
					<a class="btn btn-primary" data-toggle="tooltip"
						...
						class="fa fa-save fa-lg"></i></a> <a class="btn btn-primary"
						data-toggle="tooltip" title="<?php echo $button_save_upload ?>"
						onclick="save_and_upload()"><i class="fa fa-cloud-upload fa-lg"></i></a>
					<a class="btn btn-primary" data-toggle="tooltip"
