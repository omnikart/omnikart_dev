			...
			<div class="panel-body">
				<div class="well">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select name="filter_order_status_id" id="input-order-status"
									class="form-control">
									<option value="*"></option>
                  ...
                  <?php } ?>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select name="filter_channel" id="input-channel"
									class="form-control">
									<option value=""></option>
                  ...
                  <?php } ?>
						...
						<div class="col-sm-4">
							<button onclick="filter();" type="button" id="button-filter"
							...
							<thead>
								<tr>
									<th width="1"><input type="checkbox"
										onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></th>
