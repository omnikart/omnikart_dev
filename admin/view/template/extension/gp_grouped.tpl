	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-gp" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-gp" class="form-horizontal">
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-6<?php echo $error_image_thumb_width; ?>">
									<input type="text" name="gp_grouped_image_thumb_width"
										value="<?php echo $gp_grouped_image_thumb_width; ?>"
										placeholder="<?php echo $entry_width; ?>" class="form-control" />
								</div>
								<div class="col-sm-6<?php echo $error_image_thumb_height; ?>">
									<input type="text" name="gp_grouped_image_thumb_height"
										value="<?php echo $gp_grouped_image_thumb_height; ?>"
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-6<?php echo $error_image_popup_width; ?>">
									<input type="text" name="gp_grouped_image_popup_width"
										value="<?php echo $gp_grouped_image_popup_width; ?>"
										placeholder="<?php echo $entry_width; ?>" class="form-control" />
								</div>
								<div class="col-sm-6<?php echo $error_image_popup_height; ?>">
									<input type="text" name="gp_grouped_image_popup_height"
										value="<?php echo $gp_grouped_image_popup_height; ?>"
										placeholder="<?php echo $entry_height; ?>"
										class="form-control" />
								</div>
							</div>
						...
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-6<?php echo $error_image_added_width; ?>">
									<input type="text" name="gp_grouped_image_added_width"
										value="<?php echo $gp_grouped_image_added_width; ?>"
										placeholder="<?php echo $entry_width; ?>" class="form-control" />
								</div>
								<div class="col-sm-6<?php echo $error_image_added_height; ?>">
									<input type="text" name="gp_grouped_image_added_height"
										value="<?php echo $gp_grouped_image_added_height; ?>"
										placeholder="<?php echo $entry_height; ?>"
										class="form-control" />
								</div>
							</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for=""><span
							data-toggle="tooltip"
							title="<?php echo $help_image_child_size; ?>"><?php echo $entry_image_child_size; ?></span></label>
						<div class="col-sm-10">
							<div class="row">
								<div class="col-sm-6">
									<input type="text" name="gp_grouped_image_child_width"
										value="<?php echo $gp_grouped_image_child_width; ?>"
										placeholder="<?php echo $entry_width; ?>" class="form-control" />
								</div>
								<div class="col-sm-6">
									<input type="text" name="gp_grouped_image_child_height"
										value="<?php echo $gp_grouped_image_child_height; ?>"
										placeholder="<?php echo $entry_height; ?>"
										class="form-control" />
								</div>
							</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for=""><span
							data-toggle="tooltip"
							title="<?php echo $help_add_child_image; ?>"><?php echo $entry_add_child_image; ?></span></label>
						<div class="col-sm-10">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for=""><span
							data-toggle="tooltip"
							title="<?php echo $help_add_child_images; ?>"><?php echo $entry_add_child_images; ?></span></label>
						<div class="col-sm-10">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for=""><span
							data-toggle="tooltip"
							title="<?php echo $help_add_child_description; ?>"><?php echo $entry_add_child_description; ?></span></label>
						<div class="col-sm-10">
							<select name="gp_grouped_add_child_description"
								class="form-control">
              ...
              <label class="checkbox-inline">
                ...
                <input type="checkbox" name="gp_grouped_child_info[]"
								value="<?php echo $value; ?>" checked="checked" /> <?php echo $value; ?>
                <?php } else { ?>
                <input type="checkbox" name="gp_grouped_child_info[]"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for=""><span
							data-toggle="tooltip" title="<?php echo $help_child_nocart; ?>"><?php echo $entry_child_nocart; ?></span></label>
						<div class="col-sm-10">
