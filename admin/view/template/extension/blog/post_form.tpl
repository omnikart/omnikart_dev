			...
			<div class="panel-body">
				...
				<div id="main-content">
					...
					<div class="row">
						<div class="col-lg-12">
							<h1
								style="font-size: 21px; font-weight: 700; color: #20BFEF; border-bottom: 1px solid #F5F5F5; margin-bottom: 20px; padding: 10px 0 5px 0;"><?php echo $heading_title; ?></h1>
						</div>
					</div>

					<div id="post">
						<form action="<?php echo $action; ?>" method="post"
							enctype="multipart/form-data" id="form-postedit"
							class="form-horizontal">
							<div class="pull-right">
								<button type="submit" form="form-postedit" data-toggle="tooltip"
									title="" class="btn btn-primary"
									data-original-title="<?php echo $save_btn_tooltip; ?>">
									<i class="fa fa-save"></i>&nbsp;<?php echo $save_btn; ?></button>
								<a href="<?php echo $cancel; ?>" data-toggle="tooltip" title=""
									class="btn btn-default"
									data-original-title="<?php echo $cancel_btn_tooltip; ?>"><i
									class="fa fa-reply"></i>&nbsp;<?php echo $cancel_btn; ?></a>
							</div>
							...
							<ul style="margin-bottom: 10px;" class="nav nav-tabs">
								...
								<li><a href="#relation" aria-controls="relation"
									data-toggle="tab"><?php echo $tab_relation; ?></a></li>
                      ...
                      <div class="tab-pane"
											...
											<div class="table-responsive">
												<table class="table table-bordered">
													<tbody>
														<tr>
															<td width="15%" class="text-right required"><label
																for="input-title<?php echo $language['language_id']; ?>"
																class="control-label"><?php echo $entry_postTitle; ?></label></td>
															<td width="85%"><input type="text"
																name="post_description[<?php echo $language['language_id']; ?>][title]"
																value="<?php echo isset($post_description[$language['language_id']]['title']) ? $post_description[$language['language_id']]['title'] : ''; ?>"
                                    ...
                                    <?php } ?>
														...
														<tr>
															<td width="15%" class="text-right"><label
																for="post-content<?php echo $language['language_id']; ?>"
																class="control-label"><?php echo $entry_content; ?></label></td>
															<td width="85%"><textarea
																	name="post_description[<?php echo $language['language_id']; ?>][content]"
																	cols="30" rows="10" class="form-control content"
																	id="post-content<?php echo $language['language_id']; ?>"
																	class="form-control"><?php echo isset($post_description[$language['language_id']]['content']) ? $post_description[$language['language_id']]['content'] : ''; ?></textarea>
                                    ...
                                    <?php } ?>
														...
														<tr>
															<td width="15%" class="text-right"><label
																for="post-excerpt<?php echo $language['language_id']; ?>"
																class="control-label"><?php echo $entry_excerpt; ?></label></td>
															<td width="85%"><textarea
																	name="post_description[<?php echo $language['language_id']; ?>][excerpt]"
																	id="post-excerpt<?php echo $language['language_id']; ?>"
																	cols="30" rows="5" class="form-control excerpt"><?php echo isset($post_description[$language['language_id']]['excerpt']) ? $post_description[$language['language_id']]['excerpt'] : ''; ?></textarea>
                                    ...
                                    <?php } ?>
														...
														<tr>
															<td width="15%" class="text-right"><label
																for="input-content<?php echo $language['language_id']; ?>"
																class="control-label"><?php echo $entry_meta_desc; ?></label></td>
															<td width="85%"><textarea
																	name="post_description[<?php echo $language['language_id']; ?>][meta_description]"
																	id="meta-description<?php echo $language['language_id']; ?>"
																	cols="30" rows="5" class="form-control"><?php echo isset($post_description[$language['language_id']]['meta_description']) ? $post_description[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                    ...
                                    <?php } ?>
														...
														<tr>
															<td width="15%" class="text-right"><label
																for="input-content<?php echo $language['language_id']; ?>"
																class="control-label"><?php echo $entry_meta_key; ?></label></td>
															<td width="85%"><textarea
																	name="post_description[<?php echo $language['language_id']; ?>][meta_keyword]"
																	id="meta-keyword<?php echo $language['language_id']; ?>"
																	cols="30" rows="5" class="form-control"><?php echo isset($post_description[$language['language_id']]['meta_keyword']) ? $post_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                                    ...
                                    <?php } ?>
														...
														<tr>
															<td width="15%" class="text-right"><label
																for="input-tags<?php echo $language['language_id']; ?>"
																class="control-label"> <span data-toggle="tooltip"
																	title=""
																	data-original-title="<?php echo $help_tags; ?>"><?php echo $entry_tag; ?></span>
															</label></td>
															<td width="85%"><textarea
																	name="post_description[<?php echo $language['language_id']; ?>][tag]"
																	id="tags<?php echo $language['language_id']; ?>"
																	rows="3" class="form-control"><?php echo isset($post_description[$language['language_id']]['tag']) ? $post_description[$language['language_id']]['tag'] : ''; ?></textarea>
                    ...
                    <?php } // foreach loop; ?>
								...
								<div class="tab-pane table-responsive" id="data">
									<table class="table table-bordered">
										<tbody>
											<tr>
												<td width="15%" class="text-right"><label for="input-img"
													class="control-label"><?php echo $entry_thumb; ?></label></td>
												<td width="85%"><a href="" id="thumb-image"
											...
											<tr>
												<td width="15%" class="text-right"><label
													for="input-comment" class="control-label"><?php echo $entry_comment; ?></label></td>
												<td width="85%"><select class="form-control" name="comment"
													id="comment">
														<option value="open"
															<?php echo isset($post['comment_status']) && ($post['comment_status'] == 'open') ? 'selected="selected"' : null; ?>>Open</option>
														<option value="close"
															<?php echo isset($post['comment_status']) && ($post['comment_status'] == 'close') ? 'selected="selected"' : null; ?>>Close</option>
												</select>
                              ...
                              <?php } ?>
											...
											<tr>
												<td width="15%" class="text-right"><label
													for="input-keyword" class="control-label"> <span
														data-toggle="tooltip" title=""
														data-original-title="<?php echo $help_keyword; ?>"><?php echo $entry_keyword; ?></span></td>
												<td width="85%"><input type="text" name="keyword"
                              ...
                              <?php } ?>                
											...
											<tr>
												<td width="15%" class="text-right"><label
													for="input-date-available" class="control-label"><?php echo $entry_date_available; ?></label></td>
												<td width="85%">
											...
											<tr>
												<td width="15%" class="text-right"><label for="input-status"
													class="control-label"><?php echo $entry_status; ?></label></td>
												<td width="85%"><select class="form-control" name="status"
													id="status">
														<option value="publish"
															<?php echo ($status == 'publish') ? 'selected="selected"' : ''; ?>>Publish</option>
														<option value="unpublish"
															<?php echo ($status == 'unpublish') ? 'selected="selected"' : ''; ?>>Unpublish</option>
												</select></td>
											</tr>

											<tr>
												<td width="15%" class="text-right"><label
													for="input-sort-order" class="control-label"><?php echo $entry_sort_order; ?></label></td>
												<td width="85%"><input type="text" name="sort_order"
									...
									<div class="table-responsive">
										<table class="table table-bordered">
											<tbody>
												<tr>
													<td width="15%" class="text-right required"><label
														for="input-category" class="control-label"> <span
															data-toggle="tooltip" title=""
															data-original-title="<?php echo $help_autocomplete; ?>"><?php echo $entry_category; ?></span></td>
													<td width="85%"><input type="text" name="category" value=""
														placeholder="<?php echo $entry_category; ?>"
														id="input-category" class="form-control" />
														<div id="post-category" class="well well-sm"
															style="height: 150px; overflow: auto;">
                                 <?php if($post_categories) { ?>  
                                    <?php foreach ($post_categories as $category) { ?>
                                    <div
																id="post-category<?php echo $category['category_id']; ?>">
                                ...
                                <?php } ?>
												...
												<tr>
													<td width="15%" class="text-right"><label
														for="input-filter" class="control-label"> <span
															data-toggle="tooltip" title=""
															data-original-title="<?php echo $help_autocomplete; ?>"><?php echo $entry_filter; ?></span></td>
													<td width="85%"><input type="text" name="filter" value=""
														placeholder="<?php echo $entry_filter; ?>"
														id="input-filter" class="form-control" />
														<div id="post-filter" class="well well-sm"
															style="height: 150px; overflow: auto;">
                                  <?php foreach ($post_filters as $post_filter) { ?>
                                  <div
																id="post-filter<?php echo $post_filter['filter_id']; ?>">
																<i class="fa fa-minus-circle"></i> <?php echo $post_filter['name']; ?>
                                    <input type="hidden"
																	name="post_filter[]"
																	value="<?php echo $post_filter['filter_id']; ?>" />
															</div>
                                  <?php } ?>
                                </div></td>
												</tr>
												...
												<tr>
													<td width="15%" class="text-right"><label for="input-store"
														class="control-label"><?php echo $entry_store; ?></label></td>
													<td width="85%">
														<div id="post-store" class="well well-sm"
															style="height: 150px; overflow: auto;">
                                      ...
                                      <input type="checkbox"
																	name="post_store[]" value="0" checked="checked" />
                                      <?php echo $text_default; ?>
                                      <?php } else { ?>
                                      <input type="checkbox"
																	name="post_store[]" value="0" />
                                      <?php echo $text_default; ?>
                                      <?php } ?>
                                    </label>
															</div>
                                  ...
                                  <?php } ?>
												...
												<tr>
													<td width="15%" class="text-right"><label
														class="control-label" for="input-related"> <span
															data-toggle="tooltip" title=""
															data-original-title="<?php echo $help_autocomplete; ?>"><?php echo $entry_related; ?></span></td>
													<td width="85%"><input type="text" name="related" value=""
                                  ...
                                  <?php if(isset($related_products)){ ?>  
                                    <?php foreach ($related_products as $product) { ?>
                                      <div
																id="product-related<?php echo $product['product_id']; ?>">
                          ...
                          <tr id="image-row<?php echo $image_row; ?>">
													<td class="text-left"><a href=""
														...
														data-toggle="image" class="img-thumbnail"><img
															src="<?php echo $post_image['thumb']; ?>" alt="" title=""
															data-placeholder="<?php echo $placeholder; ?>" /></a><input
														type="hidden"
														name="post_image[<?php echo $image_row; ?>][meta_value]"
														value="<?php echo $post_image['image']; ?>"
														id="input-image<?php echo $image_row; ?>" /></td>
													<td class="text-right"><input type="text"
														name="post_image[<?php echo $image_row; ?>][sort_order]"
														value="<?php echo $post_image['sort_order']; ?>"
														placeholder="<?php echo $col_order; ?>"
											...
											<tfoot>
												<tr>
													...
													<td class="text-left"><button type="button"
															...
															title="<?php echo $image_add; ?>" class="btn btn-primary">
										...
										<table class="table table-bordered">
											...
											<tbody>
												<tr>
													...
													<td class="text-left" width="85%"><select
														name="post_layout[0]" class="form-control">
															<option value=""></option>
                          ...
                          <tr>
													...
													<td class="text-left"><select
														name="post_layout[<?php echo $store['store_id']; ?>]"
														class="form-control">
															<option value=""></option>
                                <?php foreach ($layouts as $layout) { ?>
