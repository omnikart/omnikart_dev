								...
								<div class="col-lg-4">
									<div class="pull-right">
										<button type="submit" form="form-setting"
											...
											<i class="fa fa-edit"></i>&nbsp;<?php echo $save_btn; ?></button>
									</div>
								</div>
							</div>
                    ...
                    <?php foreach ($languages as $language) { ?>
                      <div class="tab-pane"
												...
												<tbody>
													<tr>
														...
														<td width="85%"><input type="text"
															name="general_setting[<?php echo $language['language_id']; ?>][name]"
															value="<?php echo isset($general_setting[$language['language_id']]['name']) ? $general_setting[$language['language_id']]['name'] : ''; ?>"
                                ...
                                <?php } ?>
													...
													<tr>
														<td width="15%" class="text-right"><label
															...
															class="control-label"><?php echo $entry_title; ?></label></td>
														<td width="85%"><input type="text"
															name="general_setting[<?php echo $language['language_id']; ?>][title]"
															value="<?php echo isset($general_setting[$language['language_id']]['title']) ? $general_setting[$language['language_id']]['title'] : ''; ?>"
                                ...
                                <?php } ?>
													...
													<tr>
														<td width="15%" class="text-right"><label
															for="input-meta_description<?php echo $language['language_id']; ?>"
															class="control-label"><?php echo $entry_meta_desc; ?></label></td>
														<td width="85%"><textarea
																name="general_setting[<?php echo $language['language_id']; ?>][meta_description]"
																id="meta-description<?php echo $language['language_id']; ?>"
																cols="30" rows="5" class="form-control meta_description"><?php echo isset($general_setting[$language['language_id']]['meta_description']) ? $general_setting[$language['language_id']]['meta_description'] : ''; ?></textarea>
                                ...
                                <?php } ?>
													...
													<tr>
														<td width="15%" class="text-right"><label
															for="input-entry_meta_keyword<?php echo $language['language_id']; ?>"
															class="control-label"><?php echo $entry_meta_keyword; ?></label></td>
														<td width="85%"><textarea
																name="general_setting[<?php echo $language['language_id']; ?>][meta_keyword]"
																id="meta-keyword<?php echo $language['language_id']; ?>"
																cols="30" rows="5" class="form-control"><?php echo isset($general_setting[$language['language_id']]['meta_keyword']) ? $general_setting[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    ...
                    <?php } // foreach end; ?>
                        ...
                        <?php foreach ($setting_option as $setting) : ?>                        
                          <tr>
												...
												<td width="15%" class="text-right"><label
													form="form-control"><?php echo ucfirst(str_replace('_', ' ', $setting['setting_name'])); ?></label></td>
												<td width="83%">
                               <?php
																									switch ($setting ['setting_name']) {
																										case 'comment_autoapprove' :
																											?>
                                      <select
													name="setting[<?php echo $setting['setting_id']; ?>][name]"
													id="setting_name<?php echo $setting['setting_id']; ?>">
														<option
															<?php echo $setting['setting_value'] == 1 ? 'selected="selected"':''; ?>
															value="1">Yes</option>
														<option
															<?php echo $setting['setting_value'] == 0 ? 'selected="selected"':''; ?>
															value="0">No</option>
												</select>
                                    <?php
																											break;
                                    ...
                                    <input type="text"
													name="setting[<?php echo $setting['setting_id']; ?>][name]"
													id="setting_name<?php echo $setting['setting_id']; ?>"
													value="<?php echo isset($setting['setting_value']) && $setting['setting_value'] ? $setting['setting_value'] : ''; ?>"
													class="form-control">
                                  <?php
																											break;
																									}
												...
												<td><input type="text"
													name="setting[<?php echo $setting['setting_id']; ?>][position]"
													id="setting_position<?php echo $setting['setting_id']; ?>"
													value="<?php echo isset($setting['position']) && $setting['position'] ? $setting['position'] : ''; ?>"
                              ...
                              <?php
                                    ...
                                    <a href="" id="blog-logo"
													data-toggle="image" class="img-thumbnail"><img
														src="<?php echo $blog_logo; ?>" alt="" title="" /></a> <input
													type="hidden"
													name="setting[<?php echo $setting['setting_id']; ?>][name]"
													value="<?php echo $image_logo; ?>" id="blog_logo" />
                                  <?php
																											break;
																										case 'blog_icon' :
																											?>
                                    <a href="" id="blog-icon"
													data-toggle="image" class="img-thumbnail"><img
														src="<?php echo $blog_icon; ?>" alt="" title="" /></a> <input
													type="hidden"
													name="setting[<?php echo $setting['setting_id']; ?>][name]"
													value="<?php echo $image_icon; ?>" id="blog_icon" />
                                  <?php
																											break;
                                  ...
                                  <?php
                                    ...
                                    <select
													...
													id="setting_name<?php echo $setting['setting_id']; ?>">
														<option
															<?php echo $setting['setting_value'] == 'slide' ? 'selected="selected"':''; ?>
															value="slide">Slide</option>
														<option
															<?php echo $setting['setting_value'] == 'static' ? 'selected="selected"':''; ?>
                                  ...
                                  <?php
                                    ...
                                    <select
													...
													id="setting_name<?php echo $setting['setting_id']; ?>">
														<option
															<?php echo $setting['setting_value'] == 'left' ? 'selected="selected"':''; ?>
															value="left">Left</option>
														<option
															<?php echo $setting['setting_value'] == 'top' ? 'selected="selected"':''; ?>
															value="top">Top</option>
														<option
															<?php echo $setting['setting_value'] == 'right' ? 'selected="selected"':''; ?>
