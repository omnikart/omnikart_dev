    ...
    <div class="panel panel-default">
      <div class="panel-body">
          <ul style="margin-bottom:10px; background: #F5F5F5; padding: 3px 3px 0;" class="nav nav-tabs">
            ...
            <li class="active"><a href="<?php echo HTTP_SERVER; ?>index.php?route=extension/blog/help&amp;token=<?php echo $token; ?>"><?php echo $help_menu; ?></a></li>
          </ul>
        <section class="tab-content">
          ...
          <table class="table table-hover">
            ...
            <tr>
              <td class="text-center" colspan="2"><a target="_blink" href="website.com/demo" title="Demo Blog"><?php echo $demosite_text; ?></a></td>
            </tr>

            <tr>
              <td class="text-center" colspan="2"><a target="_blink" href="mysite.com/ob/documentation" title="Documentation"><?php echo $doc_text; ?></a></td>
            </tr>

            <tr>
              <td class="text-center" colspan="2"><a target="_blink" href="https://www.facebook.com/wdmilon" title="Facebook Page"><?php echo $fb_text; ?></a></td>
            </tr>

            <tr>
              <td class="text-center" colspan="2"><a target="_blink" href="https://twitter.com/techbuzz69" title="Twitter"><?php echo $tw_text; ?></a></td>
            </tr>
