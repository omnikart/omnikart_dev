              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="pull-right">
                    <a href="<?php echo $category_create_link; ?>" data-toggle="tooltip" title="" class="btn btn-sm btn-info" data-original-title="<?php echo $create_btn_tooltip; ?>"><i class="fa fa-plus"></i>&nbsp;<?php echo $create_btn; ?></a>
                    <button class="btn btn-sm btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-category').submit() : false;" data-toggle="tooltip" title="" data-original-title="<?php echo $delete_btn_tooltip; ?>"><i class="fa fa-trash-o"></i>&nbsp;<?php echo $delete_btn; ?></button>
                  </div>
                </div>
              </div>
            ...
            <table class="table table-bordered">
              <thead>
                <tr class="active">
                  ...
                  <th class="text-left"><?php if ($sort == 'cd1.name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $col_title; ?></a>
                    <?php } else { ?>
              ...
              <tbody>
                  ...
                  <td align="center" colspan="6">
                    <div class="form-inline">
                      <div style="text-align:left;" class="form-group">
                        ...
                        <input type="text" name="filter_name" value="<?php echo $filter_name; ?>" placeholder="<?php echo $filter_text_name; ?>" class="form-control">
                      </div>
                      <div style="text-align:left;" class="form-group">
                        ...
                        <select name="filter_status" id="filter_status" class="form-control">
                          ...
                          <option value="publish" <?php echo ($filter_status == 'publish') ? 'selected="selected"' : ''; ?>><?php echo $filter_text_publish; ?></option>
                          <option value="unpublish" <?php echo ($filter_status == 'unpublish') ? 'selected="selected"' : ''; ?>><?php echo $filter_text_unpublish; ?></option>
                        </select>
                      </div>
                      <div class="form-group">
                        <br>
                        <button id="button-filter" type="button" class="btn btn-sm btn-warning"><?php echo $button_filter; ?></button>
                      </div>
                    </div>
                    <!-- form-inline -->
                  </td>
                ...
                <?php if(isset($categories)) : ?>
                  <form action="<?php echo $category_delete_multiple; ?>" method="post" enctype="multipart/form-data" id="form-category">
                    <?php foreach ($categories as $category) : ?>
                      <tr>
                        ...
                        <td class="text-left"><img class="thumbnail" src="<?php echo ucfirst($category['image']); ?>"></td>
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            <a href="<?php echo $category_edit_link; ?>&amp;cid=<?php echo $category['category_id']; ?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('<?php echo $text_confirm; ?>');" href="<?php echo $category_delete_link; ?>&amp;cid=<?php echo $category['category_id']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash-o"></span></a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach; ?>
