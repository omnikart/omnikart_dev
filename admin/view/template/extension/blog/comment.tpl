          ...
          <div class="tab-pane active" id="comment">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="pull-right">
                    <button class="btn btn-sm btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-comment').submit() : false;" data-toggle="tooltip" title="" data-original-title="<?php echo $delete_btn_tooltip; ?>"><i class="fa fa-trash-o"></i>&nbsp;<?php echo $delete_btn; ?></button>
                  </div>
                </div>
              </div>
            ...
            <table class="table table-bordered">
              ...
              <?php if(isset($comments) && $comments) : ?>
                  <form action="<?php echo $comment_delete_multiple; ?>" method="post" enctype="multipart/form-data" id="form-comment">
                    <?php foreach ($comments as $comment) : ?>
                      <tr>
                        ...
                        <td class="text-right">
                          <div class="btn-group">
                            <a href="<?php echo $comment_edit_link; ?>&amp;comment_id=<?php echo $comment['comment_ID']; ?>" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
                            <a onclick="return confirm('<?php echo $text_confirm; ?>');" href="<?php echo $comment_delete_link; ?>&amp;comment_id=<?php echo $comment['comment_ID']; ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash-o"></span></a>
                          </div>
                        </td>
                      </tr>
                    <?php endforeach; ?>
