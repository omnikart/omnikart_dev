    ...
    <?php if (!empty($error)) { ?>
      <?php foreach($error as $error_message) { ?>
        <div class="alert alert-danger">
			<i class="fa fa-exclamation-circle"></i> <?php echo $error_message; ?></div>
      <?php } ?>
    <?php } ?>
    <div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					<i class="fa fa-puzzle-piece"></i> <?php echo $text_dashboard; ?></h3>
			</div>
				...
				<div class="row">
                    ...
                    <tr>
                        ...
                        <a href="<?php echo $extension['install']; ?>"
												data-toggle="tooltip" title="<?php echo $button_install; ?>"
							...
							<div class="col-md-12 text-center">
								<div class="row">
									<div class="col-md-4 text-center">
										<div class="well">
											<a href="<?php echo $product_link; ?>"> <span
												class="fa-stack fa-2x"> <i
													class="fa fa-square-o fa-stack-2x"></i> <i
													class="fa fa-tags fa-stack-1x"></i>
											</span>
									...
									<div class="col-md-4 text-center">
										<div class="well">
											<a href="<?php echo $order_link; ?>"> <span
												class="fa-stack fa-2x"> <i
													class="fa fa-square-o fa-stack-2x"></i> <i
									...
									<div class="col-md-4 text-center">
										<div class="well">
											<a href="<?php echo $manage_link; ?>"> <span
												class="fa-stack fa-2x"> <i
													class="fa fa-square-o fa-stack-2x"></i> <i
													class="fa fa-wrench fa-stack-1x"></i>
											</span>
									...
									<div class="col-md-4 text-center">
										<div class="well">
											<a href="http://www.openbaypro.com/help" target="_BLANK"> <span
												class="fa-stack fa-2x"> <i
													class="fa fa-square-o fa-stack-2x"></i> <i
													class="fa fa-comments-o fa-stack-1x"></i>
											</span>
									...
									<div class="col-md-4 text-center">
										<div class="well">
											<a href="http://www.openbaypro.com/suggestions"
												target="_BLANK"> <span class="fa-stack fa-2x"> <i
													class="fa fa-square-o fa-stack-2x"></i> <i
													class="fa fa-bullhorn fa-stack-1x"></i>
											</span>
					...
					<div class="col-md-6" style="padding-left: 10px;">
						<div id="openbay-version" class="alert alert-info text-left">
							<div id="openbay-version-loading">
								<i class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_version_check; ?> </div>
						</div>
						<div id="openbay-notification" class="alert alert-info text-left">
							<div id="openbay-loading">
								<i class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_getting_messages; ?> </div>
						</div>
					</div>
				</div>
			</div>
