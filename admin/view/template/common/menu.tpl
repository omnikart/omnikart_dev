<ul id="menu">
	<li id="dashboard"><a href="<?php echo $home; ?>"><i
			class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
	<li id="customerpartner"><a class="parent"><i class="fa fa-users"></i>
			<span><?php echo "B2B Market Place"; ?></span></a>
		<ul>
	...
	<li id="extension"><a class="parent"><i
			class="fa fa-puzzle-piece fa-fw"></i> <span><?php echo $text_extension; ?></span></a>
		<ul>
	...
	<?php if(isset($text_ne)) { ?>
		...
		<ul>
			...
			<li><a class="parent"><?php echo $text_ne_support; ?></a>
				<ul>
					<li><a href="https://www.codersroom.com/support/register.php"
						target="_blank"><?php echo $text_ne_support_register; ?></a></li>
					<li><a href="https://www.codersroom.com/support/clientarea.php"
						target="_blank"><?php echo $text_ne_support_login; ?></a></li>
...
<?php if ($nitropack_has_permission) { ?><li><a
				href="<?php echo $nitropack; ?>">NitroPack</a></li><?php } ?>
    </ul></li>
	<li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i>
