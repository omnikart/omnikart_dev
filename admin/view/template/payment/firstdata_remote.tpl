				...
				<form action="<?php echo $action; ?>" method="post"
                  ...
                  <?php } ?>
							...
							<div class="form-group required">
								<label class="col-sm-2 control-label"
									for="input-certificate-path"><span data-toggle="tooltip"
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="firstdata_remote_key"
										...
										placeholder="<?php echo $entry_certificate_key_path; ?>"
										id="input-key-path" class="form-control" />
                  <?php if ($error_key) { ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="firstdata_remote_key_pw"
										...
										placeholder="<?php echo $entry_certificate_key_pw; ?>"
										id="input-key-pw" class="form-control" />
                  <?php if ($error_key_pw) { ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="firstdata_remote_ca"
										...
										placeholder="<?php echo $entry_certificate_ca_path; ?>"
										id="input-ca-path" class="form-control" />
                  <?php if ($error_ca) { ?>
                  ...
                  <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_remote_debug" id="input-debug"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_remote_status" id="input-status"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select
										name="firstdata_remote_order_status_success_unsettled_id"
                    ...
                    <?php } ?>
						...
						<div class="tab-pane" id="tab-payment">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_remote_auto_settle"
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_remote_card_storage"
										id="input-card-store" class="form-control">
                  ...
                  <div class="checkbox">
                      ...
                      <input type="checkbox"
											name="firstdata_remote_cards_accepted[]"
