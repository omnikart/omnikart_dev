	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-bluepay-hosted"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-bluepay-hosted"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="bluepay_hosted_account_name"
								...
								placeholder="<?php echo $entry_account_name; ?>"
								id="input-account-name" class="form-control" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="bluepay_hosted_account_id"
								...
								id="input-account-id" class="form-control" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="bluepay_hosted_secret_key"
								...
								id="bluepay_hosted_secret_key" class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_test" id="input-test"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-transaction"><span
							data-toggle="tooltip" title="<?php echo $help_transaction; ?>"><?php echo $entry_transaction; ?></span></label>
						<div class="col-sm-10">
							<select name="bluepay_hosted_transaction" id="input-transaction"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_amex" id="input-amex"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_discover" id="input-discover"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="bluepay_hosted_total"
								value="<?php echo $bluepay_hosted_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_order_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_geo_zone_id" id="input-geo-zone"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_debug" id="input-debug"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_hosted_status" id="input-status"
								class="form-control">
