	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-worldpay" data-toggle="tooltip"
			...
			<h1>
				<i class="fa fa-credit-card"></i> <?php echo $heading_title; ?></h1>
		</div>
	</div>
	<div class="container-fluid">
		<div class="panel-body">
			<form action="<?php echo $action; ?>" method="post"
				enctype="multipart/form-data" id="form-worldpay"
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="worldpay_service_key"
									...
									placeholder="<?php echo $entry_service_key; ?>"
									id="input-service-key" class="form-control" />
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="worldpay_client_key"
									...
									placeholder="<?php echo $entry_client_key; ?>"
									id="input-client-key" class="form-control" />
				...
				<?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="worldpay_total"
									value="<?php echo $worldpay_total; ?>"
									placeholder="<?php echo $entry_total; ?>" id="input-total"
									class="form-control" /> <span class="help-block"><?php echo $help_total; ?></span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-card"><?php echo $entry_card; ?></label>
							<div class="col-sm-10">
								<select name="worldpay_card" id="input-card"
									class="form-control">
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-secret-token"><span
								data-toggle="tooltip" title="<?php echo $help_secret_token; ?>"><?php echo $entry_secret_token; ?></span></label>
							<div class="col-sm-10">
								<input type="text" name="worldpay_secret_token"
									value="<?php echo $worldpay_secret_token; ?>"
									id="input-secret-token" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-webhook-url"><span
								data-toggle="tooltip" title="<?php echo $help_webhook_url; ?>"><?php echo $entry_webhook_url; ?></span></label>
							<div class="col-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-link"></i></span>
									<input type="text" readonly
										value="<?php echo $worldpay_webhook_url; ?>"
										id="input-webhook-url" class="form-control" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-cron-job-url"><span
								data-toggle="tooltip" title="<?php echo $help_cron_job_url; ?>"><?php echo $entry_cron_job_url; ?></span></label>
							<div class="col-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-link"></i></span>
									<input type="text" readonly
										value="<?php echo $worldpay_cron_job_url; ?>"
			...
			<?php if ($worldpay_last_cron_job_run) { ?>
				<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" readonly
									value="<?php echo $worldpay_last_cron_job_run; ?>"
			...
			<div class="form-group">
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_debug" id="input-debug"
									class="form-control">
				  ...
				  <?php } else { ?>
					  <option value="1"><?php echo $text_enabled; ?></option>
									<option value="0" selected="selected"><?php echo $text_disabled; ?></option>
				  <?php } ?>
				</select> <span class="help-block"><?php echo $help_debug; ?></span>
							</div>
						</div>
						<div class="form-group">
				  ...
				  <?php } ?>
					...
					<div class="tab-pane" id="tab-order-status">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_success_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_failed_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_settled_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_partially_refunded_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_charged_back_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_information_requested_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_information_supplied_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
				  ...
				  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="worldpay_entry_chargeback_reversed_status_id"
									class="form-control">
				  <?php foreach ($order_statuses as $order_status) { ?>
