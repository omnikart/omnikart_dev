...
<div class="alert alert-success" id="worldpay_transaction_msg"
	...
	<tr>
	  ...
	  <?php } else { ?>
		  ...
		  <?php if ($worldpay_order['total_released'] > 0) { ?>
			  <input type="text" width="10" id="refund_amount" /> <a
			class="button btn btn-primary" id="btn_refund"><?php echo $btn_refund; ?></a>
