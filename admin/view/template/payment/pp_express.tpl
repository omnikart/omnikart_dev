...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-pp-express" data-toggle="tooltip"
				...
				<a href="<?php echo $cancel; ?>" data-toggle="tooltip"
					...
					class="fa fa-reply"></i></a> <a href="<?php echo $search; ?>"
					data-toggle="tooltip" title="<?php echo $button_search; ?>"
	...
	<div class="alert alert-info">
			<a data-paypal-button="true" target="PPFrame"
				href="<?php echo $text_paypal_link; ?>"><?php echo $text_paypal_join; ?></a>
			<button type="button" class="close" data-dismiss="alert">&times;</button>
		</div>
		<div class="alert alert-info">
			<a data-paypal-button="true" target="PPFrame"
				href="<?php echo $text_paypal_link_sandbox; ?>"><?php echo $text_paypal_join_sandbox; ?></a>
			<button type="button" class="close" data-dismiss="alert">&times;</button>
		</div>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-pp-express"
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="pp_express_username"
										...
										id="entry-username" class="form-control" />
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="pp_express_password"
										...
										id="entry-password" class="form-control" />
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="pp_express_signature"
										...
										placeholder="<?php echo $entry_signature; ?>"
										id="entry-signature" class="form-control" />
				  ...
				  <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"><span
									data-toggle="tooltip" title="<?php echo $help_ipn; ?>"><?php echo $text_ipn; ?></span></label>
								<div class="col-sm-10">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-link"></i></span>
										<input type="text" value="<?php echo $text_ipn_url; ?>"
											class="form-control" />
									</div>
								</div>
							</div>
						...
						<div class="tab-pane" id="tab-general">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="pp_express_test" id="input-live-demo"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="pp_express_debug" id="input-debug"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="pp_express_currency" id="input-currency"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									for="input-recurring-cancel"><?php echo $entry_recurring_cancellation; ?></label>
								<div class="col-sm-10">
									<select name="pp_express_recurring_cancel_status"
										id="input-recurring-cancel" class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="pp_express_total"
										value="<?php echo $pp_express_total; ?>"
					...
					<?php } ?>
						...
						<div class="tab-pane" id="tab-checkout">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="pp_express_allow_note" id="input-notes"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-page-color"><span
									data-toggle="tooltip" title="<?php echo $help_colour; ?>"><?php echo $entry_page_colour; ?></span></label>
								<div class="col-sm-10">
									<input type="text" name="pp_express_page_colour"
										value="<?php echo $pp_express_page_colour; ?>"
										placeholder="<?php echo $entry_page_colour; ?>"
										id="input-page-color" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-image"><span
									data-toggle="tooltip" title="<?php echo $help_logo; ?>"><?php echo $entry_logo; ?></span></label>
								<div class="col-sm-10">
									...
									<input type="hidden" name="pp_express_logo"
										value="<?php echo $pp_express_logo; ?>" />
								</div>
							</div>
						</div>
					</div>
