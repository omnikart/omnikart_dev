	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-bluepay-redirect"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-bluepay-redirect"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="bluepay_redirect_secret_key"
								...
								id="bluepay_redirect_secret_key" class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_test" id="input-test"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_transaction"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_card" id="input-card"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_order_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_geo_zone_id" id="input-geo-zone"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_debug" id="input-debug"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="bluepay_redirect_status" id="input-status"
								class="form-control">
