	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-authorizenet-aim"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-authorizenet-aim"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="authorizenet_aim_login"
								...
								placeholder="<?php echo $entry_login; ?>" id="input-login"
								class="form-control" />
              <?php if ($error_login) { ?>
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="authorizenet_aim_key"
								value="<?php echo $authorizenet_aim_key; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="authorizenet_aim_hash"
								...
								placeholder="<?php echo $entry_hash; ?>" id="input-hash"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
