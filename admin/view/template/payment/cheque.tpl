	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-cheque" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-cheque"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-payable"><?php echo $entry_payable; ?></label>
						<div class="col-sm-10">
							<input type="text" name="cheque_payable"
								value="<?php echo $cheque_payable; ?>"
								placeholder="<?php echo $entry_payable; ?>" id="input-payable"
								class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="cheque_total"
								value="<?php echo $cheque_total; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="cheque_sort_order"
								value="<?php echo $cheque_sort_order; ?>"
