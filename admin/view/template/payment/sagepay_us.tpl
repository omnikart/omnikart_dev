	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-sagepay-us" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-sagepay-us"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_us_merchant_key"
								...
								id="input-merchant-key" class="form-control" />
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_us_total"
								value="<?php echo $sagepay_us_total; ?>"
