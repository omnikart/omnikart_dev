	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-paypoint" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-paypoint"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-merchant"><?php echo $entry_merchant; ?></label>
						<div class="col-sm-10">
							<input type="text" name="paypoint_merchant"
								value="<?php echo $paypoint_merchant; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypoint_password"
								value="<?php echo $paypoint_password; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypoint_total"
								value="<?php echo $paypoint_total; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paypoint_sort_order"
								value="<?php echo $paypoint_sort_order; ?>"
