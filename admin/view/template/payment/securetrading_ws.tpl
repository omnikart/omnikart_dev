	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-sagepay-direct"
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-securetrading-ws"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_username"
								...
								id="securetrading_ws_username" class="form-control" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_password"
								...
								id="securetrading_ws_password" class="form-control" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_csv_username"
								...
								placeholder="<?php echo $entry_csv_username; ?>"
								id="securetrading_ws_csv_username" class="form-control" /> <span
								class="help-block"><?php echo $help_csv_username; ?></span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_csv_password"
								...
								placeholder="<?php echo $entry_csv_password; ?>"
								id="securetrading_ws_csv_password" class="form-control" /> <span
								class="help-block"><?php echo $help_csv_password; ?></span>
						</div>
					</div>
					<div class="form-group required">
						<label class="col-sm-2 control-label"
						...
						<div class="col-sm-10">
							<?php foreach ($cards as $key => $value) { ?>
								...
								<label>
									...
									name="securetrading_ws_cards_accepted[]"
									value="<?php echo $key ?>" />
										<?php } else { ?>
											<input type="checkbox"
									name="securetrading_ws_cards_accepted[]"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_settle_status"
								id="securetrading_ws_settle_status" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_settle_due_date"
								id="securetrading_ws_settle_due_date" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_total"
								...
								id="securetrading_ws_total" class="form-control" /> <span
								class="help-block"><?php echo $help_total; ?></span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_order_status_id"
								id="securetrading_ws_order_status_id" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_failed_order_status_id"
								id="securetrading_ws_failed_order_status_id"
								class="form-control">
								<?php foreach ($order_statuses as $order_status) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_declined_order_status_id"
								id="securetrading_ws_declined_order_status_id"
								class="form-control">
								<?php foreach ($order_statuses as $order_status) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_refunded_order_status_id"
								id="securetrading_ws_refunded_order_status_id"
								class="form-control">
								<?php foreach ($order_statuses as $order_status) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select
								name="securetrading_ws_authorisation_reversed_order_status_id"
								id="securetrading_ws_authorisation_reversed_order_status_id"
								class="form-control">
								<?php foreach ($order_statuses as $order_status) { ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_geo_zone_id"
								id="securetrading_ws_geo_zone_id" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="securetrading_ws_status"
								id="securetrading_ws_status" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="securetrading_ws_sort_order"
								...
								id="securetrading_ws_sort_order" class="form-control" />
						</div>
					</div>
				</form>
			</div>
						...
						<div class="row">
							...
							<div class="col-sm-1">
								<div class="form-group">
									...
									<div class="input-group">
										<select name="minute_from" id="minute-from"
											class="form-control">
								...
								<div class="form-group">
									...
									<div class="input-group datetime">
										<input type="text" name="date_from"
											...
											data-date-format="YYYY-MM-DD" id="date-from"
								...
								<div class="form-group">
									...
									<div class="input-group datetime">
										<input type="text" name="date_to"
											value="<?php echo date('Y-m-d'); ?>"
											placeholder="<?php echo $entry_date_to; ?>"
											data-date-format="YYYY-MM-DD" id="date-to"
											class="form-control" /> <span class="input-group-btn">
											<button type="button" class="btn btn-default">
												<i class="fa fa-calendar"></i>
											</button>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select name="currency[]" id="currency" multiple
										class="form-control" style="height: 150px">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select name="payment_type[]" id="payment-type" multiple
										class="form-control" style="height: 150px">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select name="settle_status[]" id="settle-status" multiple
										class="form-control" style="height: 150px">
