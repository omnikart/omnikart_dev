	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-perpetual-payments"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-perpetual-payments"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="perpetual_payments_auth_id"
								...
								placeholder="<?php echo $entry_auth_id; ?>" id="input-auth-id"
								class="form-control" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="perpetual_payments_auth_pass"
								...
								placeholder="<?php echo $entry_auth_pass; ?>"
								id="input-auth-pass" class="form-control" />
              ...
              <?php } ?>
                ...
                <input type="radio" name="perpetual_payments_test"
