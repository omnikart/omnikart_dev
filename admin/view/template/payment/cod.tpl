	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-cod" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-cod" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="cod_total"
								value="<?php echo $cod_total; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="cod_postcode_payment" id="input-postcode-payment"
								class="form-control">
								<option value="*"
									<?php echo (($cod_postcode_payment=='*')?'selected="selected"':''); ?>>All
									Postcodes</option>
								<option value="0"
									<?php echo (($cod_postcode_payment=='0')?'selected="selected"':''); ?>>Postcode
									payment is 0</option>
								<option value="1"
									<?php echo (($cod_postcode_payment=='1')?'selected="selected"':''); ?>>Postcode
									payment is 1</option>
							</select>
						</div>
					</div>
