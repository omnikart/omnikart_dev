...
<div id="content">
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-amazon-checkout"
    ...
    <div class="alert alert-info">
			<i class="fa fa-info-circle"></i> <?php echo $text_amazon_join; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
		</div>
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-amazon-checkout"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-merchant-id"><?php echo $entry_merchant_id; ?></label>
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_merchant_id"
								value="<?php echo $amazon_checkout_merchant_id; ?>"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_access_key"
								value="<?php echo $amazon_checkout_access_key; ?>"
								placeholder="<?php echo $entry_access_key; ?>"
								id="input-access-key" class="form-control" />
						</div>
					</div>
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-access-secret"><?php echo $entry_access_secret; ?></label>
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_access_secret"
								value="<?php echo $amazon_checkout_access_secret; ?>"
								placeholder="<?php echo $entry_merchant_id; ?>"
								id="input-access-secret" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-mode"><?php echo $entry_checkout_mode; ?></label>
						<div class="col-sm-10">
							<select name="amazon_checkout_mode" id="input-mode"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_marketplace" id="input-marketplace"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_order_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_ready_status_id"
								id="input-ready-status" class="form-control">
                <?php foreach($order_statuses as $order_status) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_shipped_status_id"
								id="input-shipped-status" class="form-control">
                <?php foreach($order_statuses as $order_status) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_canceled_status_id"
								id="input-canceled-status" class="form-control">
                <?php foreach($order_statuses as $order_status) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-cron-job-token"><span
							data-toggle="tooltip" title="<?php echo $help_cron_job_token; ?>"><?php echo $entry_cron_job_token; ?></span></label>
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_cron_job_token"
								value="<?php echo $amazon_checkout_cron_job_token; ?>"
								id="input-cron-job-token" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="input-group">
								...
								<input type="text" readonly value="<?php echo $cron_job_url; ?>"
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
							for="input-cron-job-last-run"><?php echo $entry_cron_job_last_run; ?></label>
						<div class="col-sm-10">
							<input type="text" readonly
								value="<?php echo $cron_job_last_run; ?>"
								id="input-cron-job-last-run" class="form-control" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-ip"><span
							data-toggle="tooltip" data-html="true"
							title="<?php echo htmlspecialchars($help_ip); ?>"><?php echo $entry_ip_allowed; ?></span></label>
						<div class="col-sm-10">
							<div class="input-group">
								<input type="text" value=""
									placeholder="<?php echo $entry_ip; ?>" id="input-ip"
							...
							<div id="ip-allowed" class="well well-sm"
								style="height: 150px; overflow: auto;">
                <?php foreach ($amazon_checkout_ip_allowed as $ip) { ?>
                <div>
									<i class="fa fa-minus-circle"></i> <?php echo $ip; ?>
                  <input type="hidden"
										name="amazon_checkout_ip_allowed[]" value="<?php echo $ip; ?>" />
								</div>
                <?php } ?>
              </div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_total"
								value="<?php echo $amazon_checkout_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_geo_zone" id="input-geo-zone"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="amazon_checkout_status" id="input-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="amazon_checkout_sort_order"
								value="<?php echo $amazon_checkout_sort_order; ?>"
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="amazon_checkout_button_colour"
									id="input-button-colour" class="form-control">
                  ...
                  <?php } ?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"
								for="input-button-background"><?php echo $entry_background; ?></label>
							<div class="col-sm-10">
								<select name="amazon_checkout_button_background"
									id="input-button-background" class="form-control">
                  ...
                  <?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select name="amazon_checkout_button_size"
									id="input-button-size" class="form-control">
