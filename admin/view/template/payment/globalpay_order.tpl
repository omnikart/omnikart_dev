...
<div class="alert alert-success" id="globalpay-transaction-msg"
      ...
      <?php } else { ?>
        ...
        <?php if ($globalpay_order['void_status'] == 0) { ?>
          <input type="text" width="10" id="capture-amount"
			value="<?php echo $globalpay_order['total']; ?>" /> <a
	...
	<tr>
      ...
      <?php } else { ?>
        <span class="void_text"><?php echo $text_no; ?></span>&nbsp;&nbsp;
			...
			<span class="btn btn-primary" id="loading-void"
			style="display: none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
    </td>
	</tr>
	<tr>
      ...
      <?php } else { ?>
        ...
        <?php if ($globalpay_order['total_captured'] > 0 && $globalpay_order['void_status'] == 0) { ?>
          <input type="text" width="10" id="rebate-amount" /> <a
			class="button btn btn-primary" id="button-rebate"><?php echo $button_rebate; ?></a>
			<span class="btn btn-primary" id="loading-rebate"
			style="display: none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
        <?php } ?>
      <?php } ?>
    </td>
