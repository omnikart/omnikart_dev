	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-nochex" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-nochex"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-email"><?php echo $entry_email; ?></label>
						<div class="col-sm-10">
							<input type="text" name="nochex_email"
								value="<?php echo $nochex_email; ?>"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="nochex_merchant"
								value="<?php echo $nochex_merchant; ?>"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="nochex_total"
								value="<?php echo $nochex_total; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="nochex_sort_order"
								value="<?php echo $nochex_sort_order; ?>"
