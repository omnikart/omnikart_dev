	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-paymate" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-paymate"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-username"><?php echo $entry_username; ?></label>
						<div class="col-sm-10">
							<input type="text" name="paymate_username"
								value="<?php echo $paymate_username; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="paymate_password"
								value="<?php echo $paymate_password; ?>"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paymate_total"
								value="<?php echo $paymate_total; ?>"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="paymate_sort_order"
								value="<?php echo $paymate_sort_order; ?>"
