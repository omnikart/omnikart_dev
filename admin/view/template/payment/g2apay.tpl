	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-skrill" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-g2apay"
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="g2apay_username"
										value="<?php echo $g2apay_username; ?>"
										placeholder="<?php echo $entry_username; ?>"
										id="input-username" class="form-control" /> <span
										class="help-block"><?php echo $help_username; ?></span>
				  ...
				  <?php } ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="g2apay_secret"
										value="<?php echo $g2apay_secret; ?>"
				  ...
				  <?php } ?>
							...
							<div class="form-group required">
								...
								<div class="col-sm-10">
									<input type="text" name="g2apay_api_hash"
										value="<?php echo $g2apay_api_hash; ?>"
										placeholder="<?php echo $entry_api_hash; ?>"
										id="input-api-hash" class="form-control" />
				  ...
				  <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_environment" class="form-control"
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="g2apay_secret_token"
										value="<?php echo $g2apay_secret_token; ?>"
										id="input-secret-token" class="form-control" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-ipn-url"><span
									data-toggle="tooltip" title="<?php echo $help_ipn_url; ?>"><?php echo $entry_ipn_url; ?></span></label>
								<div class="col-sm-10">
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-link"></i></span>
										<input type="text" readonly
											value="<?php echo $g2apay_ipn_url; ?>" id="input-ipn-url"
											class="form-control" />
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="g2apay_total"
										value="<?php echo $g2apay_total; ?>"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_geo_zone_id" id="input-geo-zone"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_debug" id="input-debug"
										class="form-control">
					<?php if ($g2apay_debug) { ?>
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_status" id="input-status"
										class="form-control">
					...
					<?php } ?>
						...
						<div class="tab-pane" id="tab-order-status">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_order_status_id" id="input-order-status"
										class="form-control">
					...
					<?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="g2apay_partially_refunded_status_id"
										class="form-control">
					<?php foreach ($order_statuses as $order_status) { ?>
