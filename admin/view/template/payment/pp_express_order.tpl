...
<table class="table table-striped table-bordered">
	...
	<tr>
      ...
      &nbsp;&nbsp; <a onclick="doVoid();"
			class="button paypal_capture btn btn-primary" id="button-void"><?php echo $button_void; ?></a>
  ...
  <tr class="paypal_capture">
		...
		<td><p>
				<input type="checkbox" name="paypal_capture_complete"
					id="paypal_capture_complete" value="1" />
        <?php echo $text_complete_capture; ?></p>
			<p>
				<input type="text" size="10" id="paypal_capture_amount"
					value="<?php echo $paypal_order['remaining']; ?>" /> <a
					class="btn btn-primary" onclick="capture();" id="button_capture"><?php echo $button_capture; ?></a>
  ...
  <tr>
		...
		<td><table class="table table-striped table-bordered"
          ...
          <tr>
              ...
              <a
							href="<?php echo $view_link .'&transaction_id='.$transaction['transaction_id']; ?>"><?php echo $text_view; ?></a>
              ...
              &nbsp;<a
							href="<?php echo $refund_link .'&transaction_id='.$transaction['transaction_id']; ?>"><?php echo $text_refund; ?></a>
              <?php } ?>
              <?php } else { ?>
              <a onclick="resendTransaction(this); return false;"
							href="<?php echo $resend_link . '&paypal_order_transaction_id=' . $transaction['paypal_order_transaction_id']; ?>"><?php echo $text_resend; ?></a>
              <?php } ?></td>
					</tr>
          <?php } ?>
        </tbody>
