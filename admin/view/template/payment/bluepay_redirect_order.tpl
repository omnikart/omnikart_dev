...
<div class="alert alert-success" id="bluepay_redirect_transaction_msg"
...
<table class="table table-striped table-bordered">
	...
	<tr>
      ...
      <input type="text" width="10" id="release_amount"
			value="<?php echo $bluepay_redirect_order['total']; ?>" /> <a
			class="button btn btn-primary" id="button-release"><?php echo $button_release; ?></a>
	...
	<tr>
		...
		<td><table class="table table-striped table-bordered"
				id="bluepay_redirect_transactions">
				<thead>
					<tr>
