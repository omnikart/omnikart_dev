	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-pp-pro-uk" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-pp-pro-uk"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="entry-username"><?php echo $entry_username; ?></label>
						<div class="col-sm-10">
							<input type="text" name="pp_pro_username"
								value="<?php echo $pp_pro_username; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="pp_pro_password"
								value="<?php echo $pp_pro_password; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="pp_pro_signature"
								value="<?php echo $pp_pro_signature; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="pp_pro_test" id="input-live-demo"
								class="form-control">
                <?php if ($pp_pro_test) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="pp_pro_total"
								value="<?php echo $pp_pro_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="pp_pro_sort_order"
								value="<?php echo $pp_pro_sort_order; ?>"
