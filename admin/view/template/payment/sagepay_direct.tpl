    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-sagepay-direct"
              ...
              <?php } ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_direct_total"
								value="<?php echo $sagepay_direct_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_direct_card" id="input-card"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_direct_debug" id="input-debug"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
							for="sagepay-direct-cron-job-token"><span data-toggle="tooltip"
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="cron-job-url"><span
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_direct_cron_job_url"
								...
								placeholder="<?php echo $entry_cron_job_url; ?>"
