	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-sagepay-server"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-sagepay-server"
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_server_vendor"
								...
								placeholder="<?php echo $entry_vendor; ?>" id="input-vendor"
								class="form-control" />
              <?php if ($error_vendor) { ?>
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_test" id="input-test"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_transaction" id="input-transaction"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_server_total"
								value="<?php echo $sagepay_server_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_card" id="input-debug"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_order_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_geo_zone_id" id="input-geo-zone"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_debug" id="input-debug"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="sagepay_server_status" id="input-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"
							for="sagepay_server_cron_job_token"><span data-toggle="tooltip"
						...
						<div class="col-sm-10">
							<input type="text" name="sagepay_server_cron_job_token"
								...
								id="sagepay_server_cron_job_token" class="form-control" />
						</div>
					</div>
					<div class="form-group">
