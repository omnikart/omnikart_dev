...
<table class="table table-striped table-bordered">
	...
	<tr>
      ...
      <a class="button btn btn-primary" id="button_capture"><?php echo $button_capture; ?></a>
			<span class="btn btn-primary" id="img_loading_capture"
...
<form method="POST" id="voidform" action="<?php echo $action_url; ?>">
	<input type="hidden" name="responseSuccessURL"
		value="<?php echo $void_url; ?>" /> <input type="hidden"
		name="responseFailURL" value="<?php echo $void_url; ?>" /> <input
		type="hidden" name="transactionNotificationURL"
		value="<?php echo $notify_url; ?>" /> <input type="hidden"
		name="txntype" value="void" /> <input type="hidden" name="timezone"
		value="GMT" /> <input type="hidden" name="txndatetime"
		value="<?php echo $request_timestamp; ?>" /> <input type="hidden"
		name="hash" value="<?php echo $hash; ?>" /> <input type="hidden"
		name="storename" value="<?php echo $merchant_id; ?>" /> <input
		...
		value="<?php echo $firstdata_order['order_ref']; ?>" /> <input
		type="hidden" name="tdate"
		value="<?php echo $firstdata_order['tdate']; ?>" /> <input
		type="hidden" name="order_id" value="<?php echo $order_id; ?>" />
</form>
<form method="POST" id="captureform" action="<?php echo $action_url; ?>">
	<input type="hidden" name="responseSuccessURL"
		value="<?php echo $capture_url; ?>" /> <input type="hidden"
		name="responseFailURL" value="<?php echo $capture_url; ?>" /> <input
		type="hidden" name="transactionNotificationURL"
		value="<?php echo $notify_url; ?>" /> <input type="hidden"
		name="txntype" value="postauth" /> <input type="hidden"
		name="timezone" value="GMT" /> <input type="hidden" name="txndatetime"
		value="<?php echo $request_timestamp; ?>" /> <input type="hidden"
		name="hash" value="<?php echo $hash; ?>" /> <input type="hidden"
		name="storename" value="<?php echo $merchant_id; ?>" /> <input
		type="hidden" name="chargetotal" value="<?php echo $amount; ?>" /> <input
