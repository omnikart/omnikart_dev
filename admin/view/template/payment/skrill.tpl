    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-skrill"
					class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-email"><?php echo $entry_email; ?></label>
						<div class="col-sm-10">
							<input type="text" name="skrill_email"
								value="<?php echo $skrill_email; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="skrill_secret"
								value="<?php echo $skrill_secret; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="skrill_total"
								value="<?php echo $skrill_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_order_status_id" id="input-order-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_pending_status_id" id="input-pending-status"
								class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_canceled_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_failed_status_id" id="input-failed-status"
								class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?>
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_chargeback_status_id"
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_geo_zone_id" id="input-geo-zone"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="skrill_status" id="input-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="skrill_sort_order"
								value="<?php echo $skrill_sort_order; ?>"
