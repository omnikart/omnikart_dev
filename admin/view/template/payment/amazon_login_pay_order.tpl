...
<div class="alert alert-success" id="amazon_login_pay-transaction-msg"
...
<table class="table table-striped table-bordered">
	...
	<tr>
	  ...
	  <?php } else { ?>
		  ...
		  <?php if ($amazon_login_pay_order['cancel_status'] == 0) { ?>
			  <input type="text" width="10" id="capture-amount"
			value="<?php echo $amazon_login_pay_order['total']; ?>" /> <a
			class="button btn btn-primary" id="button-capture"><?php echo $button_capture; ?></a>
			<span class="btn btn-primary" id="loading-capture"
	...
	<tr>
	  ...
	  <?php } else { ?>
		  ...
		  <a class="button btn btn-primary" id="button-cancel"><?php echo $button_cancel; ?></a>
			<span class="btn btn-primary" id="loading-cancel"
			style="display: none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
		  <?php } ?>
	  <?php } ?>
	</td>
	...
	<tr>
	  ...
	  <?php } else { ?>
		  ...
		  <?php if ($amazon_login_pay_order['total_captured'] > 0 && $amazon_login_pay_order['cancel_status'] == 0) { ?>
			  <input type="text" width="10" id="refund-amount" /> <a
			class="button btn btn-primary" id="button-refund"><?php echo $button_refund; ?></a>
		  <?php } else { ?>
			  <input type="text" width="10" id="refund-amount"
			style="display: none;" /> <a class="button btn btn-primary"
			id="button-refund" style="display: none;"><?php echo $button_refund; ?></a>
		  <?php } ?>
		  <span class="btn btn-primary" id="loading-refund"
			style="display: none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
	  <?php } ?>
	</td>
	</tr>
	<tr>
		...
		<td>
			<table class="table table-striped table-bordered"
				id="amazon_login_pay-transactions">
				<thead>
					<tr>
