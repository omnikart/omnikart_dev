...
<div class="alert alert-success" id="globalpay_transaction_msg"
...
<table class="table table-striped table-bordered">
	...
	<tr>
      ...
      <input type="text" width="10" id="capture_amount"
			value="<?php echo $globalpay_order['total']; ?>" /> <a
			class="button btn btn-primary" id="button_capture"><?php echo $button_capture; ?></a>
