	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-firstdata" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-firstdata"
                  ...
                  <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_live_demo" id="input-live-demo"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_geo_zone_id" id="input-geo-zone"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_debug" id="input-debug"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_status" id="input-status"
										class="form-control">
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="firstdata_total"
										value="<?php echo $firstdata_total; ?>"
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_order_status_decline_id"
                    ...
                    <?php } ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_order_status_void_id"
										id="input-order-status-void" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
						...
						<div class="tab-pane" id="tab-payment">
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-auto-settle"><span
									data-toggle="tooltip" title="<?php echo $help_settle; ?>"><?php echo $entry_auto_settle; ?></span></label>
								<div class="col-sm-10">
									<select name="firstdata_auto_settle" id="input-auto-settle"
										class="form-control">
										<option value="0"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="firstdata_card_storage" id="input-card-store"
										class="form-control">
                  ...
                  <?php } ?>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-sort-order"><span
									data-toggle="tooltip" title="<?php echo $help_notification; ?>"><?php echo $text_notification_url; ?></span></label>
								<div class="col-sm-10">
