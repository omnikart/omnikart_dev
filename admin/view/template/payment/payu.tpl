	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-payu" data-toggle="tooltip"
    ...
    <div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post"
					enctype="multipart/form-data" id="form-payu"
					class="form-horizontal">
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-merchant"><?php echo $entry_merchant; ?></label>
						<div class="col-sm-10">
							<input type="text" name="payu_merchant"
								value="<?php echo $payu_merchant; ?>"
              ...
              <?php } ?>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-salt"><span
							data-toggle="tooltip" title="<?php echo $help_salt; ?>"><?php echo $entry_salt; ?></span></label>
						<div class="col-sm-10">
							<input type="text" name="payu_salt"
								value="<?php echo $payu_salt; ?>"
								placeholder="<?php echo $entry_salt; ?>" id="input-password"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="payu_total"
								value="<?php echo $payu_total; ?>"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="payu_order_status_id" id="input-order-status"
								class="form-control">
                ...
                <?php } ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="payu_geo_zone_id" id="input-geo-zone"
								class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="payu_sort_order"
								value="<?php echo $payu_sort_order; ?>"
